...
from .dot_node import update_node, recursive_create_dot_graph, add_dot_node, init_digraph, append_node_text, init_nodes_text
...
class DataPipeline:
    ...
    def __init__(self, cfg):
        ...
        self.limit = 33 #text line limit of characters in node
    ...
    def create_dot_graph(self):
        ...
        add_dot_node(self, transformers_set)
...
def recursive_build_node_from_steps(steps, node_pairs, latest_node, index, parallel_index, nodename2transformer):
    ...
    return node_pairs, latest_node, index, parallel_index, nodename2transformer
