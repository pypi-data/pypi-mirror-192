...
require_relative '../../sdk/core/type'
require_relative '../../sdk/core/ruby_command'
require_relative '../../sdk/core/string_encoding_mode'
...
class CommandDeserializer
    ...
    def initialize(buffer,byte_array_len)
        ...
        @command = RubyCommand.new(buffer[0], buffer[10], [])
        @position = 11
    end
    ...
    def read_command
        ...
        @position += 7
        return_command = RubyCommand.new(runtime, command_type, [])
    ...
    def read_command_recursively(number_of_elements_in_payload_left, cmd)
        if number_of_elements_in_payload_left == 0
            ...
            p = @position
            arg_size = TypeDeserializer.deserialize_int(@buffer[p+1..p+4])
