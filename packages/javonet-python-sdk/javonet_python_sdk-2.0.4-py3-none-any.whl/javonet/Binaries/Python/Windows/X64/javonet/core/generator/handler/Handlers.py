...
class Handlers:
    ...
    def __init__(self):
        ...
        self.SHARED_BODY_HANDLER[PythonCommandType.CreateClassInstance] = SharedCreateInstanceBodyHandler()
        self.SHARED_BODY_HANDLER[PythonCommandType.GetType] = SharedGetTypeBodyHandler()
        self.SHARED_BODY_HANDLER[PythonCommandType.InvokeInstanceMethod] = SharedInvokeInstanceMethodBodyHandler()
        self.SHARED_BODY_HANDLER[PythonCommandType.InvokeStaticMethod] = SharedInvokeStaticMethodBodyHandler()
        self.SHARED_BODY_HANDLER[PythonCommandType.GetStaticField] = SharedGetStaticFieldBodyHandler()
        self.SHARED_BODY_HANDLER[PythonCommandType.GetInstanceField] = SharedGetInstanceFieldBodyHandler()

        self.GENERATOR_HANDLER[PythonCommandType.CreateClassInstance] = CreateInstanceGeneratorHandler()
        self.GENERATOR_HANDLER[PythonCommandType.GetType] = GetTypeGeneratorHandler()
        self.GENERATOR_HANDLER[PythonCommandType.InvokeInstanceMethod] = InvokeInstanceMethodGeneratorHandler()
        self.GENERATOR_HANDLER[PythonCommandType.InvokeStaticMethod] = InvokeStaticMethodGeneratorHandler()
        self.GENERATOR_HANDLER[PythonCommandType.GetStaticField] = GetStaticFieldGeneratorHandler()
        self.GENERATOR_HANDLER[PythonCommandType.GetInstanceField] = GetInstanceFieldGeneratorHandler()
