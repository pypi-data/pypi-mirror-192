...
class CommandDeserializer:
    ...
    def __init__(self, buffer, buffer_len):
        ...
        self.command = PythonCommand(RuntimeLib(buffer[0]), PythonCommandType(buffer[10]), [])
        self.position = 11
    ...
    def read_command(self):
        ...
        self.position += 7
        return_command = PythonCommand(RuntimeLib(runtime), PythonCommandType(command_type), [])
