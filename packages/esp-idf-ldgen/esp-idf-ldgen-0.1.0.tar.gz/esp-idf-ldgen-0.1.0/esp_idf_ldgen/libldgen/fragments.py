...
from pyparsing import (Combine, Forward, Group, IndentedBlock, Keyword,
                       LineEnd, Literal, OneOrMore, Opt, ParseFatalException,
                       SkipTo, Suppress, Word, ZeroOrMore, alphanums, alphas,
                       delimited_list, nums, rest_of_line)
...
def parse_fragment_file(path, sdkconfig):
    ...
    # comment
    comment = (Literal('#') + rest_of_line).set_parse_action(lambda s, l, t: Empty())  # noqa: E741
