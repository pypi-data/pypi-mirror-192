...
try:
    from esp_idf_ldgen.libldgen.fragments import (Align, Flag, Keep, Sort,
                                                  Surround,
                                                  parse_fragment_file)
    from esp_idf_ldgen.libldgen.sdkconfig import SDKConfig
except ImportError:
    sys.path.append(os.path.dirname(os.path.dirname(__file__)))
    from esp_idf_ldgen.libldgen.fragments import Align, Flag, Keep, Sort, Surround, parse_fragment_file
    from esp_idf_ldgen.libldgen.sdkconfig import SDKConfig
