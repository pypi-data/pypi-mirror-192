...
try:
    from esp_idf_ldgen.libldgen.entity import Entity, EntityDB
    from esp_idf_ldgen.libldgen.fragments import parse_fragment_file
    from esp_idf_ldgen.libldgen.generation import (Generation,
                                                   GenerationException)
    from esp_idf_ldgen.libldgen.linker_script import LinkerScript
    from esp_idf_ldgen.libldgen.output_commands import (AlignAtAddress,
                                                        InputSectionDesc,
                                                        SymbolAtAddress)
    from esp_idf_ldgen.libldgen.sdkconfig import SDKConfig
except ImportError:
