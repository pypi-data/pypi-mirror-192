...
def iFDOFromFile(iFDOfile:str,handle_prefix='20.500.12085',provenance = None,verbose=True,startEmpty=False,writeTmpProvFile=True,image_broker_uuid="ee277578-a911-484d-a515-9c781d79aa91"):
    ...
    return iFDO(dir=dirObj,handle_prefix=handle_prefix,provenance=provenance,verbose=verbose,startEmpty=startEmpty,writeTmpProvFile=writeTmpProvFile,image_broker_uuid=image_broker_uuid)


class iFDO:
    " Class for creating and editing iFDO.yaml files "

    def __init__(self, dir:miqtd.Dir=None, handle_prefix='20.500.12085',provenance = None,verbose=True,startEmpty=False,writeTmpProvFile=True,iFDOfile=None,image_broker_uuid="ee277578-a911-484d-a515-9c781d79aa91"):
