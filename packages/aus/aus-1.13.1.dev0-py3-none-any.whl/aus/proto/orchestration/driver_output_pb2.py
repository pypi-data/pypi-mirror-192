...
# source: aus/proto/orchestration/driver_output.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='aus/proto/orchestration/driver_output.proto',
  package='aus.orchestration',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n+aus/proto/orchestration/driver_output.proto\x12\x11\x61us.orchestration\x1a&ml_metadata/proto/metadata_store.proto\"\x97\x03\n\x0c\x44riverOutput\x12N\n\x10output_artifacts\x18\x01 \x03(\x0b\x32\x34.aus.orchestration.DriverOutput.OutputArtifactsEntry\x12L\n\x0f\x65xec_properties\x18\x02 \x03(\x0b\x32\x33.aus.orchestration.DriverOutput.ExecPropertiesEntry\x1a\x38\n\x0c\x41rtifactList\x12(\n\tartifacts\x18\x01 \x03(\x0b\x32\x15.ml_metadata.Artifact\x1a\x64\n\x14OutputArtifactsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12;\n\x05value\x18\x02 \x01(\x0b\x32,.aus.orchestration.DriverOutput.ArtifactList:\x02\x38\x01\x1aI\n\x13\x45xecPropertiesEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12!\n\x05value\x18\x02 \x01(\x0b\x32\x12.ml_metadata.Value:\x02\x38\x01\x62\x06proto3')
  ,
...
_DRIVEROUTPUT_ARTIFACTLIST = _descriptor.Descriptor(
  name='ArtifactList',
  full_name='aus.orchestration.DriverOutput.ArtifactList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='artifacts', full_name='aus.orchestration.DriverOutput.ArtifactList.artifacts', index=0,
...
_DRIVEROUTPUT_OUTPUTARTIFACTSENTRY = _descriptor.Descriptor(
  ...
  full_name='aus.orchestration.DriverOutput.OutputArtifactsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='aus.orchestration.DriverOutput.OutputArtifactsEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='aus.orchestration.DriverOutput.OutputArtifactsEntry.value', index=1,
...
_DRIVEROUTPUT_EXECPROPERTIESENTRY = _descriptor.Descriptor(
  ...
  full_name='aus.orchestration.DriverOutput.ExecPropertiesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='aus.orchestration.DriverOutput.ExecPropertiesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='aus.orchestration.DriverOutput.ExecPropertiesEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DRIVEROUTPUT = _descriptor.Descriptor(
  name='DriverOutput',
  full_name='aus.orchestration.DriverOutput',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='output_artifacts', full_name='aus.orchestration.DriverOutput.output_artifacts', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exec_properties', full_name='aus.orchestration.DriverOutput.exec_properties', index=1,
...
DriverOutput = _reflection.GeneratedProtocolMessageType('DriverOutput', (_message.Message,), {
  ...
  'ArtifactList' : _reflection.GeneratedProtocolMessageType('ArtifactList', (_message.Message,), {
    ...
    '__module__' : 'aus.proto.orchestration.driver_output_pb2'
    # @@protoc_insertion_point(class_scope:aus.orchestration.DriverOutput.ArtifactList)
    })
  ,
  ...
  'OutputArtifactsEntry' : _reflection.GeneratedProtocolMessageType('OutputArtifactsEntry', (_message.Message,), {
    ...
    '__module__' : 'aus.proto.orchestration.driver_output_pb2'
    # @@protoc_insertion_point(class_scope:aus.orchestration.DriverOutput.OutputArtifactsEntry)
    })
  ,
  ...
  'ExecPropertiesEntry' : _reflection.GeneratedProtocolMessageType('ExecPropertiesEntry', (_message.Message,), {
    ...
    '__module__' : 'aus.proto.orchestration.driver_output_pb2'
    # @@protoc_insertion_point(class_scope:aus.orchestration.DriverOutput.ExecPropertiesEntry)
    })
  ,
  'DESCRIPTOR' : _DRIVEROUTPUT,
  '__module__' : 'aus.proto.orchestration.driver_output_pb2'
  # @@protoc_insertion_point(class_scope:aus.orchestration.DriverOutput)
  })
