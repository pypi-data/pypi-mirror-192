...
try:
  from aus.proto.orchestration.schema_pb2 import Schema as schema_pb2_Schema  # pylint: disable=g-import-not-at-top,g-importing-member
...
class SchemaReader:
  ...
  def read(self, schema_path: str) -> schema_pb2_Schema:  # pytype: disable=invalid-annotation
    ...
    """
    try:
      from aus.proto.orchestration import schema_pb2  # pylint: disable=g-import-not-at-top
    except ModuleNotFoundError as e:
