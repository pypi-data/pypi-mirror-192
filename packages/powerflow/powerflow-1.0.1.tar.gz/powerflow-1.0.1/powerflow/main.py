...
def get_app():
    app = typer.Typer(
        name=APP_NAME,
        short_help="Initialize a new django project using the powerflow project template.",
        help="""This is a wrapper around the django-admin startproject  command using my custom project template at
        https://github.com/Kodesio/Powerflow. This cli also includes some additional commands to make setting up
