...
def args(new_command=None):
    ...
    create_user_parser.add_argument('--region', default='us-east-1', required=False)
    create_user_parser.add_argument('--email', required=True, help='Email address of the user to create.')
    create_user_parser.add_argument('--first-name', required=True, help='First name of the user.')
    create_user_parser.add_argument('--last-name', required=True, help='Last name of the user.')
    ...
    if args.command == 'quit':
        ...
        parser.print_help()
        print('You can also use the "help" command with any other command to get more information about that command.')
    return args, parser
    #############################End Argument Parser########################################
    ########################################################################################