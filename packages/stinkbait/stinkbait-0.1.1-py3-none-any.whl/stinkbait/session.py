...
def stinkbait_session_handler(args):
    ...
    for i in range(3):
        try:
            ...
            if i == 2:
                print("Unable to determine user Public IP Address")
                return None
            else:
                print("Initial IP Address Unsuccessful, Trying Again...")
    ...
    for i in range(3):
        try:
            ...
            if i == 2:
                print("Unable to initiate AWS Session")
                return None
            else:
                print("Initial AWS Session Attempt Unsuccessful, Trying Again...")   
    ...
    print(f'Your AWS Account: {aws_account}')
    print(f'Your AWS Principal: {aws_principal}')
########################################################################################
###############################START CONFIG PARSER######################################
    ...
    if config.has_option('stinkbait config', 'stinkbait_organizations_list'):
        ...
        print(f'Your Stinkbait Organizations: {stinkbait_organizations_list}')
    else:
        stinkbait_organizations_list = None
        print(f'Your Stinkbait Organizations: None')
...
########################################################################################
    ...
    #Return session data
    return session, user_ip, aws_account, aws_principal
