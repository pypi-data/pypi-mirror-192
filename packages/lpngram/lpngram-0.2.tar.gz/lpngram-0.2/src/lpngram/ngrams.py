...
def get_n_ngrams(
    ...
    >>> for ngram in lpngram.get_n_ngrams(sent, 2):
    ...     print(ngram)
    ...
    ('$$$', 'Insurgents')
    ('Insurgents', 'killed')
    ...
    >>> for ngram in lpngram.get_n_ngrams(sent, 0):
    ...     print(ngram)
    ...
    """
...
def get_all_ngrams_by_order(
    ...
    >>> for ngram in lpngram.get_all_ngrams_by_order(sent):
    ...     print(ngram)
    ...
    ('Insurgents',)
    ('were',)
...
def get_skipngrams(
    ...
    >>> import lpngram
    >>> sent = "Insurgents killed in ongoing fighting"
    >>> for ngram in lpngram.get_skipngrams(sent, 2, 2):
    ...     print(ngram)
    ...
    ('$$$', 'Insurgents')
    ('Insurgents', 'killed')
    ...
    ('killed', 'fighting')
    ('in', '$$$')
    >>> for ngram in lpngram.get_skipngrams(sent, 2, 2, single_gap=False):
    ...     print(ngram)
    ...
    ('$$$', 'Insurgents')
    ('$$$', 'killed')
...
def get_posngrams(
    ...
    >>> import lpngram
    >>> sent = "Insurgents killed in ongoing fighting"
    >>> for ngram in lpngram.get_posngrams(sent, 2, 1):
    ...     print(ngram)
    ...
    (('$$$', '$$$', '###', 'killed'), 'Insurgents', 0)
