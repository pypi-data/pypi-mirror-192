...
import sqlalchemy
from sqlalchemy import Column, String, Integer, ForeignKey, Boolean, Enum, Identity, JSON, Float
from sqlalchemy.orm import relationship, Session, validates

# import hit_db_connection as hit_db
...
from sunpeek.components.helpers import ORMBase, AttrSetterMixin, AccuracyClass, InstallCondition, SensorMap, ComponentParam
    ...
    def _validate(self, key, value):
        if key in self.attr_props:
            if not self.attr_props[key].get('no_check', False):
                # assert uu.units.is_compatible_with(value.units, self.attr_props[key]['unit'])
