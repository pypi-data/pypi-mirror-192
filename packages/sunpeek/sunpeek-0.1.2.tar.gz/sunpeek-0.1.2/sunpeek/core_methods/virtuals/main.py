...
# from components import Plant, Array
from sunpeek.common.errors import VirtualSensorCalculationError

from sunpeek.core_methods import VerifyValidateMode, assert_valid_collector, assert_valid_fluid
...
class CalcInternalShading(VirtualSensorCalculation):
    ...
    def _core(self):
        ...
        is_not_shadowed = np.ones_like(ar.aoi.data).astype(bool)
        ...
        is_shadowed = uu.to_s(np.invert(is_not_shadowed), 'dimensionless')
