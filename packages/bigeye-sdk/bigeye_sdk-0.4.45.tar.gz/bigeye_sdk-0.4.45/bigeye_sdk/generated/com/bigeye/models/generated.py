...
class QueryErrorReason(betterproto.Enum):
    """
    taken from MetricRunFailureReason.java TODO: figure out how to only have
    one declaration of this
    """

    QUERY_ERROR_REASON_UNSPECIFIED = 0
    QUERY_ERROR_REASON_QUERY_FAILED = 1
    QUERY_ERROR_REASON_CONNECTION_FAILURE = 2
    QUERY_ERROR_REASON_QUERY_TIMEOUT = 3
    QUERY_ERROR_REASON_INVALID_CREDS = 4
    QUERY_ERROR_REASON_NO_LOOKBACK_DATA = 5
    QUERY_ERROR_REASON_LOOKBACK_VALUE_NOT_FOUND = 6
    QUERY_ERROR_REASON_NO_OBSERVED_VALUE = 7
    QUERY_ERROR_REASON_DATA_ACCESS_EXCEPTION = 8
    QUERY_ERROR_REASON_BIGEYE_IP_NOT_WHITELISTED = 9
    QUERY_ERROR_REASON_MAX_METRIC_TIME_NOT_FOUND = 10
    QUERY_ERROR_REASON_DIMENSION_NOT_FOUND = 11
    QUERY_ERROR_REASON_GROUPS_OVER_LIMIT = 12
    QUERY_ERROR_REASON_GRPC_MESSAGE_TOO_LARGE = 13
    QUERY_ERROR_REASON_BLOB_SIZE_TOO_LARGE = 14
...
class QueryError(betterproto.Message):
    ...
    message: str = betterproto.string_field(2)
    reason: "QueryErrorReason" = betterproto.enum_field(3)
