...
class SMLRunner(object):
    ...
    def set_feature_vector(self, model_index: int, feature_vector: list):
        """Sets the models feature vector to the specified value

        Args:
            model_index (int): The model index
            feature_vector (list): A list containing the features to set the current models internal feature vector too
        """
