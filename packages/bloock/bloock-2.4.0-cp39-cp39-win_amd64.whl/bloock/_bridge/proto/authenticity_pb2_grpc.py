...
class AuthenticityServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GenerateEcdsaKeys = channel.unary_unary(
            "/bloock.AuthenticityService/GenerateEcdsaKeys",
            request_serializer=authenticity__pb2.GenerateEcdsaKeysRequest.SerializeToString,
            response_deserializer=authenticity__pb2.GenerateEcdsaKeysResponse.FromString,
        )
...
class AuthenticityServiceServicer(object):
    ...
    def GenerateEcdsaKeys(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_AuthenticityServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "GenerateEcdsaKeys": grpc.unary_unary_rpc_method_handler(
            servicer.GenerateEcdsaKeys,
            request_deserializer=authenticity__pb2.GenerateEcdsaKeysRequest.FromString,
            response_serializer=authenticity__pb2.GenerateEcdsaKeysResponse.SerializeToString,
        ),
...
class AuthenticityService(object):
    ...
    def GenerateEcdsaKeys(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/bloock.AuthenticityService/GenerateEcdsaKeys",
            authenticity__pb2.GenerateEcdsaKeysRequest.SerializeToString,
            authenticity__pb2.GenerateEcdsaKeysResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
