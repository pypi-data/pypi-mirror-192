...
class GtkStatusIcon:
    ...
    def __init__(self):
        self.data_configs: str = data_configs
    ...
    def daemon_restart(self, widget):
        ...
        data: str = process('restart', data)
        self.message(data, title)

    def show_daemon_status(self, widget):
        """ Show message status about the daemon. """
        title: str = 'SUN daemon'
        data: str = 'SUN is not running'
        if daemon_status():
            data: str = 'SUN is running...'
        self.message(data, title)
