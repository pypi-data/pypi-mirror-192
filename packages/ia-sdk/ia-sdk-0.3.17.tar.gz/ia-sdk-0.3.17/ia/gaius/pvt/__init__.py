...
class PerformanceValidationTest():
    ...
    def compute_incidental_probabilities(self, test_step_info: dict):
        ...
        if self.test_type == 'classification':
            ...
            if 'running_accuracy' not in test_step_info:
                test_step_info['true_positive']       = collections.defaultdict(lambda: collections.defaultdict(float))  
                test_step_info['false_positive']      = collections.defaultdict(lambda: collections.defaultdict(float))  
                test_step_info['true_negative']       = collections.defaultdict(lambda: collections.defaultdict(float))  
                test_step_info['false_negative']      = collections.defaultdict(lambda: collections.defaultdict(float))  
                test_step_info['unknown_percentage']  = collections.defaultdict(lambda: collections.defaultdict(float))  
                test_step_info['response_percentage'] = collections.defaultdict(lambda: collections.defaultdict(float))  
                test_step_info['response_counts']     = collections.defaultdict(lambda: collections.defaultdict(float))  
                test_step_info['running_accuracy']    = collections.defaultdict(lambda: collections.defaultdict(float))    
                ...
                test_step_info['running_precisions'] = collections.defaultdict(lambda: collections.defaultdict(float))  
                for k in test_step_info['predicted'].keys():
                    for emotive in test_step_info['actual'].keys():
                        if emotive in test_step_info['predicted'].keys():
            ...
            if 'running_accuracy' not in test_step_info:
                ...
                test_step_info['response_percentage'] = collections.defaultdict(lambda: collections.defaultdict(float))  
                test_step_info['response_counts']     = collections.defaultdict(lambda: collections.defaultdict(float))  
                test_step_info['residuals']           = collections.defaultdict(lambda: collections.defaultdict(float))  
