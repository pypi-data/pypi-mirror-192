...
def openTEPES_run(DirName, CaseName, SolverName, pCompleteResults, pIndLogConsole):
    ...
    #%% model declaration
    mTEPES = ConcreteModel('Open Generation, Storage, and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 4.10.0 - February 15, 2023')
