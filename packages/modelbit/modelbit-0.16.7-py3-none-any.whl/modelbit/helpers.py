...
from .utils import sizeOfFmt, getEnvOrDefault, inDeployment, inNotebook, inModelbitCI, branchForJob, inRuntimeJob
...
_login_host = ""
_api_url = ""
_currentBranch = branchForJob() if inRuntimeJob() else "main"
...
class JobProps:
  ...
  def __init__(self, name: str, outVar: str, rtProps: RuntimePythonProps, schedule: Optional[str],
               redeployOnSuccess: bool, refreshDatasets: Optional[List[str]], size: Optional[str],
