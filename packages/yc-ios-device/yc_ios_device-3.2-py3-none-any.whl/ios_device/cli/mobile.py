...
def cmd_battery(udid, network, format):
    ...
    current_capacity = io_registry.get('CurrentCapacity');
    log.info(
        f"[Battery] time={update_time}, current={current}, voltage={voltage}, power={power}, temperature={temperature}, currentcapacity={current_capacity}")
