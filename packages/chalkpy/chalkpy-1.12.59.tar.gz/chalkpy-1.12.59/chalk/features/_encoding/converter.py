...
class FeatureConverter(Generic[_TPrim, _TRich]):
    ...
    def from_primitive_to_rich(self, value: _TPrim) -> _TRich:
    ...
    def from_primitive_to_json(self, value: _TPrim) -> TJSON:
    ...
    def from_json_to_primitive(self, value: TJSON) -> _TPrim:
        try:
