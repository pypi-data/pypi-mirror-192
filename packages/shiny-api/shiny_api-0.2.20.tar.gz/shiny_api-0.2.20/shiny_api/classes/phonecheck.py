...
class Device:
    ...
    def __init__(self, serial_number: str) -> None:
        """load data from API"""
        params = {
            "Apikey": config.PHONECHECK_API_KEY,
            "imei": serial_number,
            "Username": "cloudshinycomputers",
        }
        ...
        self.failed = set(self.failed) - set(self.blacklist)
        ...
        self.parts_status = json.loads(response_json.get("Parts"))["Remarks"]
        self.success = True
    ...
    def __str__(self) -> str:
        ...
        print_string = (
            ...
            + f"Battery cycle count: {self.battery_cycle_count} at "
