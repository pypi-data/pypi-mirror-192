...
class SickwResults:
    ...
    def __init__(self, serial_number: str, service: int = APPLE_SERIAL_INFO) -> None:
        """Instantiate result with data from API from passed serial number and service.
        Set status to false if sickw says not success or no HTML result string"""
        ...
        response = requests.get(
            "https://sickw.com/api.php", params=current_params, headers=headers, timeout=60
        )
