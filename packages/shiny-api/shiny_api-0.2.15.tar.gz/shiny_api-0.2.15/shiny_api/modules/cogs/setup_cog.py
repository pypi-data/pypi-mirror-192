...
class SetupCog(commands.Cog):
    ...
    async def sync_command(self, context: commands.Context) -> None:
        ...
        if platform.node().lower() == "secureerase":
            await context.defer()
            print(pkg_resources.get_distribution("shiny_api"))
            print(luddite.get_version_pypi("shiny_api"))
            if pkg_resources.get_distribution("shiny_api") != luddite.get_version_pypi("shiny_api"):
                quit()
