<!-- THIS FILE IS EXCLUSIVELY MAINTAINED by the project aedev.aedev V0.3.16 -->
<!-- THIS FILE IS EXCLUSIVELY MAINTAINED by the project aedev.tpl_namespace_root V0.3.13 -->
# setup_project 0.3.18
...
[![LatestPyPIrelease](
    https://img.shields.io/gitlab/pipeline/aedev-group/aedev_setup_project/release0.3.17?logo=python)](
    https://gitlab.com/aedev-group/aedev_setup_project/-/tree/release0.3.17)
