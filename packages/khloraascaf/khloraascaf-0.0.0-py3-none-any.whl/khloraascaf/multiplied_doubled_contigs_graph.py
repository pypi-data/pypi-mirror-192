...
from khloraascaf.inputs import (
    ...
    MultT,
    PresScoreT,
    read_contigs_attributes,
    read_contigs_links_file,
)


# DOC: missing constant docstrings
# ============================================================================ #
#                                     TYPES                                    #
# ============================================================================ #
# ---------------------------------------------------------------------------- #
...
def mdcg_with_id_from_input_files(
    ...
    for contig_id, mult, presscore in read_contigs_attributes(contigs_attrs):
        id_container.associate_contig_vertex(
            contig_id,
            mdcg.add_multiplied_vertex(mult, presscore),
        )

    for l_id, c_id, c_or, d_id, d_or in read_contigs_links_file(contigs_links):
