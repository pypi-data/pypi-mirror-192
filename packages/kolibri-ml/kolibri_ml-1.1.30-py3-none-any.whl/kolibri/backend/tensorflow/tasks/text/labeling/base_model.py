...
class BaseLabelingModel(TextBaseModel):
    ...
    def build_model(self, x_data, y_data):
        ...
        train_gen = DataGenerator(x_data, y_data, self.embedding.max_position)
    ...
    def predict(self,
        ...
        with kolibri.backend.tensorflow.custom_object_scope():
            if truncating:
                ...
                seq_length = None
            tensor = self.content_indexer.transform(x_data, max_position=self.embedding.max_position, segment=self.embedding.segment)
