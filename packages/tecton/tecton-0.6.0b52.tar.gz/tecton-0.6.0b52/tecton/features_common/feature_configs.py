...
class EMRJsonClusterConfig:
    """
    Configuration used to specify materialization clusters.
    :param json: A JSON string used to directly configure the cluster used in materialization. This is an alpha feature. Contact Tecton Support before using.
    """
