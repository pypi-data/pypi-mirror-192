...
GET_HISTORICAL_FEATURES_START_TIME_GT_END_TIME = TectonValidationError(
    "For get_historical_features, end_time must be greater than or equal to start_time if both times are provided."
)
