...
def _time_range_get_historical_features_for_feature_definition(
    ...
    if _start >= _end:
        ...
        raise START_TIME_NOT_BEFORE_END_TIME(_start, _end)
...
def derive_materialization_schema_for_feature_view(
    ...
    return core_schema_derivation_utils.compute_materialization_schema_from_view_schema(view_schema, feature_view_args)
