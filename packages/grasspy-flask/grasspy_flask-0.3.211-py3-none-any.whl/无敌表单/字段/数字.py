...
class LocaleAwareNumberField(〇字段):
    """
...
class 〇整数字段(〇字段):
    ...
    def __init__(self, 标签=None, 验证器々=None, **kwargs):
        super().__init__(标签, 验证器々, **kwargs)
...
class 〇高精度字段(LocaleAwareNumberField):
    """
    ...
    def __init__(
        self, 标签=None, 验证器々=None, places=unset_value, rounding=None, **kwargs
    ):
        super().__init__(标签, 验证器々, **kwargs)
