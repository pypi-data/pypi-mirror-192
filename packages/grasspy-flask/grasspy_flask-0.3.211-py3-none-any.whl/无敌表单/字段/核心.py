...
class 〇字段:
    ...
    def __init__(
        ...
        self.flags = Flags()
        self.名称 = self.name = _prefix + name
        self.短名称 = self.short_name = name
        self.type = type(self).__name__

        self.check_validators(验证器々)
        self.验证器々 = self.validators = 验证器々 or self.validators

        self.id = id or self.name
        self.标签 = self.label = Label(
            self.id,
            标签
            if 标签 is not None
...
class UnboundField:
    ...
    def __init__(self, field_class, *args, name=None, **kwargs):
        ...
        self.args = args
        self.名称 = self.name = name
        self.kwargs = kwargs
        self.creation_counter = UnboundField.creation_counter
        validators = kwargs.get("验证器々")
        if validators:
