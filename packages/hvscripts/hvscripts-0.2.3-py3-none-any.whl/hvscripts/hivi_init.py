...
# PROJECT_DIR = './'
print("> hvscripts.hivi_init - PROJECT_DIR:: ", PROJECT_DIR)
# print("> hvscripts.hivi_init - os.getcwd():: ", os.getcwd())
...
def convertToBoolean(
    ...
    res = defaultVal
    if value is not None and str(value).lower() in valuesPossibles:
...
class Manager():
    ...
    def getAppModuleNames(self, haveInitialModule: bool = False):
        ...
        try:
            ...
            # print("> hvscripts.hivi_init.py | getAppModuleNames - properties:: ", properties)
            propertiesContent = properties if type(properties) == dict and len(properties.keys()) > 0 else {}
            modulesStr = None
            # print("> hvscripts.hivi_init.py | getAppModuleNames - propertiesContent:: ", propertiesContent)
            ...
            if modulesStr is not None :
                ...
                # print("> hvscripts.hivi_init.py | getAppModuleNames - properties:: ", properties)
                # print("> hvscripts.hivi_init.py | getAppModuleNames - propertiesContent:: ", propertiesContent)
                # print("> hvscripts.hivi_init.py | getAppModuleNames - modulesStr:: ", modulesStr)
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA RECUPERATION DES NOMS DE MODULE | err:: {err} ".format(
                err = str(err)
            )
            # print(e)
    ...
    def getAppModuleProperties(self,):
        ...
        # print("> hvscripts.hivi_init.py | getAppModuleProperties - modulesStr:: \n", modulesStr)
        modules = {}
        if modulesStr is not None:
            for index, data in enumerate(modulesStr):
                modules[data] = os.path.join(data, 'conf.xml')
            # print("> hvscripts.hivi_init.py | getAppModuleProperties - modules:: \n", modules)
    ...
    def checkInvalidModules(self, moduleNames: list, sendError = True):
        ...
        try:
            ...
            if(
                ...
                errRes = Exception('[ERROR] hvscripts.hivi_init.py | LES MODULES SUIVANTS SONT INTROUVABLES:: "{value}"'.format(
                    value = ', '.join(invalidModules)
                ))
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA VERIFICATION DES MODULES SUIVANT:: \"{value}\" | err:: {err} ".format(
    ...
    def getModulesRequiredForModule(self, moduleName: str):
        try:
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA RECUPERATION DES MODULES REQUIS DU MODULE \"{name}\" | err:: {err} ".format(
                name = moduleName,
                err = str(err)
            )
            # print(e)
        ...
        try:
            ...
            if(
                ...
                if(
                    ...
                    res = False
                    raise Exception('[ERROR] hvscripts.hivi_init.py | LES MODULES REQUIS SUIVANT SONT INEXISTANTS:: "{value}" DANS LE MODULE "{module}"'.format(
                        value = ', '.join(invalidModules),
                        module = moduleName,
                    ))
                    ...
                    res = False
                    raise Exception(
                        "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA VERIFICATION DES MODULES REQUIS POUR LE MODULE \"{name}\"".format(
                            name = moduleName,
                        )
                    )
    ...
    def getModuleProperties(self, moduleName: str):
        try:
            # print("> hvscripts.hivi_init.py | getModuleProperties - moduleName:: ", moduleName)
            return self.getPropertiesModule(moduleName = moduleName)
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA RECUPERATION DES PROPRIETES DU MODULE \"{name}\" | err:: {err} ".format(
                name = moduleName,
                err = str(err)
            )
            # print(e)
    ...
    def getModuleServices(self, moduleName: str):
        try:
            # print("> hvscripts.hivi_init.py | getModuleServices <")
            moduleProperties = self.getModuleProperties(moduleName)
            # print("> hvscripts.hivi_init.py | getModuleServices - moduleName:: ", moduleName)
            # print("> hvscripts.hivi_init.py | getModuleServices - moduleProperties:: ", moduleProperties)
            ...
            if(services is not None):
                ...
                if(len(notFoundServices) <= 0):
                    ...
                    # print("> hvscripts.hivi_init.py | getModuleServices - services:: ", services)
                else:
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA RECUPERATION DES SERVICES DU MODULE \"{name}\" | err:: {err} ".format(
                name = moduleName,
                err = str(err)
            )
            # print(e)
    ...
    def getAppMiddlewares(self,):
        try:
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA RECUPERATION DES MIDDLEWARES DES MODULES | err:: {err} ".format(
                name = moduleName,
                err = str(err)
            )
            # print(e)
    ...
    def getModuleMiddlewares(self, moduleName: str):
        try:
            ...
            # print("> hvscripts.hivi_init.py | getModuleMiddlewares - moduleName:: ", moduleName)
            # print("> hvscripts.hivi_init.py | getModuleMiddlewares - moduleProperties:: ", moduleProperties)
            ...
            # print("> hvscripts.hivi_init.py | getModuleMiddlewares - middlewares:: ", middlewares)
            if(middlewares is not None):
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA RECUPERATION DES MIDDLEWARES DU MODULE \"{name}\" | err:: {err} ".format(
                name = moduleName,
                err = str(err)
            )
            # print(e)
    ...
    def getGenConf(self, genModulename: str = 'gen'):
        try:
            ...
            self.allConf = self.getAppModuleProperties()
            # print("> hvscripts.hivi_init.py | getGenConf - self.allConf:: ", self.allConf)
            allConf = {}
                ...
                if(
                    ...
                    for indexGF, valGF in enumerate(deepcopy(genFiles)):
                        ...
                        if (
                            ...
                            # print("> hvscripts.hivi_init.py | getGenConf - createDir(valGFFinal['dest']):: ", createDir(valGFFinal['dest']))
                            if(
                                not(
                    ...
                    # print("> hvscripts.hivi_init.py | getGenConf - genFilesContent:: ", genFilesContent)
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LA SECTION MODULE, ELEMENT gen D'UN DES MODULES | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getMigrationsConfig(self,):
        try:
            self.allConf = self.getAppModuleProperties()
            # print("> hvscripts.hivi_init.py | getMigrationsConfig - self.allConf:: ", self.allConf)
            allConf = {}
            for key in self.allConf:
                value = self.allConf[key]
                if(key != 'init'):
            ...
            for index, (key, conf) in enumerate(allConf.items()):
                if(
                    ...
                    # print("> hvscripts.hivi_init.py | getMigrationsConfig - migrationConf['", key, "']:: ", migrationConf[key])
            ...
            res = migrationConf
            # print("> hvscripts.hivi_init.py | getMigrationsConfig - migrationConf:: ", migrationConf)

            return res
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LA SECTION MODULE, ELEMENT migration D'UN DES MODULES | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getMigrationsViewConfig(self,):
        try:
            ...
            for key in self.allConf:
                ...
                if(key != 'init'):
                    allConf[key] = value
            # print("> hvscripts.hivi_init.py | getMigrationsConfig -> allConf:: ", allConf)
            migrationViewConf = {}
            for index, (key, conf) in enumerate(allConf.items()):
                # print("> hvscripts.hivi_init.py | getMigrationsConfig -> index:: ", index, " - conf:: ", conf)
                if(
                    "DEFAULT" in conf and
                    ...
                    # print("> hvscripts.hivi_init.py | getMigrationsConfig - migrationViewConf['", key, "']:: ", migrationViewConf[key])
            ...
            # print("> hvscripts.hivi_init.py | getMigrationsConfig - migrationViewConf:: ", migrationViewConf)
    ...
    def getModuleMigrationsFile(self, moduleName: str):
        try:
            moduleProperties = self.getModuleProperties(moduleName)
            # print("> hvscripts.hivi_init.py | getModuleMigrationsFile - moduleName:: ", moduleName)
            # print("> hvscripts.hivi_init.py | getModuleMigrationsFile - moduleProperties:: ", moduleProperties)
            targets = [
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA RECUPERATION DES FICHIERS DE MIGRATIONS DU MODULE \"{name}\" | err:: {err} ".format(
                name = moduleName,
                err = str(err)
            )
            # print(e)
    ...
    def getModuleMigrationsViewsFile(self, moduleName: str):
        try:
            moduleProperties = self.getModuleProperties(moduleName)
            # print("> hvscripts.hivi_init.py | getModuleMigrationsViewsFile - moduleName:: ", moduleName)
            # print("> hvscripts.hivi_init.py | getModuleMigrationsViewsFile - moduleProperties:: ", moduleProperties)
            targets = [
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA RECUPERATION DES FICHIERS DE MIGRATIONS DE VIEW DU MODULE \"{name}\" | err:: {err} ".format(
                name = moduleName,
                err = str(err)
            )
            # print(e)
    ...
    def getModuleMigrationsViewsFileAction(self, moduleName: str):
        try:
            moduleProperties = self.getModuleProperties(moduleName)
            # print("> hvscripts.hivi_init.py | getModuleMigrationsViewsFileAction - moduleName:: ", moduleName)
            # print("> hvscripts.hivi_init.py | getModuleMigrationsViewsFileAction - moduleProperties:: ", moduleProperties)
            targets = [
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR LORS DE LA RECUPERATION DES FICHIERS DE MIGRATIONS ACTION DE VIEW DU MODULE \"{name}\" | err:: {err} ".format(
                name = moduleName,
                err = str(err)
            )
            # print(e)
    ...
    def getModelsConfig(self,):
        try:
            self.allConf = self.getAppModuleProperties()
            # print("> hvscripts.hivi_init.py | getModelsConfig - self.allConf:: ", self.allConf)
            allConf = {}
            for key in self.allConf:
                value = self.allConf[key]
                if(key != 'init'):
            ...
            modelConf = {}
            for index, (key, conf) in enumerate(allConf.items()):
                # print("> hvscripts.hivi_init.py | getModelsConfig - index:: ", index, " - conf:: ", conf)
                if(
                    "DEFAULT" in conf and
                    ...
                    # print("> hvscripts.hivi_init.py | getModelsConfig - index:: ", index, " - modelConf[", key, "]:: ", modelConf[key])
                    # print("> hvscripts.hivi_init.py | getModelsConfig - index:: ", index, " - modelConf[", key, "]['src']:: ", modelConf[key]['src'])
                    # print("> hvscripts.hivi_init.py | getModelsConfig - modelConf[", key, "]['src']:: ", modelConf[key]['src'])
                    # print("> hvscripts.hivi_init.py | getModelsConfig - index:: ", index, " - self.allConf:: ", self.allConf)
                    ...
                    # print("> hvscripts.hivi_init.py | getModelsConfig - modelConf[", key, "]:: ", modelConf[key])
                    # modelConf[key]['data'] = importlib.import_module(modelConf[key]['src'])
            res = modelConf
            # print("> hvscripts.hivi_init.py | getModelsConfig - modelConf:: ", modelConf)

            return res
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LA SECTION MODULE, ELEMENT model D'UN DES MODULES | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def loadJsonFile(self, filePath: str, mode: str = 'r', encoder: str = 'utf-8'):
        try:
            ...
            return None
    def getAllTranslationConfig(self,):
        try:
            self.allConf = self.getAppModuleProperties()
            # print("> hvscripts.hivi_init.py | getAllTranslationConfig - self.allConf:: ", self.allConf)
            allConf = deepcopy(self.allConf)
            translationsConf = {}
            for indexModule, (keyModule, conf) in enumerate(allConf.items()):
                moduleFolder = keyModule if keyModule != 'init' else 'main'
                translationsDIR = (conf["DEFAULT"]["translations"] if (
                    "DEFAULT" in conf and
                    "translations" in conf["DEFAULT"] and
                    type(conf["DEFAULT"]["translations"]) == str and
                    len(conf["DEFAULT"]["translations"]) > 0 and
                    "translations" in conf["DEFAULT"].keys()
                ) else "translations").replace('.', '/') + ".json"
                translationsDIRPath = createDir(
                    moduleFolder,
                    translationsDIR
                )
                translationsExists = Path(translationsDIRPath).exists()
                translationsContent = None
                if translationsExists :
                    translationsContent = self.loadJsonFile(translationsDIRPath)
                translationsCheck = (
                    translationsExists and
                    translationsContent is not None and
                    type(translationsContent) == dict
                )
                # print("> hvscripts.hivi_init.py | getAllTranslationConfig - index:: ", index, " - conf:: ", conf)
                # print("> hvscripts.hivi_init.py | getAllTranslationConfig - translationsDIR:: ", translationsDIR)
                # print("> hvscripts.hivi_init.py | getAllTranslationConfig - translationsDIRPath:: ", translationsDIRPath)
                # print("> hvscripts.hivi_init.py | getAllTranslationConfig - translationsExists:: ", translationsExists)
                # print("> hvscripts.hivi_init.py | getAllTranslationConfig - translationsContent:: ", translationsContent)
                # print("> hvscripts.hivi_init.py | getAllTranslationConfig - translationsCheck:: ", translationsCheck)
                if(translationsCheck):
                    translationsContentF = {}
                    if type(translationsContent) == dict:
                        for key, value in translationsContent.items():
                            translationsContentF[key] = value
                    if keyModule == 'init':
                        translationsConf = translationsContentF
                    else:
                        translationsConf['__' + keyModule] = translationsContentF
            res = translationsConf
            # print("> hvscripts.hivi_init.py | getAllTranslationConfig - translationsConf:: ", translationsConf)

            return res
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LA SECTION MODULE, ELEMENT translations D'UN DES MODULES | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getTranslationsConfig(self, lang: str = 'fr'):
        try:
            self.allConf = self.getAppModuleProperties()
            # print("> hvscripts.hivi_init.py | getTranslationsConfig - self.allConf:: ", self.allConf)
            allConf = deepcopy(self.allConf)
            translationsConf = {}
            for indexModule, (keyModule, conf) in enumerate(allConf.items()):
                moduleFolder = keyModule if keyModule != 'init' else 'main'
                ...
                # print("> hvscripts.hivi_init.py | getTranslationsConfig - index:: ", index, " - conf:: ", conf)
                # print("> hvscripts.hivi_init.py | getTranslationsConfig - translationsDIR:: ", translationsDIR)
                # print("> hvscripts.hivi_init.py | getTranslationsConfig - translationsDIRPath:: ", translationsDIRPath)
                # print("> hvscripts.hivi_init.py | getTranslationsConfig - translationsExists:: ", translationsExists)
                # print("> hvscripts.hivi_init.py | getTranslationsConfig - translationsContent:: ", translationsContent)
                # print("> hvscripts.hivi_init.py | getTranslationsConfig - translationsCheck:: ", translationsCheck)
                if(translationsCheck):
                    translationsContentF = {}
                    if type(translationsContent) == dict:
                        for key, value in translationsContent.items():
                            translationsContentF[key] = value[lang]
                    if keyModule == 'init':
                        translationsConf = translationsContentF
                    else:
                        translationsConf['__' + keyModule] = translationsContentF
            res = translationsConf
            # print("> hvscripts.hivi_init.py | getTranslationsConfig - translationsConf:: ", translationsConf)
    ...
    def getTestsConfig(self,):
        try:
            self.allConf = self.getAppModuleProperties()
            # print("> hvscripts.hivi_init.py | getTestsConfig - self.allConf:: ", self.allConf)
            allConf = {}
            for key in self.allConf:
                value = self.allConf[key]
                if(key != 'init'):
            ...
            for index, (key, conf) in enumerate(allConf.items()):
                ...
                if(pathDirF is not None):
                    for indexFile, file in enumerate(os.listdir(createDir(key, pathDir))):
                        ...
                        # print("> hvscripts.hivi_init.py | getTestsConfig - allConf[", key, "] - files[", indexFile ,"].ext :: ", ext)
            res = testsConf
            # print("> hvscripts.hivi_init.py | getTestsConfig - testsConf:: ", testsConf)

            return res
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LA SECTION TEST, ELEMENT model D'UN DES TESTS | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getUrlsConfig(self,):
        try:
            self.allConf = self.getAppModuleProperties()
            # print("> hvscripts.hivi_init.py | getUrlsConfig - self.allConf:: ", self.allConf)
            allConf = {}
            for key in self.allConf:
                # print("> hvscripts.hivi_init.py | getUrlsConfig - self.allConf[", key, "]:: ", self.allConf[key])
                value = self.allConf[key]
                if(key != 'init'):
                    allConf[key] = value
            urlConf = {}
            ...
            # print("> hvscripts.hivi_init.py | getUrlsConfig - urlConf:: ", urlConf)

            return res
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LA SECTION MODULE, ELEMENT url ou urlname D'UN DES MODULES | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getCommunicationConfig(self,):
        try:
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LE hiviconfig.ini concernant la section COMMUNICATION | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getDatabaseConfig(self,):
        try:
            ...
            if dialect in ('mysql', 'postgres', 'oracle', 'sqlite', 'mssql'):
                ...
                dbType = 'memorydb'
            # print("> hvscripts.hivi_init.py - getDatabaseConfig | dialect:: ", dialect)
            # print("> hvscripts.hivi_init.py - getDatabaseConfig | dbType:: ", dbType)
            # print("> hvscripts.hivi_init.py - getDatabaseConfig | PROJECT_DIR:: ", PROJECT_DIR)
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LE hiviconfig.ini concernant la section DATABASE | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getSecurityConfig(self,):
        try:
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LE hiviconfig.ini concernant la section SECURITY | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getStructConfig(self,):
        try:
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LE hiviconfig.ini concernant la struct config | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getAssetStructModulesConfig(self,):
        try:
            self.allConf = self.getAppModuleProperties()
            # print("> hvscripts.hivi_init.py | getAssetStructModulesConfig - self.allConf:: ", self.allConf)
            allConf = {}
            for key in self.allConf:
                value = self.allConf[key]
                if(key != 'init'):
            ...
            # print("> hvscripts.hivi_init.py | getAssetStructModulesConfig - structModuleConf:: ", structModuleConf)

            return res
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LA SECTION MODULE, ELEMENT template_folder, static_folder, static_url_path D'UN DES MODULES | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getAssetStructModuleConfig(self, name: str):
        ...
        # print("> hvscripts.hivi_init.py | getAssetStructModuleConfig - datas:: ", datas)
    ...
    def getOSConfig(self,):
        try:
            self.allConf = self.getAppModuleProperties()
            # print("> hvscripts.hivi_init.py - self.allConf['init']:: ", self.allConf['init'])
            ...
            e = "[ERROR] hvscripts.hivi_init.py | ERREUR DE CONFIGURATION DANS LE hiviconfig.ini concernant os config | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def getProperties(self,**modules: dict):
        ...
        # print("> hvscripts.hivi_init.py | getProperties - modules:: ", modules)
        # print("> hvscripts.hivi_init.py | getProperties - modulesConfig:: ", modulesConfig)
        res = {}
    ...
    def getPropertiesModule(self, moduleName: str = None, isAbsoluteUrl: bool = False):
        try:
            ...
            # print("> hvscripts.hivi_init.py - getPropertiesModule | moduleName:: ", moduleName)
            # print("> hvscripts.hivi_init.py - getPropertiesModule | res:: ", res)
            ...
            # print("> hvscripts.hivi_init.py - getPropertiesModule | resF:: ", resF)
            resFi = list(resF.values())[0] if type(resF) == dict and len(resF.values()) > 0 else None
            return resFi
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
            log.error(stack)
            return None
    def setPropertyModule(self, module: str, value):
        ...
        try:
            ...
            # print("> hvscripts.hivi_init.py | setPropertyModule - lastConf:: ", lastConf)
            ...
            # print("> hvscripts.hivi_init.py | setPropertyModule - conf:: ", conf)
            # print("> hvscripts.hivi_init.py | setPropertyModule - value:: ", value)
            # print("> hvscripts.hivi_init.py | setPropertyModule - newElement:: ", newElement)

            # print("> hvscripts.hivi_init.py | setPropertyModule - urlPathConf:: ", urlPathConf)
            # print("> hvscripts.hivi_init.py | setPropertyModule - conf (old):: ", conf)
            # print("> hvscripts.hivi_init.py | setPropertyModule - session:: ", session)
            # print("> hvscripts.hivi_init.py | setPropertyModule - (session in conf):: ", (session in conf))
            # print("> hvscripts.hivi_init.py | setPropertyModule - name:: ", name)

            outWrite = XMLFile().write(path=urlPathConf, datas = conf, mode = 'wb', encoding = 'utf-8')
            res = 1 if outWrite == True else 2
                
            # print("> hvscripts.hivi_init.py | setPropertyModule - dict(conf):: ", dict(conf))
        except Exception as err:
            e = "[ERROR] hvscripts.hivi_init.py | err:: {err} ".format(err = str(err))
            # print(e)
            stack = str(traceback.format_exc())
...
# manager = Manager()
# translations = manager.getTranslationsConfig()
# print("> hvscripts.hivi_init.py - translations:: ", translations)

# allMigrationFiles = manager.getModuleMigrationsFile(moduleName='mymoduletest')
# print("> hvscripts.hivi_init.py - allMigrationFiles:: ", allMigrationFiles)
# allMigrationViewFiles = manager.getModuleMigrationsViewsFile(moduleName='mymoduletest')
# print("> hvscripts.hivi_init.py - allMigrationViewFiles:: ", allMigrationViewFiles)

# mainConfig = manager.getInitProperties()
# print("> hvscripts.hivi_init.py - mainConfig:: ", mainConfig)
# AUTHmodulePropertiesConfig = manager.getModuleProperties(moduleName='auth')
# print("> hvscripts.hivi_init.py - AUTHmodulePropertiesConfig:: ", AUTHmodulePropertiesConfig)
# AUTHmoduleServicesConfig = manager.getModuleServices(moduleName='auth')
# print("> hvscripts.hivi_init.py - AUTHmoduleServicesConfig:: ", AUTHmoduleServicesConfig)
# modulesRequiredForModule = manager.getModulesRequiredForModule(moduleName='auth')
# print("> hvscripts.hivi_init.py - modulesRequiredForModule:: ", modulesRequiredForModule)
# checkModulesRequiredForModule = manager.checkAllModulesRequiredForModule(moduleName='auth')
# print("> hvscripts.hivi_init.py - checkModulesRequiredForModule:: ", checkModulesRequiredForModule)

# allModuleNames = manager.getAllModuleNames()
# print("> hvscripts.hivi_init.py - allModuleNames:: ", allModuleNames)
# moduleNames = manager.getAppModuleNames()
# print("> hvscripts.hivi_init.py - moduleNames:: ", moduleNames)
# allConfPath = manager.getAppModuleUrlConfPath()
# print("> hvscripts.hivi_init.py - allConfPath:: ", allConfPath)
# initModuleProperties = manager.getPropertiesModule()
# print("> hvscripts.hivi_init.py - initModuleProperties:: ", initModuleProperties)
# appModuleProperties = manager.getAppModuleProperties()
# print("> hvscripts.hivi_init.py - appModuleProperties:: ", appModuleProperties)
...
# print("> hvscripts.hivi_init.py - structConfig:: ", structConfig)
# securityConfig = manager.getSecurityConfig()
# print("> hvscripts.hivi_init.py - securityConfig:: ", securityConfig)
# databaseConfig = manager.getDatabaseConfig()
# print("> hvscripts.hivi_init.py - databaseConfig:: ", databaseConfig)
# urlsConfig = manager.getUrlsConfig()
# print("> hvscripts.hivi_init.py - urlsConfig:: ", urlsConfig)
# communicationConfig = manager.getCommunicationConfig()
# print("> hvscripts.hivi_init.py - communicationConfig:: ", communicationConfig)
# testsConfig = manager.getTestsConfig()
# print("> hvscripts.hivi_init.py - testsConfig:: ", testsConfig)
# modelsConfig = manager.getModelsConfig()
# print("> hvscripts.hivi_init.py - modelsConfig:: ", modelsConfig)
# migrationsConfig = manager.getMigrationsConfig()
# print("> hvscripts.hivi_init.py - migrationsConfig:: ", migrationsConfig)
# migrationsViewConfig = manager.getMigrationsViewConfig()
# print("> hvscripts.hivi_init.py - migrationsViewConfig:: ", migrationsViewConfig)