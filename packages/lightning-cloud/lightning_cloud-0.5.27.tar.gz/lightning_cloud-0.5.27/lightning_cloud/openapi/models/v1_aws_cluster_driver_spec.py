...
class V1AWSClusterDriverSpec(object):
    ...
    def __init__(
        ...
        cluster_coredns_version: 'str' = None,
        cluster_kubeproxy_version: 'str' = None,
        cluster_vpc_cni_version: 'str' = None,
        ...
        disable_automatic_ami_updates: 'bool' = None,
        ec2_gpu_ami: 'str' = None,
        ec2_gpu_ami_cloud_space: 'str' = None,
        ...
        region: 'str' = None,
        role_arn: 'str' = None,
        secondary_regions: 'list[V1AWSClusterSecondaryRegionSpec]' = None
    ):  # noqa: E501
    ...
    def disable_automatic_ami_updates(self,
                                      disable_automatic_ami_updates: 'bool'):
    ...
    def secondary_regions(
            self, secondary_regions: 'list[V1AWSClusterSecondaryRegionSpec]'):
