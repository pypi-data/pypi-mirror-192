from src.dependencies.fancy import colored, spinner
from src.dependencies.core import multiprocessing, time, abstractmethod, ABCMeta
from src.dependencies.datatypes import AbsModule
from src.libs import colorize_diff
