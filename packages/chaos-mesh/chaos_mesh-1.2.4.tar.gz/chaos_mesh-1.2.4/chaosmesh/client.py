...
class Client:
    ...
    def resume_experiment(self, experiment_type: Experiment, namespace: str, name: str, **kwargs):
        """
        Resumes the specified chaos experiment.

        Arguments:
            experiment_type (Experiment): The type of chaos experiment to resume.
            namespace (str): The namespace in which the experiment is running.
            name (str): The name of the chaos experiment.
            **kwargs: The optional parameters for the experiment.
        ...
        Returns:
            None
        """
        log.info(f"resuming {experiment_type.value} experiment {name} in {namespace} namespace")
        self.factory.get_experiment(experiment_type, **kwargs).resume(namespace=namespace, name=name)
