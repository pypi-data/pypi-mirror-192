...
class session(object):
    ...
    def enableStreaming(self, port:int = 0, threadCount:int = 1) -> None:
        ...
        Note:
            If the server you're connecting to supports subscription through reverse connection (connection initiated by the subscriber), do not specify its port. 
            If the server does not support subscription through reverse connection, the port must be specified.  
