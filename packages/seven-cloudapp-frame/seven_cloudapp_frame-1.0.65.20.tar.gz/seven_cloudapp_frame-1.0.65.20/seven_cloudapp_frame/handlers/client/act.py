...
@LastEditTime: 2023-02-17 09:49:33
...
class ActInfoHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        act_info_dict = act_base_model.get_act_info_dict(act_id, True, False, field)
        ...
        if act_info_dict.__contains__("share_desc_json") and act_info_dict["share_desc_json"]:
