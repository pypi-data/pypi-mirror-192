...
@LastEditTime: 2023-02-10 10:22:39
...
class AssetBaseModel():
    ...
    def get_asset_log_list(self, app_id, act_id, asset_type=0, page_size=20, page_index=0, user_id=0, asset_object_id="", start_date="", end_date="", user_nick="", open_id="", source_type=0, source_object_id=None, field="*", is_cache=True, operate_type=-1, page_count_mode="total"):
        ...
        asset_log_model = AssetLogModel(FrameBaseModel(context=self.context).get_business_sub_table("asset_log_tb",{"app_id":app_id}),context=self.context)
        if is_cache:
