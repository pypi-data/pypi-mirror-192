...
def plot(x: numpy.ndarray, y: numpy.ndarray, fig: plotly.graph_objects.Figure = None, xlabel: str = 'x', ylabel: str = 'y', name: str = '', axis_equal: bool = False, grid: str = 'default'):
    """
    ...
    if grid == 'on':
        ...
        fig = grid_off(fig)
    return fig
def plot3(x: numpy.ndarray, y: numpy.ndarray, z: numpy.ndarray, fig: plotly.graph_objects.Figure = None, xlabel: str = 'x', ylabel: str = 'y', zlabel: str = 'z', name: str = ''):
    """
...
def planet_state(jd: float, center: str, target: str) -> numpy.ndarray:
    ...
    ```
    """
    return FKIAMToolbox.ephemeris.planetstate(jd, target, center)
