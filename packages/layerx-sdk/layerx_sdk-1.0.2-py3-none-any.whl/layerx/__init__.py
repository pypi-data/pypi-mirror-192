...
class LayerxClient:
    ...
    def download_project_annotations(self, project_id: str, status_list, is_annotated_only):
        # init dataset client
        _dataset_client = dataset.DatasetClient(self.encoded_key_secret, self.layerx_url)

        # start download
        _dataset_client.download_annotations_for_project_v2(project_id, status_list, is_annotated_only)
