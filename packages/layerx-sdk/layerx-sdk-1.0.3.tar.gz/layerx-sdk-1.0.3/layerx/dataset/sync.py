...
class DatasetSync:
    ...
    def handle_one_download(self, arg_list):
        ...
        if self.local_download_abs_dir != None:
            ...
            file_path = os.path.join(self.local_download_abs_dir, self.data_directory_name, file_path)
    ...
    """
    def get_all_pages(self, call_url, page_no, status_list = [], is_annotated_only = False):
        payload = {
            'pageNo': page_no, 
            'pageSize': 250, 
    ...
    @param project_id 
    """
    def download_project_v2(self, project_id: str, status_list, is_annotated_only):

        # get collection url data from server
        _call_url = f'{self.server_url}/studio/api/client/getAnnotations/{project_id}/project'
        ...
        # start operation
        self.get_all_pages(_call_url, 0, status_list, is_annotated_only)
