...
def arg_parser():
    ...
    config, file = yaml_parser.parse_config()
    logger.log(message="Config file: " + file + 'found at absolute path: ' + os.path.abspath(file), log_level="info", to_file=True, to_terminal=True)
