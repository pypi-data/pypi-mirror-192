...
def check_latest_version():
    ...
    # print which config file is being used, and path to it
    logger.log(message="Using config file: " + yaml_parser.file, log_level="info", to_file=True, to_terminal=False)
