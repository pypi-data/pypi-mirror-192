...
def parse_config():
    config_files = [
        ...
        os.path.join(os.path.expanduser("~"), ".config", "sd-upload", "sd-upload-config.yml"),
        os.path.join(os.path.expanduser("~"), ".config", "sd-upload", "sd-upload-config.yaml"),
        os.path.join(os.path.expanduser("~"), ".config", "sd-upload", "config.yml"),
        os.path.join(os.path.expanduser("~"), ".config", "sd-upload", "config.yaml"),
        os.path.join(os.path.expanduser("~"), ".config", "sd-upload", "config"),
        os.path.join(os.path.expanduser("~"), ".config", "sd-upload", "sd-upload-config"),
        os.path.join(os.path.expanduser("~"), ".config", "sd-upload", "sd-upload-config"),
    ]
