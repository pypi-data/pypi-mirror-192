...
def parse_config():
    config_files = [
        ...
        "/opt/robin/config/sd-upload/sd-upload-config.yml",
        "/opt/robin/config/sd-upload/sd-upload-config.yaml"
        "/opt/robin/config/sd-upload-config.yml",
        "/opt/robin/config/sd-upload-config.yaml"
    ]
