...
def arg_parser():
    ...
    config_file_path = yaml_parser.get_config_path()
    # print which config file is being used and the path
    logger.log(message="Using config file: " + config_file_path, log_level="info", to_file=True, to_terminal=True)
    logger.log(message="Using config file: " + config_file_path, log_level="info", to_file=True, to_terminal=True)
