...
class ShortestPathEnv(gym.Env):
    ...
    Observation:
        - Graph entity of form ((n*1), (e,1), (2,e))
    ...
    Action:
        - integer v, indicating the addition of node v to the current path end
    Reward:
    ...
    def __init__(self, n_nodes, n_edges, weighted=True) -> None:
        ...
        self.observation_space = gym.spaces.Graph(node_space=gym.spaces.Box(low=0, high=3, shape=(n_nodes, 1)))
