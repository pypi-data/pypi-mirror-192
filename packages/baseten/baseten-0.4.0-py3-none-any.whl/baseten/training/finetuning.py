...
class FinetuningRun:
    ...
    **Examples:**
    ...
    @staticmethod
    def create(
        trained_model_name: str, fine_tuning_config: FinetuningConfig, verbosity: bool = True
        ...
        **Example:**
        ...
        Args:
            trained_model_name: The name you want your fine-tuned model to have
            fine_tuning_config: The configuration for the fine-tuning process
            verbosity: Toggle this to determine the verbosity of the output
        ...
        try:
            ...
            if verbosity:
                ...
                logger.info(
                    "\t* 📫 You'll get an email once the finetuning run completes, and will then be able to deploy it."
                )
    ...
    # Mutations
    def deploy(self, idle_time_minutes: int = 30, verbosity: bool = True) -> FoundationalModel:
        """
