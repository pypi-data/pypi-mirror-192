    ...
    def build_search_query(self, inp_db=None, schema=None, table=None, column_name=None,like_flag=None,
        ...
        if column_name != None:
            if type(column_name) == str:
                where_stmt = where_stmt + f"AND column_name like '{column_name}' " if like_flag == True else where_stmt + f"AND column_name = '{column_name}' "  # column name equals (if like_flag = false)
