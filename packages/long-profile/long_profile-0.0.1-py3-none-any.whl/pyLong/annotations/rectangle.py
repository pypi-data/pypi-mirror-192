...
class Rectangle(Annotation):
    def __init__(self):
        ...
        self._rectangle = mpl_Rectangle((0, 0),
                                        0,
                                        0,
    ...
    def update(self):
        ...
        self._rectangle.set_visible(self._visible and self._active)
