...
#07L3O00000Dy7SAUAZ
    def test_log_ID(self):
        try:
            InCli._main(["-u","NOSDEV","-logs","07L3O00000DyP4iUAF"])
        except Exception as e:
            print(e)
            print(traceback.format_exc())
    ...
    def test_log_file(self):
        try:
            ...
            res = InCli._main(["-logs","-inputfile",f"/Users/uormaechea/Downloads/logs_SF/apex-07L7T000003AWSiUAO.log"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)
    ...
    def test_log_tail_auto(self):
        try:
            #return
            InCli._main(["-u","NOSDEV","-logs","-tail","-auto"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)  
