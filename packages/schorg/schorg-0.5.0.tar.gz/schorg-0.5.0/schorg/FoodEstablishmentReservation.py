...
class FoodEstablishmentReservationProperties(TypedDict):
    ...
    Attributes:
        ...
        partySize: (Optional[Union[List[Union[SchemaOrgObj, int, str]], SchemaOrgObj, int, str]]): Number of people the reservation should accommodate.
    """
    ...
    partySize: NotRequired[Union[List[Union[SchemaOrgObj, int, str]], SchemaOrgObj, int, str]]
    

#FoodEstablishmentReservationInheritedPropertiesTd = FoodEstablishmentReservationInheritedProperties()
#FoodEstablishmentReservationPropertiesTd = FoodEstablishmentReservationProperties()
