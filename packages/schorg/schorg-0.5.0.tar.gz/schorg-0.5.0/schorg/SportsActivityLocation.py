...
#SportsActivityLocationInheritedPropertiesTd = SportsActivityLocationInheritedProperties()
#SportsActivityLocationPropertiesTd = SportsActivityLocationProperties()
