...
#CurrencyConversionServiceInheritedPropertiesTd = CurrencyConversionServiceInheritedProperties()
#CurrencyConversionServicePropertiesTd = CurrencyConversionServiceProperties()
