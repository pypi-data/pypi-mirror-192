...
#MedicalContraindicationInheritedPropertiesTd = MedicalContraindicationInheritedProperties()
#MedicalContraindicationPropertiesTd = MedicalContraindicationProperties()
