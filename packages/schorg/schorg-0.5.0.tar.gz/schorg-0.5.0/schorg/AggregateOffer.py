...
class AggregateOfferProperties(TypedDict):
    ...
    Attributes:
        ...
        offerCount: (Optional[Union[List[Union[SchemaOrgObj, int, str]], SchemaOrgObj, int, str]]): The number of offers for the product.
    ...
    offerCount: NotRequired[Union[List[Union[SchemaOrgObj, int, str]], SchemaOrgObj, int, str]]
...
#AggregateOfferInheritedPropertiesTd = AggregateOfferInheritedProperties()
#AggregateOfferPropertiesTd = AggregateOfferProperties()
