...
class CollectionProperties(TypedDict):
    ...
    Note:
        Model Depth 3
    Attributes:
        collectionSize: (Optional[Union[List[Union[SchemaOrgObj, int, str]], SchemaOrgObj, int, str]]): The number of items in the [[Collection]].
    """

    collectionSize: NotRequired[Union[List[Union[SchemaOrgObj, int, str]], SchemaOrgObj, int, str]]
    

#CollectionInheritedPropertiesTd = CollectionInheritedProperties()
#CollectionPropertiesTd = CollectionProperties()
