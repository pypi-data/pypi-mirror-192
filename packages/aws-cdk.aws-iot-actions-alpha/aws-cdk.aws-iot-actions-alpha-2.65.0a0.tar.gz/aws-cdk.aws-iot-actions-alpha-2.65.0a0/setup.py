    ...
    """
{
    ...
    "package_data": {
        "aws_cdk.aws_iot_actions_alpha._jsii": [
            "aws-iot-actions-alpha@2.65.0-alpha.0.jsii.tgz"
        ],
        "aws_cdk.aws_iot_actions_alpha": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-iot-alpha==2.65.0.a0",
        "aws-cdk.aws-iotevents-alpha==2.65.0.a0",
        "aws-cdk.aws-kinesisfirehose-alpha==2.65.0.a0",
