...
setup(
    ...
    description = ("Another example of the library making the shad robot"),
    license = "MIT",
    keywords = ["rubika","bot","robot","library","rubikalib","rubikalib.ml","rubikalib.ir","rubika.ir","Rubika","Python","libraryshad","ArseinRubika"],
