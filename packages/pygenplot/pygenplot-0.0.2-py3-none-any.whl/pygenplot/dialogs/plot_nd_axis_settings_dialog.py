...
class PlotNDAxisSettingsDialog(QtWidgets.QDialog):
    ...
    def _build(self):
        ...
        self._new_min_x_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self._new_max_x_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self._new_min_y_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self._new_max_y_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self._min_z_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self._max_z_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
