...
class InspectDataDialog(QtWidgets.QDialog):
    ...
    def _build(self):
        ...
        if self._dataset_info["dimension"] > 1:
            ...
            for i,s in enumerate(self._dataset_info["shape"]):
                ...
                self._lines.append([axis_label,row_radio_button,col_radio_button,slice_slider,slice_spinbox,sum_along_dimension_checkbox,range_label,sum_range_slider,min_range_spinbox,max_range_spinbox])
    ...
    def on_select_col(self,states):
        ...
        if row_id == col_id:
            ...
            self._lines[self._current_col][3].setDisabled(self._lines[self._current_col][5].isChecked())
            self._lines[col_id][4].setDisabled(True)
            self._lines[self._current_col][4].setDisabled(self._lines[self._current_col][5].isChecked())
            ...
            self._lines[self._current_col][6].setDisabled(not self._lines[self._current_col][5].isChecked())
            self._lines[col_id][7].setDisabled(True)
            self._lines[self._current_col][7].setDisabled(not self._lines[self._current_col][5].isChecked())
            self._lines[col_id][8].setDisabled(True)
            self._lines[self._current_col][8].setDisabled(not self._lines[self._current_col][5].isChecked())
            self._lines[col_id][9].setDisabled(True)
            self._lines[self._current_col][9].setDisabled(not self._lines[self._current_col][5].isChecked())
    ...
    def on_select_row(self,states):
        ...
        if row_id == col_id:
            ...
            self._lines[self._current_row][8].setDisabled(not self._lines[self._current_row][5].isChecked())
            self._lines[row_id][9].setDisabled(True)
            self._lines[self._current_row][9].setDisabled(not self._lines[self._current_row][5].isChecked())
