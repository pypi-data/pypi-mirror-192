...
class Plot1DAxisSettingsDialog(QtWidgets.QDialog):
    ...
    def _build(self):
        ...
        self._x_min_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self._x_max_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self._y_min_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self._y_max_doublespinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
