...
class PlotNDModel(QtCore.QObject):
    ...
    def set_x_integration_box(self,min_x,max_x):
        ...
        x_integration_box = Rectangle(origin,width,height,facecolor=(1,0,0,0.5),edgecolor=(0,0,0,1),fill=True,linewidth=2)
    ...
    def set_x_slicer(self,row):
        ...
        x_data = self._axis_info[self._x_index]["data"]*self._axis_conversion_factors[self._x_index]
        try:
            self._x_slicer = self._figure.axes[0].axvline(x=x_data[row],color=(1,0,0),linewidth=3)
        except IndexError:
    ...
    def set_y_integration_box(self,min_y,max_y):
        ...
        height = max_y - min_y
        y_integration_box = Rectangle(origin,width,height,facecolor=(0,1,0,0.5),edgecolor=(0,0,0,1),fill=True,linewidth=2)
    ...
    def set_y_slicer(self,column):
        ...
        y_data = self._axis_info[self._y_index]["data"]*self._axis_conversion_factors[self._y_index]
        try:
            self._y_slicer = self._figure.axes[0].axhline(y=y_data[column],color=(0,1,0),linewidth=3)
        except IndexError:
