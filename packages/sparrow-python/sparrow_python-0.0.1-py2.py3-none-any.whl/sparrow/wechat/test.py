...
import time
import os
# from sparrow.wechat import wxRobot
# from sparrow.wechat.wxRobot import WeChatRobot
import wxRobot
...
def test_send_text(instance):
    ...
    chat_with = instance.GetFriendByWxNickName("kunyuan")
    print(chat_with)
...
def test_friend_status(instance):
    ...
    print(f"{len(friend_list)}")
    index = "\t".join(['微信号', '昵称', '备注', '状态', '\n'])

    for Friend in friend_list:
        print([Friend.get('wxNumber'), Friend.get('wxNickName'), Friend.get('wxRemark'),
...
if __name__ == '__main__':
    ...
    # print(wx.GetWxUserInfo('filehelper'))
    # print(wx.GetFriendByWxNickName('kunyuan'))
    # print("文件传输助手:", wx.GetFriendByWxNickName('文件传输助手'))
    # test_send_text(wx)
    print('2')
    test_friend_status(wx)
