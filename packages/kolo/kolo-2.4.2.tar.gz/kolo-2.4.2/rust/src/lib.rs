...
mod _kolo {
    ...
    lazy_static! {
        static ref MIDDLEWARE_FINDER: Finder<'static> = Finder::new("\\kolo\\middleware.py");
        static ref TEMPLATE_FINDER: Finder<'static> =
            Finder::new("django\\template\\backends\\django.py");
        static ref HUEY_FINDER: Finder<'static> = Finder::new("\\huey\\api.py");
        static ref REQUESTS_FINDER: Finder<'static> = Finder::new("requests\\sessions");
        static ref URLLIB_FINDER: Finder<'static> = Finder::new("urllib\\request");
        static ref URLLIB3_FINDER: Finder<'static> = Finder::new("urllib3\\connectionpool");
        static ref LOGGING_FINDER: Finder<'static> = Finder::new("\\logging\\");
        static ref SQL_FINDER: Finder<'static> =
            Finder::new("\\django\\db\\models\\sql\\compiler.py");
        static ref PYTEST_FINDER: Finder<'static> = Finder::new("kolo\\pytest_plugin.py");
        static ref UNITTEST_FINDER: Finder<'static> = Finder::new("unittest\\result.py");
        static ref LIBRARY_FINDERS: [Finder<'static>; 3] = [
            Finder::new("lib\\python"),
            Finder::new("\\site-packages\\"),
            Finder::new("\\x64\\lib\\"),
        ];
        static ref LOWER_PYTHON_FINDER: Finder<'static> = Finder::new("\\python\\");
        static ref UPPER_PYTHON_FINDER: Finder<'static> = Finder::new("\\Python\\");
        static ref LOWER_LIB_FINDER: Finder<'static> = Finder::new("\\lib\\");
        static ref UPPER_LIB_FINDER: Finder<'static> = Finder::new("\\Lib\\");
        static ref KOLO_FINDERS: [Finder<'static>; 3] = [
            Finder::new("\\kolo\\middleware"),
            Finder::new("\\kolo\\profiler"),
            Finder::new("\\kolo\\serialize"),
        ];
    }
    ...
    lazy_static! {
        static ref MIDDLEWARE_FINDER: Finder<'static> = Finder::new("/kolo/middleware.py");
        static ref TEMPLATE_FINDER: Finder<'static> =
            Finder::new("django/template/backends/django.py");
        static ref HUEY_FINDER: Finder<'static> = Finder::new("/huey/api.py");
        static ref REQUESTS_FINDER: Finder<'static> = Finder::new("requests/sessions");
        static ref URLLIB_FINDER: Finder<'static> = Finder::new("urllib/request");
        static ref URLLIB3_FINDER: Finder<'static> = Finder::new("urllib3/connectionpool");
        static ref LOGGING_FINDER: Finder<'static> = Finder::new("/logging/");
        static ref SQL_FINDER: Finder<'static> = Finder::new("/django/db/models/sql/compiler.py");
        static ref PYTEST_FINDER: Finder<'static> = Finder::new("kolo/pytest_plugin.py");
        static ref UNITTEST_FINDER: Finder<'static> = Finder::new("unittest/result.py");
        static ref LIBRARY_FINDERS: [Finder<'static>; 2] =
            [Finder::new("lib/python"), Finder::new("/site-packages/")];
        static ref KOLO_FINDERS: [Finder<'static>; 3] = [
            Finder::new("/kolo/middleware"),
            Finder::new("/kolo/profiler"),
            Finder::new("/kolo/serialize"),
    ...
    lazy_static! {
        static ref CELERY_FINDER: Finder<'static> = Finder::new("celery");
        static ref SENTRY_FINDER: Finder<'static> = Finder::new("sentry_sdk");
        static ref DJANGO_FINDER: Finder<'static> = Finder::new("django");
        static ref FROZEN_FINDER: Finder<'static> = Finder::new("<frozen ");
        static ref EXEC_FINDER: Finder<'static> = Finder::new("<string>");
    }
