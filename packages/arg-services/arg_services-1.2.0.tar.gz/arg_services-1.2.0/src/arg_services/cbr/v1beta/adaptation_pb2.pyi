...
class AdaptResponse(google.protobuf.message.Message):
    ...
    EXTRAS_FIELD_NUMBER: builtins.int
    @property
    def cases(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AdaptedCaseResponse]: ...
    @property
    def extras(self) -> google.protobuf.struct_pb2.Struct: ...
    def __init__(
        self,
        *,
        cases: collections.abc.Iterable[global___AdaptedCaseResponse] | None = ...,
        extras: google.protobuf.struct_pb2.Struct | None = ...,
    ) -> None: ...
