...
def iou_loss(y_true, y_pred):
    ...
    # perfect overlap yields a value slightly greater than 0, and perfect non-overlap yields a value of 1.
    final = - intersection / union
...
def log_iou_loss(y_true, y_pred):
    ...
    final = - K.log((intersection + 1) / (union + 1))
