...
class VGG19Unet(SegmentationModel):
    ...
    def compile_model(self, loss: list = 'sparse_categorical_crossentropy',
        ...
        Args:
            ...
            loss_weights: the weights to apply to each loss;
...
class Unet(SegmentationModel):
    ...
    def compile_model(self, loss: str = 'sparse_categorical_crossentropy',
                      loss_weights: list = [1.0],
                      learning_rate: float = 0.001,
                      rescale_factor: float = 1 / 255,
                      include_residual: bool = False,
