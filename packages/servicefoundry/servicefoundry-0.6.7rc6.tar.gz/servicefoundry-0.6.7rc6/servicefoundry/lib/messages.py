...
your service folder"""
PROMPT_NO_DEPLOYMENTS = f"""[yellow]No deployments found."""
PROMPT_NO_APPLICATIONS = f"""[yellow]No applications found. You can create one with [bold]{SFY} deploy .[/] from within
your service folder"""
PROMPT_NO_VERSIONS = f"""[yellow]No versions found."""
PROMPT_LOGIN_POST_TENANT_CHANGE = f"""[yellow]Your session needs to be refreshed as a new tenant was configured.
Please login with [bold]{SFY} login[/]"""
