...
class FundingClient(KrakenBaseSpotAPI):
    ...
    def get_deposit_methods(self, asset: str) -> dict:
        ...
        return self._request(method='POST', uri='/private/DepositMethods', params={ 'asset': asset })
    ...
    def get_deposit_address(self, asset: str, method: str, new: bool=False) -> dict:
        ...
        return self._request(method='POST', uri='/private/DepositAddresses', params={
            'asset': asset,
            'method': method,
            'new': new
        })
    ...
    def withdraw_funds(self, asset: str, key: str, amount: str) -> dict:
        ...
        return self._request(method='POST', uri='/private/Withdraw', params={
            'asset': asset,
            'key': str(key),
            'amount': str(amount)
        })
    ...
    def get_withdrawal_info(self, asset: str, key: str, amount: str) -> dict:
        ...
        return self._request(method='POST', uri='/private/WithdrawInfo', params={
            'asset': asset,
            'key': str(key),
            'amount': str(amount)
        })
    ...
    def cancel_withdraw(self, asset: str, refid: str) -> dict:
        ...
        return self._request(method='POST', uri='/private/WithdrawCancel', params={
            'asset': asset,
            'refid': str(refid)
        })
    ...
    def wallet_transfer(self, asset: str, from_: str, to_: str, amount: str) -> dict:
        ...
        return self._request(method='POST', uri='/private/WalletTransfer', params={
            'asset': asset,
            'from': from_,
            'to': to_,
            'amount': amount
