...
class FundingClient(KrakenBaseFuturesAPI):
    ...
    def initiate_wallet_transfer(self, amount: str, fromAccount: str, toAccount: str, unit: str) -> dict:
        ...
        return self._request(method='POST', uri='/derivatives/api/v3/transfer', post_params={
            'amount': amount,
    ...
    def initiate_subccount_transfer(self,
        ...
        return self._request(method='POST', uri='/derivatives/api/v3/transfer/subaccount', post_params={
            'amount': amount,
            'fromAccount': fromAccount,
            'fromUser': fromUser,
            'toAccount': toAccount,
    ...
    def initiate_withdrawal_to_spot_wallet(self, amount: str, currency: str, sourceWallet: str=None, **kwargs) -> dict:
        ...
        return self._request(method='POST', uri='/derivatives/api/v3/withdrawal', post_params=params, auth=True)