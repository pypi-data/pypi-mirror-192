...
_PERGENERICSTEPDETAILS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unknown_time_ms', full_name='tensorflow.profiler.PerGenericStepDetails.unknown_time_ms', index=3,
      number=3, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_wait_input_ms', full_name='tensorflow.profiler.PerGenericStepDetails.host_wait_input_ms', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_to_device_ms', full_name='tensorflow.profiler.PerGenericStepDetails.host_to_device_ms', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_ms', full_name='tensorflow.profiler.PerGenericStepDetails.output_ms', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_compute_ms', full_name='tensorflow.profiler.PerGenericStepDetails.device_compute_ms', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_to_device_ms', full_name='tensorflow.profiler.PerGenericStepDetails.device_to_device_ms', index=8,
      number=7, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_collectives_ms', full_name='tensorflow.profiler.PerGenericStepDetails.device_collectives_ms', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_compute_ms', full_name='tensorflow.profiler.PerGenericStepDetails.host_compute_ms', index=10,
      number=8, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_prepare_ms', full_name='tensorflow.profiler.PerGenericStepDetails.host_prepare_ms', index=11,
      number=9, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_compile_ms', full_name='tensorflow.profiler.PerGenericStepDetails.host_compile_ms', index=12,
      number=10, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
