...
class CreateCollectionRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, chain, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): The name of this item collection. This can be anything, such as `Production - Item Collection`, `Testing - My Game Item Collection`, etc.. [optional]  # noqa: E501
        """
