...
class ThinksDashMobileDropdown(Component):
    """A ThinksDashMobileDropdown component.
...
- value (string | number; optional)"""
    ...
    _namespace = 'thinks_dash_mobile_dropdown'
    _type = 'ThinksDashMobileDropdown'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, options=Component.UNDEFINED, value=Component.UNDEFINED, notfoundMsg=Component.UNDEFINED, clearable=Component.UNDEFINED, **kwargs):
        ...
        super(ThinksDashMobileDropdown, self).__init__(**args)
