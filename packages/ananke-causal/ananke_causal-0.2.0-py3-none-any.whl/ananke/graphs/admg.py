...
class ADMG(SG):
    ...
    def subgraph(self, vertices):
        ...
        di_edges = [
            e for e in self.di_edges if e[0] in vertices and e[1] in vertices
        ]
        bi_edges = [
            e for e in self.bi_edges if e[0] in vertices and e[1] in vertices
        ]
    ...
    def get_intrinsic_sets_and_heads(self):
        ...
        :return: tuple of dict of intrinsic sets to heads and tails, and fixing orders for each intrinsic set
