...
class CredentialStoreStatic(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope_id: The scope for this credential store. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/boundary/r/credential_store_static#scope_id CredentialStoreStatic#scope_id}
        :param description: The static credential store description. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/boundary/r/credential_store_static#description CredentialStoreStatic#description}
        :param name: The static credential store name. Defaults to the resource name. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/boundary/r/credential_store_static#name CredentialStoreStatic#name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
