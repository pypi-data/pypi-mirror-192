...
class CredentialSshPrivateKey(
    ...
    def __init__(
        ...
        *,
        ...
        :param credential_store_id: ID of the credential store this credential belongs to. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/boundary/r/credential_ssh_private_key#credential_store_id CredentialSshPrivateKey#credential_store_id}
        :param private_key: The private key associated with the credential. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/boundary/r/credential_ssh_private_key#private_key CredentialSshPrivateKey#private_key}
        :param username: The username associated with the credential. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/boundary/r/credential_ssh_private_key#username CredentialSshPrivateKey#username}
        :param description: The description of the credential. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/boundary/r/credential_ssh_private_key#description CredentialSshPrivateKey#description}
        :param name: The name of the credential. Defaults to the resource name. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/boundary/r/credential_ssh_private_key#name CredentialSshPrivateKey#name}
        :param private_key_passphrase: The passphrase of the private key associated with the credential. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/boundary/r/credential_ssh_private_key#private_key_passphrase CredentialSshPrivateKey#private_key_passphrase}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
