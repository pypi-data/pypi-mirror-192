...
def to_week_tow(epoch: datetime.datetime, time_scale: TimeScale= TimeScale.GPS) -> WeekTow:
    """
    ...
    >>> to_week_tow(datetime.datetime(2005, 1, 28, 13, 30), TimeScale.GPS)
...
def from_week_tow(week: int, tow: float, time_scale: TimeScale=TimeScale.GPS) -> datetime.datetime:
    """
    Convert from datetime to GPS week
