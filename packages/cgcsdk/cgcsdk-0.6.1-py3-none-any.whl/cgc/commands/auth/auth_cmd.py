...
from cgc.utils.prepare_headers import get_url_and_headers_jwt_token
...
def auth_register(user_id: str, access_key: str):
    ...
    url, headers = get_url_and_headers_jwt_token(user_id, access_key)
...
def api_keys_create(user_id: str, password: str):
    ...
    :type password: str
    """
    auth_create_api_key_with_save(user_id=user_id, password=password)
