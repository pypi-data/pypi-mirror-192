...
class DataExtractionModule(_object):
    ...
    if _newclass:
        ExtractToXSLX = staticmethod(_PDFNetPython.DataExtractionModule_ExtractToXSLX)
    else:
        ExtractToXSLX = _PDFNetPython.DataExtractionModule_ExtractToXSLX
...
DataExtractionModule_ExtractToXSLX = _PDFNetPython.DataExtractionModule_ExtractToXSLX
