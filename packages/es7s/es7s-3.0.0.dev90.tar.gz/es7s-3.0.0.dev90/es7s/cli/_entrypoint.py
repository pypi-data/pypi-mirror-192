...
def init_cli():
    ...
    logger_params, io_params, spec_args = _filter_common_args(sys.argv)
    sys.argv = spec_args
...
def _filter_common_args(args: list[str]) -> tuple[LoggerParams, IoParams, list[str]]:
    filtered = []
    lp = LoggerParams()
    iop = IoParams()
