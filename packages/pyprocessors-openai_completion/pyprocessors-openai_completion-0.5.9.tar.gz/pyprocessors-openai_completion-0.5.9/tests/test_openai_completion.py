    ...
    docs = [
        Document(
            ...
            altTexts=[
                AltText(
                    name="prompt",
                    text="Peux tu écrire un article de presse concernant: $text",
                )
            ],
        ),
        Document(
            ...
            altTexts=[
                AltText(
                    name="prompt",
                    text="Peux tu me donner des phrases similaires à: $text",
                )
            ],
        ),
        Document(
            ...
            altTexts=[
                AltText(
                    name="prompt",
                    text="Peux tu me donner des phrases similaires en changeant le format de date à: $text",
                )
            ],
        ),
        Document(
            ...
            altTexts=[
                AltText(
                    name="prompt",
                    text="Peux résumer dans un style journalistique le texte suivant: $text",
                )
            ],
        ),
        Document(
...
def test_openai_text():
    parameters = OpenAICompletionParameters(
        model=OpenAIModel.text_davinci_003,
        max_tokens=120,
        best_of=3,
        n=3,
