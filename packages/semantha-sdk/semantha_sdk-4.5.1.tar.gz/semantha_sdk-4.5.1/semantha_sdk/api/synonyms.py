...
from semantha_sdk.model.synonym import Synonym as SynonymDTO
from semantha_sdk.model.schema.synonym import SynonymSchema


class Synonym(SemanthaAPIEndpoint):
...
class Synonyms(SemanthaAPIEndpoint):
    ...
    def __call__(self, id: str):
        return Synonym(self._session, self._endpoint, id)
