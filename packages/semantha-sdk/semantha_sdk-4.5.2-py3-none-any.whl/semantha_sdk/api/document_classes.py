...
from semantha_sdk.model.document_class import DocumentClass as DocumentClassDTO
from semantha_sdk.model.schema.document import DocumentSchema
from semantha_sdk.model.schema.document_class import DocumentClassSchema


class DocumentClass(SemanthaAPIEndpoint):
    ...
    def __init__(self, session: RestClient, parent_endpoint: str, id: str):
        ...
        self._id = id
        self.__child_document_classes = DocumentClass.InnerDocumentClasses(session, self._endpoint)
        self.__child_reference_documents = DocumentClass.InnerReferenceDocuments(session, self._endpoint)
...
class DocumentClasses(SemanthaAPIEndpoint):
    ...
    def __call__(self, id: str):
        return DocumentClass(self._session, self._endpoint, id)
