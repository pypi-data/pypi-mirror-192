...
from semantha_sdk.model.boost_word import Boostword as BoostwordDTO
from semantha_sdk.model.schema.boost_word import BoostwordSchema
from semantha_sdk.rest.rest_client import RestClient


class Boostword(SemanthaAPIEndpoint):
...
class Boostwords(SemanthaAPIEndpoint):
    ...
    def __call__(self, id: str):
        return Boostword(self._session, self._endpoint, id)
