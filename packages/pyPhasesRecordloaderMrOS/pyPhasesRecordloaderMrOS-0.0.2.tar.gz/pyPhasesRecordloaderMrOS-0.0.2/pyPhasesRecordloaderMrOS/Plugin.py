...
class Plugin(PluginAdapter):
    def initPlugin(self):
        ...
        RecordLoader.registerRecordLoader("MrOSAnnotationLoader", "pyPhasesRecordloaderMrOS.recordLoaders")
        mrosPath = self.getConfig("mros-path")
        self.project.setConfig("loader.mros.dataset.downloader.basePath", mrosPath + "/polysomnography/edfs/visit1/")
