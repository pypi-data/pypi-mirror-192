...
ID_ROW = "id"
USERID_ROW = 'employee_id'
GUID_ROW = "guid"
SOURCEID_ROW = "source_id"
FILENAME_ROW = "filename"
TIMEZONE_ROW = "employee_timezone"
...
sql_event_descriptions = {
    ...
    DATE_LOCAL_ROW: 'The date of the event in the employee\'s local timezone.',
