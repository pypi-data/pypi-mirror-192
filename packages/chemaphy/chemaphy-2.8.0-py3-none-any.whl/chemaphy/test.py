...
#         if i>0:
#             diff.append(args[i]-args[i-1])
    
# print(AP([1,2,3,4,5]))

# from chemaphy import Calculus,Bool,Mathematics

# print(Mathematics.arithmeticProgression(1,2,5))
# print(Mathematics.geometricProgression(1,2,5))
# print(Mathematics.sumArithmeticProgression(1,2,5))
# print(Mathematics.sumGeometricProgression(1,2,5))

# print(Calculus.differentiate("log(x)/tan(x)","x")) 
# print(Calculus.integrate("log(x)/tan(x)","x"))
# print(Bool.true)
# print(Bool.false)
