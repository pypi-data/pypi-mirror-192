...
def get_app_urlpatterns() -> list[URLPattern]:
    """
    ...
    Перехват исключительных ситуаций данной функции необходимо осуществлять
    вручную в urls.py прикладных приложений
    """
    
    url_patterns: list[URLPattern] = []
    procs: list[callable] = get_callables_from_modules('app_meta', 'register_urlpatterns')
