...
def process_member_sample(samples) -> dict:
    """
    ...
    for sample_item in samples:
        ...
        if 'type' in sample_item and \
                sample_item['type'] == 'journal-article':

            preservation_statuses, doi = \
                preservation_status(sample_item)
