...
class GeoArray(object):
    ...
    def get_mapPos(self, mapBounds, mapBounds_prj=None, band2get=None, out_prj=None, out_gsd=None, arr_gt=None,
                   arr_prj=None, fillVal=None, rspAlg='near', progress=None, v=False
                   ):  # TODO implement slice for indexing bands
        # type: (tuple, Union[str, int], int, Union[str, int], tuple, tuple, str, int, str, bool, bool) -> (np.ndarray, tuple, str)  # noqa
