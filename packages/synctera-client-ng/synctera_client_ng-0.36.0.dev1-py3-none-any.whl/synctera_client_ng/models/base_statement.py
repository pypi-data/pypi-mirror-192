...
class BaseStatement(BaseModel):
    ...
    transactions: Optional[List[Transaction]] = Field(None, description="This attribute is deprecated and will be removed in a future API version. Use `GET /v0/statements/{statement_id}/transactions` instead. ")
