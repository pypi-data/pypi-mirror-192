...
class Operation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["execution_context", b"execution_context", "python", b"python"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["command", b"command", "description", b"description", "dockerImage", b"dockerImage", "env", b"env", "execution_context", b"execution_context", "inputSlots", b"inputSlots", "name", b"name", "outputSlots", b"outputSlots", "poolSpecName", b"poolSpecName", "python", b"python"]) -> None: ...
