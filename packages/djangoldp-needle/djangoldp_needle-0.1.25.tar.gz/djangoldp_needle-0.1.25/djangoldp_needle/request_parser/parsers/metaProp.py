...
class MetaProp(AbstractParser):
    def parse(self, annotation_target: AnnotationTarget, target_url, bs_document, previous_parse_result):
        ...
        selectors = ["meta[name='pubdate']","meta[name='article:published_time']","meta[name='DC:date']","meta[name='DC.date']","meta[name='article:published_time']",
                     "meta[property='pubdate']","meta[property='article:published_time']","meta[property='DC:date']","meta[property='DC.date']","meta[property='article:published_time']"]
        ...
        for selector in selectors:
            if annotation_target.publication_date is None:
                ...
                if date_published_element:
                    ...
                    if content:
                        annotation_target.publication_date = JSONLD().try_strptimeAll(content).isoformat()
