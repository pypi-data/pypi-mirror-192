...
class Tree:
    ...
    def get_bbox(self,nodeid=None,rootid=None):
        """Return bounding box positions covering the tree. 
        
        If nodeid is None, then bounding box of the whole tree. 
        Otherwise, bounding box of the given set of nodes.
    ...
    def compute_local_3d_scale_sigma(self,sig_lst,dim_param=None,decomposed_method="leaf",rootid=None):
    ...
    def compute_local_3d_scale_radius(self,r_lst,dim_param=None,decomposed_method="leaf",rootid=None):
