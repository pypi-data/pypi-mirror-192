...
class ctd_t(object):
    ...
    __typenames__ = ["compas_lcmtypes.standard.header_t", "double", "double", "double", "double", "double"]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x27e09d290728ae11+ compas_lcmtypes.standard.header_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
