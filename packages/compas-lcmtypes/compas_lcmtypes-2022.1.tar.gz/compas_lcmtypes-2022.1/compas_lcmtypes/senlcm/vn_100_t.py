...
class vn_100_t(object):
    __slots__ = ["utime", "byteGroups", "bytesG1", "bytesG2", "bytesG3", "timeStartup", "rpy", "quaternion", "angRateComp", "accelComp", "magFieldComp", "Temperature", "Pressure", "insStatus", "syncInCnt", "magFieldUncomp", "accelUncomp", "angRateUncomp"]

    __typenames__ = ["int64_t", "int8_t", "int16_t", "int16_t", "int16_t", "int64_t", "double", "double", "double", "double", "double", "double", "double", "int16_t", "int32_t", "double", "double", "double"]

    __dimensions__ = [None, None, None, None, None, None, [3], [4], [3], [3], [3], None, None, None, None, [3], [3], [3]]
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(vn_100_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != vn_100_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return vn_100_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if vn_100_t in parents: return 0
        tmphash = (0x5f29dec93e61e63a) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if vn_100_t._packed_fingerprint is None:
            vn_100_t._packed_fingerprint = struct.pack(">Q", vn_100_t._get_hash_recursive([]))
        return vn_100_t._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", vn_100_t._get_packed_fingerprint())[0]
