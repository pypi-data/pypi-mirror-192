...
class Meta2Vec:
    ...
    def __init__(self, embedding_path="embedding/TransE_HMDB_Embedding.pkl"):
        ...
        embedding_path (str): path to the HMDB embeddings file
        """
        if not os.exists("embedding"):
            os.mkdir("embedding")
        if not os.exists(embedding_path):
            urllib.request.urlretrieve("https://github.com/PKU-BDBA/HMKG-Progress/blob/main/Meta2Vec/embedding/TransE_HMDB_Embedding.pkl",embedding_path)
