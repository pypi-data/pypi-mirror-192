...
class ExportedModel final :
 ...
 public:
  ...
  void clear_save_node_name();
  const std::string& save_node_name() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_save_node_name(ArgT0&& arg0, ArgT... args);
  std::string* mutable_save_node_name();
  PROTOBUF_NODISCARD std::string* release_save_node_name();
  void set_allocated_save_node_name(std::string* save_node_name);
  private:
  const std::string& _internal_save_node_name() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_save_node_name(const std::string& value);
  std::string* _internal_mutable_save_node_name();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr save_node_name_;
...
// string save_node_name = 7;
inline void ExportedModel::clear_save_node_name() {
  _impl_.save_node_name_.ClearToEmpty();
}
inline const std::string& ExportedModel::save_node_name() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.ExportedModel.save_node_name)
  return _internal_save_node_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ExportedModel::set_save_node_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.save_node_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tensorflow.quantization.ExportedModel.save_node_name)
}
inline std::string* ExportedModel::mutable_save_node_name() {
  std::string* _s = _internal_mutable_save_node_name();
  // @@protoc_insertion_point(field_mutable:tensorflow.quantization.ExportedModel.save_node_name)
  return _s;
}
inline const std::string& ExportedModel::_internal_save_node_name() const {
  return _impl_.save_node_name_.Get();
}
inline void ExportedModel::_internal_set_save_node_name(const std::string& value) {
  
  _impl_.save_node_name_.Set(value, GetArenaForAllocation());
}
inline std::string* ExportedModel::_internal_mutable_save_node_name() {
  
  return _impl_.save_node_name_.Mutable(GetArenaForAllocation());
}
inline std::string* ExportedModel::release_save_node_name() {
  // @@protoc_insertion_point(field_release:tensorflow.quantization.ExportedModel.save_node_name)
  return _impl_.save_node_name_.Release();
}
inline void ExportedModel::set_allocated_save_node_name(std::string* save_node_name) {
  if (save_node_name != nullptr) {
    
  } else {
    
  }
  _impl_.save_node_name_.SetAllocated(save_node_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.save_node_name_.IsDefault()) {
    _impl_.save_node_name_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:tensorflow.quantization.ExportedModel.save_node_name)
}
