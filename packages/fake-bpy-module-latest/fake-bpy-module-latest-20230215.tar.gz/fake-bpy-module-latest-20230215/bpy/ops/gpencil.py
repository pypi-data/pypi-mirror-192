...
def tint_flip(override_context: typing.Union[typing.
              ...
              execution_context: typing.Union[str, int] = None,
              undo: typing.Optional[bool] = None):
    ''' Switch tint colors :file: `startup/bl_ui/properties_grease_pencil_common.py\:869 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_ui/properties_grease_pencil_common.py$869>`_
