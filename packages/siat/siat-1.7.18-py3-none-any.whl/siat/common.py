...
def descriptive_statistics(df,titletxt,footnote,decimals=4,sortby='tpw_mean'):
    ...
    dst2.reset_index(drop=True,inplace=True)
    dst2.index=dst2.index+1
    
    print("\n"+titletxt+"\n")
    alignlist=['right','left']+['center']*(len(list(dst2))-1)
    print(dst2.to_markdown(index=True,tablefmt='plain',colalign=alignlist))
