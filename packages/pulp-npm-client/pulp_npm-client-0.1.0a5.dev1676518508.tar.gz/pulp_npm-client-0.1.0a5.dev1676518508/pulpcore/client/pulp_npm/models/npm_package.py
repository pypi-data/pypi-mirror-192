...
class NpmPackage(object):
    ...
    def __init__(self, artifact=None, relative_path=None, file=None, repository=None, upload=None, name=None, version=None, local_vars_configuration=None):  # noqa: E501
