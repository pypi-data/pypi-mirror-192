...
if os.name != 'nt' and os.environ.get('VAULTDB_DISABLE_PARALLEL_COMPILE', '') != '1':
...
if 'VAULTDB_INSTALL_USER' in os.environ and 'install' in sys.argv:
...
toolchain_args.append('-DVAULTDB_PYTHON_LIB_NAME='+lib_name)

if platform.system() == 'Darwin':
    toolchain_args.extend(['-stdlib=libc++', '-mmacosx-version-min=10.7'])

if platform.system() == 'Windows':
    toolchain_args.extend(['-DVAULTDB_BUILD_LIBRARY','-DWIN32'])
...
setup(
    ...
    long_description = 'See here for an introduction: https://vaultdb.ai/docs/api/python/overview',
    license='MIT',
    ...
    ext_modules = [libvaultdb],
    maintainer = "vaultdb.ai",
    maintainer_email = "support@vaultdb.ai",
    cmdclass={"build_ext": build_ext},
    project_urls={
        "Documentation": "https://vaultdb.ai/docs/api/python/overview",
