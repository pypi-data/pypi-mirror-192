...
CatalogEntry *SchemaCatalogEntry::CreateRole(CatalogTransaction transaction, CreateRoleInfo *info){
	throw NotImplementedException("CreateFortress, Not supported for this type of Schema");
}

CatalogEntry *SchemaCatalogEntry::CreateTag(CatalogTransaction transaction, CreateTagInfo *info){
	throw NotImplementedException("CreateFortress, Not supported for this type of Schema");
}

CatalogEntry *SchemaCatalogEntry::CreateFortress(CatalogTransaction transaction, CreateFortressInfo *info){
	throw NotImplementedException("CreateFortress, Not supported for this type of Schema");
}
