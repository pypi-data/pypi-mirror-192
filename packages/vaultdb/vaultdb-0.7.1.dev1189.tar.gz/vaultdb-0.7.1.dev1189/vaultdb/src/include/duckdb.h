...
#ifndef DUCKDB_API
#ifdef _WIN32
#if defined(VAULTDB_BUILD_LIBRARY) && !defined(VAULTDB_BUILD_LOADABLE_EXTENSION)
...
#ifdef _WIN32
#ifdef VAULTDB_BUILD_LOADABLE_EXTENSION
...
#ifndef VAULTDB_API_VERSION
#define VAULTDB_API_VERSION DUCKDB_API_LATEST
#endif
...
typedef struct {
#if VAULTDB_API_VERSION < DUCKDB_API_0_3_2
	void *data;
	bool *nullmask;
	duckdb_type type;
	char *name;
