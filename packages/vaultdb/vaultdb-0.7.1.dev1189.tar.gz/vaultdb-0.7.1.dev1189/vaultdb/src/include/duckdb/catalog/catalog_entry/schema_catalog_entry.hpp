...
public:
	...
	virtual CatalogEntry *CreateRole(CatalogTransaction transaction, CreateRoleInfo *info);
	//! Creates a tag with the given name in the schema
	virtual CatalogEntry *CreateTag(CatalogTransaction transaction, CreateTagInfo *info);
	//! Creates a Fortress with the given name in the schema
	virtual CatalogEntry *CreateFortress(CatalogTransaction transaction, CreateFortressInfo *info);
