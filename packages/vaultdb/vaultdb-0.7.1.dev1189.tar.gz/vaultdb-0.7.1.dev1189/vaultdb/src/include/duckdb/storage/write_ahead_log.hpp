...
protected:
	...
	void ReplayDropRole();
	void ReplayCreateTag();
	void ReplayDropTag();
	void ReplayCreateFortress();
	void ReplayDropFortress();
};
...
public:
	...
	void WriteCreateRole(RoleCatalogEntry *entry);
	void WriteDropRole(RoleCatalogEntry *entry);

	void WriteCreateTag(TagCatalogEntry *entry);
	void WriteDropTag(TagCatalogEntry *entry);

	void WriteCreateFortress(FortressCatalogEntry *entry);
	void WriteDropFortress(FortressCatalogEntry *entry);
