...
protected:
	...
	virtual void WriteRole(RoleCatalogEntry &table);
	virtual void WriteTag(TagCatalogEntry &table);
	virtual void WriteFortress(FortressCatalogEntry &table);
...
protected:
	...
	virtual void ReadRole(ClientContext &context, MetaBlockReader &reader);
	virtual void ReadTag(ClientContext &context, MetaBlockReader &reader);
	virtual void ReadFortress(ClientContext &context, MetaBlockReader &reader);
