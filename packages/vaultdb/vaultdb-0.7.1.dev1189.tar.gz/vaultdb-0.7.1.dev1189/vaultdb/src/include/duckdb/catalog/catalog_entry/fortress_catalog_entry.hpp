...
public:
	...
	//! Serialize the meta information of the FortressCatalogEntry a serializer
	virtual void Serialize(Serializer &serializer);
	//! Deserializes to a CreateTableInfo
	static unique_ptr<CreateFortressInfo> Deserialize(Deserializer &source);
	
	bool isLocked();
	
	void AddFortressToTableEntry(CatalogTransaction transaction);
