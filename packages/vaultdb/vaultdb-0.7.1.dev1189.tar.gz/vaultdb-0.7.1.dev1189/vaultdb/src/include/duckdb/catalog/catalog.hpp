...
public:
	...
	DUCKDB_API CatalogEntry *CreateRole(CatalogTransaction transaction, CreateRoleInfo *info);
	DUCKDB_API CatalogEntry *CreateRole(ClientContext &context, CreateRoleInfo *info);
	//! Creates a Tag in the catalog.
	DUCKDB_API CatalogEntry *CreateTag(CatalogTransaction transaction, CreateTagInfo *info);
	DUCKDB_API CatalogEntry *CreateTag(ClientContext &context, CreateTagInfo *info);
	//! Creates a Fortress in the catalog.
	DUCKDB_API CatalogEntry *CreateFortress(CatalogTransaction transaction, CreateFortressInfo *info);
	DUCKDB_API CatalogEntry *CreateFortress(ClientContext &context, CreateFortressInfo *info);
	...
	//! Creates a role in the catalog.
	DUCKDB_API CatalogEntry *CreateRole(CatalogTransaction transaction, SchemaCatalogEntry *schema,
	                                        CreateRoleInfo *info);
	//! Creates a Tag in the catalog.
	DUCKDB_API CatalogEntry *CreateTag(CatalogTransaction transaction, SchemaCatalogEntry *schema,
	                                        CreateTagInfo *info);
	//! Creates a Fortress in the catalog.
	DUCKDB_API CatalogEntry *CreateFortress(CatalogTransaction transaction, SchemaCatalogEntry *schema,
