...
public:
	explicit Transformer(ClientContext *context, idx_t max_expression_depth_p);
...
private:
	...
	unique_ptr<CreateStatement> TransformCreateRole(duckdb_libpgquery::PGNode *node);
	//! Transform a Postgres duckdb_libpgquery::T_PGCreateTagStmt node into CreateStatement
	unique_ptr<CreateStatement> TransformCreateTag(duckdb_libpgquery::PGNode *node);
	//! Transform a Postgres duckdb_libpgquery::T_PGCreateFortressStmt node into CreateStatement
	unique_ptr<CreateStatement> TransformCreateFortress(duckdb_libpgquery::PGNode *node);
	//! Transform a Postgres duckdb_libpgquery::T_PGAlterFortressStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformAlterFortress(duckdb_libpgquery::PGNode *node);
	//! Transform a Postgres duckdb_libpgquery::T_PGLockFortressStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformLockFortress(duckdb_libpgquery::PGNode *node);
	//! Transform a Postgres duckdb_libpgquery::T_PGUnLockFortressStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformUnlockFortress(duckdb_libpgquery::PGNode *node);
	//! Transform a Postgres duckdb_libpgquery::T_PGGrantStmt or T_PGRevokeStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformPrivilege(AlterRoleType type, duckdb_libpgquery::PGNode *node);
	//! Transform a Postgres duckdb_libpgquery::T_PGAlterRoleStmt node into CreateStatement
	unique_ptr<AlterStatement> TransformAlterRole(duckdb_libpgquery::PGNode *node);
