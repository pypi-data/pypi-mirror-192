...
void CommitState::WriteCatalogEntry(CatalogEntry *entry, data_ptr_t dataptr) {
	...
	case CatalogType::ROLE_ENTRY:
		log->WriteCreateRole((RoleCatalogEntry *)parent);
		break;
	case CatalogType::TAG_ENTRY:
		log->WriteCreateTag((TagCatalogEntry *)parent);
		break;
	case CatalogType::FORTRESS_ENTRY:
		log->WriteCreateFortress((FortressCatalogEntry *)parent);
		break;
	...
	case CatalogType::DELETED_ENTRY:
		...
		case CatalogType::SEQUENCE_ENTRY:
			...
			break;
		case CatalogType::ROLE_ENTRY:
			log->WriteDropRole((RoleCatalogEntry *)entry);
			break;
		case CatalogType::TAG_ENTRY:
			log->WriteDropTag((TagCatalogEntry *)entry);
			break;
		case CatalogType::FORTRESS_ENTRY:
			log->WriteDropFortress((FortressCatalogEntry *)entry);
			break;
		case CatalogType::MACRO_ENTRY:
