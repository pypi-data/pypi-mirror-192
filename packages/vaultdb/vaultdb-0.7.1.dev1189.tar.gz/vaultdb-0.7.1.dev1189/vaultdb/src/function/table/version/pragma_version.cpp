#ifndef VAULTDB_VERSION
#define VAULTDB_VERSION "0.7.1-dev1189"
#endif
#ifndef VAULTDB_SOURCE_ID
#define VAULTDB_SOURCE_ID "16c5bd66a0"
#endif
...
const char *DuckDB::SourceID() {
	return VAULTDB_SOURCE_ID;
}

const char *DuckDB::LibraryVersion() {
	return VAULTDB_VERSION;
}
