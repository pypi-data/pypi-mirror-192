...
ExtensionLoadResult ExtensionHelper::LoadExtensionInternal(DuckDB &db, const std::string &extension,
	...
	if (!initial_load && StringUtil::Contains(DUCKDB_TEST_REMOTE_INSTALL, extension)) {
		Connection con(db, INTERNAL_ROLE);
...
-----END PUBLIC KEY-----
	...
	R"(
-----BEGIN PUBLIC KEY-----

NQIDAQAB
-----END PUBLIC KEY-----
)",
    R"(
