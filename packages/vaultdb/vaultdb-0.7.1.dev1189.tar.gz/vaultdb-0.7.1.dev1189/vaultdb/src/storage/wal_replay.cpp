...
// Replay Role
//===--------------------------------------------------------------------===//
void ReplayState::ReplayCreateRole() {
	auto info = RoleCatalogEntry::Deserialize(source);
	if (deserialize_only) {
		return;
	}
...
void ReplayState::ReplayDropRole() {
	DropInfo info;
...
// Replay Tag
//===--------------------------------------------------------------------===//
void ReplayState::ReplayCreateTag() {
	auto info = TagCatalogEntry::Deserialize(source);
	if (deserialize_only) {
		return;
	}
...
void ReplayState::ReplayDropTag() {
	DropInfo info;
...
// Replay Fortress
//===--------------------------------------------------------------------===//
void ReplayState::ReplayCreateFortress() {
	auto info = FortressCatalogEntry::Deserialize(source);
	if (deserialize_only) {
		return;
	}
...
void ReplayState::ReplayDropFortress() {
	DropInfo info;
