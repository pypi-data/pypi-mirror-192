...
unique_ptr<CreateStatement> Transformer::TransformCreateTag(duckdb_libpgquery::PGNode *node) {
	auto stmt = reinterpret_cast<duckdb_libpgquery::PGCreateTagStmt *>(node);
	D_ASSERT(stmt);
	(void)stmt;
