...
#
# This file is part of pyvaultdb.
#
...
# to remove tests that are for features that are not supported by VaultDB.
...
class VaultDBTypeTests(unittest.TestCase):
    def setUp(self):
        self.con = vaultdb.connect(":memory:")
