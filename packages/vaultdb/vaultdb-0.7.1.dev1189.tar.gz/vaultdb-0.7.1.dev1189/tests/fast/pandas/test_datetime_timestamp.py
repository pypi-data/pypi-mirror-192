...
class TestDateTimeTimeStamp(object):
    ...
    def test_timestamp_high(self, duckdb_cursor):
        duckdb_time = vaultdb.query("SELECT '2260-01-01 23:59:00'::TIMESTAMP AS '0'").df()
        df_in = pd.DataFrame(
    ...
    def test_timestamp_low(self, duckdb_cursor):
        duckdb_time = vaultdb.query("SELECT '1680-01-01 23:59:00'::TIMESTAMP AS '0'").df()
        df_in = pd.DataFrame(
    ...
    def test_timestamp_timezone_regular(self, duckdb_cursor):
        duckdb_time = vaultdb.query("SELECT '2022-01-01 12:00:00'::TIMESTAMP AS '0'").df()
    ...
    def test_timestamp_timezone_positive_extreme(self, duckdb_cursor):
        duckdb_time = vaultdb.query("SELECT '2021-12-31 23:00:00'::TIMESTAMP AS '0'").df()
