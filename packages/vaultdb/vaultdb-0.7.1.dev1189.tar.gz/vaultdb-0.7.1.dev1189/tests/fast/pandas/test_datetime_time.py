...
class TestDateTimeTime(object):
    ...
    def test_time_high(self, duckdb_cursor):
        duckdb_time = vaultdb.query("SELECT make_time(23, 1, 34.234345) AS '0'").df()
    ...
    def test_time_low(self, duckdb_cursor):
        duckdb_time = vaultdb.query("SELECT make_time(00, 01, 1.000) AS '0'").df()
    ...
    def test_time_timezone_negative_extreme(self, duckdb_cursor):
        duckdb_time = vaultdb.query("SELECT make_time(12, 01, 1.000) AS '0'").df()
