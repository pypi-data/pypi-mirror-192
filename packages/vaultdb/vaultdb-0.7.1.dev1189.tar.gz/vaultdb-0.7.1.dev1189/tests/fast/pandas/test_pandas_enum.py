...
class TestPandasEnum(object):
    ...
    def test_3479(self, duckdb_cursor):
        ...
        with pytest.raises(vaultdb.ConversionException, match='Type UINT8 with value 0 can\'t be cast because the value is out of range for the destination type UINT8'):
