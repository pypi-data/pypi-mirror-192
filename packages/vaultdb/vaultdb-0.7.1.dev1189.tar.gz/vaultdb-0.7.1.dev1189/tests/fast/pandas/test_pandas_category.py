...
class TestCategory(object):
    ...
    def test_category_simple(self, duckdb_cursor):
        ...
        df_out = vaultdb.query_df(df_in, "data", "SELECT * FROM data").df()
        print (vaultdb.query_df(df_in, "data", "SELECT * FROM data").fetchall())
        print (df_out['int'])
    ...
    def test_categorical_fetchall(self, duckdb_cursor):
        ...
        assert vaultdb.query_df(df_in, "data", "SELECT * FROM data").fetchall() == [('foo',), ('bla',), (None,), ('zoo',), ('foo',), ('foo',), (None,), ('bla',)]
