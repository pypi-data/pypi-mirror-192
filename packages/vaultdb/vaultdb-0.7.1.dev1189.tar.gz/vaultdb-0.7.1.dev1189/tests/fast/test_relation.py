...
class TestRelation(object):
    def test_csv_auto(self, duckdb_cursor):
        ...
        csv_rel = vaultdb.from_csv_auto(temp_file_name)
    ...
    def test_fetchnumpy(self, duckdb_cursor):
        ...
        with pytest.raises(vaultdb.ConversionException, match="Conversion Error.*out of range.*"):
