...
#ifndef VAULTDB_PYTHON_LIB_NAME
#define VAULTDB_PYTHON_LIB_NAME vaultdb
#endif
...
PYBIND11_MODULE(VAULTDB_PYTHON_LIB_NAME, m) {
	VaultDBPyRelation::Initialize(m);
	VaultDBPyConnection::Initialize(m);
	...
	m.attr("__interactive__") = VaultDBPyConnection::DetectAndGetEnvironment();
	m.attr("__jupyter__") = VaultDBPyConnection::IsJupyter();
	m.attr("default_connection") = VaultDBPyConnection::DefaultConnection();
	m.attr("apilevel") = "1.0";
	...
	m.def("connect", &VaultDBPyConnection::Connect,
	      "Create a VaultDB database instance. Can take a database file name to read/write persistent data and a "
	      "read_only flag if no changes are desired",
	      py::arg("database") = ":memory:", py::arg("read_only") = false, py::arg("role") = "vaultdb", py::arg("config") = py::none());
	...
	m.def("values", &VaultDBPyRelation::Values, "Create a relation object from the passed values", py::arg("values"),
	      py::arg("connection") = py::none());
	m.def("from_query", &VaultDBPyRelation::FromQuery, "Create a relation object from the given SQL query",
	      py::arg("query"), py::arg("alias") = "query_relation", py::arg("connection") = py::none());
	m.def("query", &VaultDBPyRelation::RunQuery,
	      "Run a SQL query. If it is a SELECT statement, create a relation object from the given SQL query, otherwise "
	      "run the query as-is.",
	      py::arg("query"), py::arg("alias") = "query_relation", py::arg("connection") = py::none());
	m.def("from_substrait", &VaultDBPyRelation::FromSubstrait, "Creates a query object from the substrait plan",
	      py::arg("proto"), py::arg("connection") = py::none());
	m.def("get_substrait", &VaultDBPyRelation::GetSubstrait, "Serialize a query object to protobuf", py::arg("query"),
	      py::arg("connection") = py::none());
	m.def("get_substrait_json", &VaultDBPyRelation::GetSubstraitJSON, "Serialize a query object to protobuf",
	      py::arg("query"), py::arg("connection") = py::none());
	m.def("from_substrait_json", &VaultDBPyRelation::FromSubstraitJSON, "Serialize a query object to protobuf",
	      py::arg("json"), py::arg("connection") = py::none());
	m.def("from_parquet", &VaultDBPyRelation::FromParquet,
	      "Creates a relation object from the Parquet files in file_glob", py::arg("file_glob"),
	      py::arg("binary_as_string") = false, py::kw_only(), py::arg("file_row_number") = false,
	      py::arg("filename") = false, py::arg("hive_partitioning") = false, py::arg("union_by_name") = false,
	      py::arg("connection") = py::none());
	m.def("from_parquet", &VaultDBPyRelation::FromParquets,
	      "Creates a relation object from the Parquet files in file_globs", py::arg("file_globs"),
	      py::arg("binary_as_string") = false, py::kw_only(), py::arg("file_row_number") = false,
	      py::arg("filename") = false, py::arg("hive_partitioning") = false, py::arg("union_by_name") = false,
	      py::arg("connection") = py::none());
	m.def("df", &VaultDBPyRelation::FromDf, "Create a relation object from the DataFrame df", py::arg("df"),
	      py::arg("connection") = py::none());
	m.def("from_df", &VaultDBPyRelation::FromDf, "Create a relation object from the DataFrame df", py::arg("df"),
	      py::arg("connection") = py::none());
	m.def("from_arrow", &VaultDBPyRelation::FromArrow, "Create a relation object from an Arrow object",
	      py::arg("arrow_object"), py::arg("connection") = py::none());
	m.def("arrow", &VaultDBPyRelation::FromArrow, "Create a relation object from an Arrow object",
	      py::arg("arrow_object"), py::arg("connection") = py::none());
	m.def("filter", &VaultDBPyRelation::FilterDf, "Filter the DataFrame df by the filter in filter_expr", py::arg("df"),
	      py::arg("filter_expr"), py::arg("connection") = py::none());
	m.def("project", &VaultDBPyRelation::ProjectDf, "Project the DataFrame df by the projection in project_expr",
	      py::arg("df"), py::arg("project_expr"), py::arg("connection") = py::none());
	m.def("alias", &VaultDBPyRelation::AliasDF, "Create a relation from DataFrame df with the passed alias",
	      py::arg("df"), py::arg("alias"), py::arg("connection") = py::none());
	m.def("order", &VaultDBPyRelation::OrderDf, "Reorder the DataFrame df by order_expr", py::arg("df"),
	      py::arg("order_expr"), py::arg("connection") = py::none());
	m.def("aggregate", &VaultDBPyRelation::AggregateDF,
	...
	m.def("distinct", &VaultDBPyRelation::DistinctDF, "Compute the distinct rows from DataFrame df ", py::arg("df"),
	      py::arg("connection") = py::none());
	m.def("limit", &VaultDBPyRelation::LimitDF, "Retrieve the first n rows from the DataFrame df", py::arg("df"),
	      py::arg("n"), py::arg("connection") = py::none());

	m.def("query_df", &VaultDBPyRelation::QueryDF,
	...
	m.def("write_csv", &VaultDBPyRelation::WriteCsvDF, "Write the DataFrame df to a CSV file in file_name",
