# perllib module for pythonizer, generated by makelib.py on Wed Feb 15 23:44:09 2023
#
...
INPUT_LINE_NUMBER = 0
_PYTHONIZER_KEYWORDS = {'None','pass','any','sorted','await','chr','yield','dict','random','eval','find','atexit','ArrayHash','object','not','map','warnings','super','print','inspect','calendar','wantarray','finally','complex','from','async','glob','struct','fileinput','vars','is','staticmethod','round','stat','issubclass','tuple','signal','types','except','builtins','insert','sys','help','callable','while','aiter','import','if','tempfile','exec','traceback','ord','compile','sum','or','max','True','itertools','filter','in','values','pow','reversed','io','input','update','bytearray','False','classmethod','as','re','os','pop','set','nonlocal','property','math','return','list','upper','collections.abc','tm_py','type','assert','open','close','with','continue','Array','setattr','id','hasattr','casefold','iter','hash','getopt','dir','functools','ascii','repr','break','abs','locals','str','globals','get','memoryview','rfind','len','abc','next','lambda','subprocess','codecs','range','lower','anext','Hash','global','try','enumerate','format','int','delattr','and','perllib','rstrip','bin','getattr','fcntl','for','def','slice','breakpoint','float','frozenset','copy','min','else','bool','argparse','del','dataclasses','bytes','hex','keys','extend','pdb','zip','raise','divmod','class','isinstance','all','elif','oct'}
...
OUTPUT_AUTOFLUSH = 0
_TIE_MAP = {'UNTIE': '__untie__','DELETE': '__delitem__','SCALAR': '__len__','DESTROY': '__del__','PUSH': 'append','CLEAR': 'clear','EXISTS': '__contains__','STORE': '__setitem__','FETCH': '__getitem__','FETCHSIZE': '__len__'}
