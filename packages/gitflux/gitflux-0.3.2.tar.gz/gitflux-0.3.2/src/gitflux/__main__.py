...
from gitflux.commands import list_remote_command, create_remote_command, delete_remote_command, sync_repos_command
...
cli.add_command(list_remote_command)
cli.add_command(create_remote_command)
cli.add_command(delete_remote_command)
