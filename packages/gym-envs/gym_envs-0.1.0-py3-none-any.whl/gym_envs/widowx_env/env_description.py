...
class ActionShapes:
    ...
    def __init__(
        ...
        print(f'joint_positions={self.joint_positions} pybullet_action={self.pybullet_action},new_joint_positions={self.new_joint_positions}')
    ...
    def force_joint_positions(self, joint_positions):
        ...
        # In Pybullet, gripper halves are controlled separately
        p.resetJointState(self.arm, 10, joint_positions[6])
        p.resetJointState(self.arm, 11, joint_positions[7])
        # for i in range(6, 8):
        #     p.resetJointState(
        #         self.arm,
        #         i,
...
class RewardFunctions:
    ...
    def get_reward1(self):
        ...
        if self.dist > 0.03:
            ...
            rew = - self.dist ** 2 +  self.gap ** 2
        else:
            rew = 0.3 - self.dist ** 2 - 10* self.gap ** 2
