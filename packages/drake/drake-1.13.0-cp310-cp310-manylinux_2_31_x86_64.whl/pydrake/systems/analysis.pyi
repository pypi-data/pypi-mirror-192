...
class IntegratorBase:
    ...
    def StopDenseIntegration(self) -> pydrake.trajectories.PiecewisePolynomial_𝓣float𝓤: ...
    def get_actual_initial_step_size_taken(self) -> float: ...
    def get_context(self) -> pydrake.systems.framework.Context_𝓣float𝓤: ...
    def get_dense_output(self) -> pydrake.trajectories.PiecewisePolynomial_𝓣float𝓤: ...
    ...
    def reset_context(self, context: pydrake.systems.framework.Context_𝓣float𝓤) -> None: ...
...
class RungeKutta2Integrator(IntegratorBase_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣float𝓤, max_step_size: float, context: pydrake.systems.framework.Context_𝓣float𝓤 = ...) -> None: ...
...
class RungeKutta2Integrator_𝓣float𝓤(IntegratorBase_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣float𝓤, max_step_size: float, context: pydrake.systems.framework.Context_𝓣float𝓤 = ...) -> None: ...

class RungeKutta3Integrator(IntegratorBase_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣float𝓤, context: pydrake.systems.framework.Context_𝓣float𝓤 = ...) -> None: ...
...
class RungeKutta3Integrator_𝓣float𝓤(IntegratorBase_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣float𝓤, context: pydrake.systems.framework.Context_𝓣float𝓤 = ...) -> None: ...
...
class Simulator:
    ...
    def get_context(self) -> pydrake.systems.framework.Context_𝓣float𝓤: ...
    def get_integrator(self) -> IntegratorBase_𝓣float𝓤: ...
    def get_monitor(self) -> Callable[[pydrake.systems.framework.Context_𝓣float𝓤],pydrake.systems.framework.EventStatus]: ...
    def get_mutable_context(self) -> pydrake.systems.framework.Context_𝓣float𝓤: ...
    def get_mutable_integrator(self) -> IntegratorBase_𝓣float𝓤: ...
    def get_num_discrete_updates(self) -> int: ...
    def get_num_publishes(self) -> int: ...
    def get_num_steps_taken(self) -> int: ...
    def get_num_unrestricted_updates(self) -> int: ...
    def get_system(self) -> pydrake.systems.framework.System_𝓣float𝓤: ...
    def get_target_realtime_rate(self) -> float: ...
    def has_context(self) -> bool: ...
    def reset_context(self, context: pydrake.systems.framework.Context_𝓣float𝓤) -> None: ...
    def set_monitor(self, monitor: Callable[[pydrake.systems.framework.Context_𝓣float𝓤],Optional[pydrake.systems.framework.EventStatus]]) -> None: ...
...
class _TemporaryName_N5drake7systems21RungeKutta2IntegratorIdEE(IntegratorBase_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣float𝓤, max_step_size: float, context: pydrake.systems.framework.Context_𝓣float𝓤 = ...) -> None: ...
...
class _TemporaryName_N5drake7systems21RungeKutta3IntegratorIdEE(IntegratorBase_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, system: pydrake.systems.framework.System_𝓣float𝓤, context: pydrake.systems.framework.Context_𝓣float𝓤 = ...) -> None: ...
...
@overload
def ApplySimulatorConfig(config: SimulatorConfig, simulator: Simulator_𝓣float𝓤) -> None: ...
@overload
def ApplySimulatorConfig(config: SimulatorConfig, simulator: Simulator_𝓣AutoDiffXd𝓤) -> None: ...
@overload
def ExtractSimulatorConfig(simulator: Simulator_𝓣float𝓤) -> SimulatorConfig: ...
@overload
...
@overload
def PrintSimulatorStatistics(arg0: Simulator_𝓣float𝓤) -> None: ...
@overload
def PrintSimulatorStatistics(arg0: Simulator_𝓣AutoDiffXd𝓤) -> None: ...
def RandomSimulation(make_simulator: Callable[[pydrake.common._module_py.RandomGenerator],Simulator_𝓣float𝓤], output: Callable[[pydrake.systems.framework.System_𝓣float𝓤,pydrake.systems.framework.Context_𝓣float𝓤],float], final_time: float, generator: pydrake.common._module_py.RandomGenerator) -> float: ...
def RegionOfAttraction(system: pydrake.systems.framework.System_𝓣float𝓤, context: pydrake.systems.framework.Context_𝓣float𝓤, options: RegionOfAttractionOptions = ...) -> pydrake.symbolic.Expression: ...
@overload
def ResetIntegratorFromFlags(simulator: Simulator_𝓣float𝓤, scheme: str, max_step_size: float) -> IntegratorBase_𝓣float𝓤: ...
@overload
