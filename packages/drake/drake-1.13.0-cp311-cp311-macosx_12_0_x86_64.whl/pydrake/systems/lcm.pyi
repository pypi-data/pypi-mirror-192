...
class LcmInterfaceSystem(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    def __init__(self, lcm: pydrake.lcm.DrakeLcmInterface) -> None: ...

class LcmPublisherSystem(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    @overload
...
class LcmScopeSystem(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    def __init__(self, size: int) -> None: ...
    def AddToBuilder(self, *args, **kwargs) -> Any: ...

class LcmSubscriberSystem(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    @overload
...
class _Serializer_𝓣experimental_lcmt_deformable_tri𝓤(SerializerInterface):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self) -> None: ...
...
def ApplyLcmBusConfig(lcm_buses: Dict[str,pydrake.lcm.DrakeLcmParams], builder: pydrake.systems.framework.DiagramBuilder_𝓣float𝓤) -> LcmBuses: ...
