...
class ColorizeDepthImage(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
...
class ColorizeLabelImage(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    __init__: ClassVar[function] = ...
...
class ConcatenateImages(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    __init__: ClassVar[function] = ...
    _calc_output: ClassVar[function] = ...
...
class VideoWriter(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    __init__: ClassVar[function] = ...
...
def AddDefaultVisualization(builder: pydrake.systems.framework.DiagramBuilder_𝓣float𝓤) -> None: ...
def ApplyVisualizationConfig(config: VisualizationConfig, builder: pydrake.systems.framework.DiagramBuilder_𝓣float𝓤, lcm_buses: pydrake.systems.lcm.LcmBuses = ..., plant: pydrake.multibody.plant.MultibodyPlant_𝓣float𝓤 = ..., scene_graph: pydrake.geometry.SceneGraph_𝓣float𝓤 = ..., meshcat: pydrake.geometry.Meshcat = ..., lcm: pydrake.lcm.DrakeLcmInterface = ...) -> None: ...
