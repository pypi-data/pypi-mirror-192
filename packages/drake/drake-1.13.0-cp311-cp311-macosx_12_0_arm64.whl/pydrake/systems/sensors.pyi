...
class ImageToLcmImageArrayT(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    ...
    def DeclareImageInputPort𝓣PixelType𝓹kDepth16U𝓤(self, name: str) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...
    def DeclareImageInputPort𝓣PixelType𝓹kDepth32F𝓤(self, name: str) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...
    def DeclareImageInputPort𝓣PixelType𝓹kLabel16I𝓤(self, name: str) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...
    def DeclareImageInputPort𝓣PixelType𝓹kRgba8U𝓤(self, name: str) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...
    def color_image_input_port(self) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...
    def depth_image_input_port(self) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...
    def image_array_t_msg_output_port(self) -> pydrake.systems.framework.OutputPort_𝓣float𝓤: ...
    def label_image_input_port(self) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...
...
class LcmImageArrayToImages(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    def __init__(self) -> None: ...
    def color_image_output_port(self) -> pydrake.systems.framework.OutputPort_𝓣float𝓤: ...
    def depth_image_output_port(self) -> pydrake.systems.framework.OutputPort_𝓣float𝓤: ...
    def image_array_t_input_port(self) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...
...
class RgbdSensor(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    @overload
    def __init__(self, parent_id: pydrake.geometry.FrameId, X_PB: pydrake.math.RigidTransform_𝓣float𝓤, color_camera: pydrake.geometry.render.ColorRenderCamera, depth_camera: pydrake.geometry.render.DepthRenderCamera) -> None: ...
    @overload
    def __init__(self, parent_id: pydrake.geometry.FrameId, X_PB: pydrake.math.RigidTransform_𝓣float𝓤, depth_camera: pydrake.geometry.render.DepthRenderCamera, show_window: bool = ...) -> None: ...
    def X_BC(self) -> pydrake.math.RigidTransform_𝓣float𝓤: ...
    def X_BD(self) -> pydrake.math.RigidTransform_𝓣float𝓤: ...
    def body_pose_in_world_output_port(self) -> pydrake.systems.framework.OutputPort_𝓣float𝓤: ...
    def color_camera_info(self, *args, **kwargs) -> Any: ...
    def color_image_output_port(self) -> pydrake.systems.framework.OutputPort_𝓣float𝓤: ...
    def depth_camera_info(self, *args, **kwargs) -> Any: ...
    def depth_image_16U_output_port(self) -> pydrake.systems.framework.OutputPort_𝓣float𝓤: ...
    def depth_image_32F_output_port(self) -> pydrake.systems.framework.OutputPort_𝓣float𝓤: ...
    def label_image_output_port(self) -> pydrake.systems.framework.OutputPort_𝓣float𝓤: ...
    def parent_frame_id(self) -> pydrake.geometry.FrameId: ...
    def query_object_input_port(self) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...

class RgbdSensorDiscrete(pydrake.systems.framework.Diagram_𝓣float𝓤):
