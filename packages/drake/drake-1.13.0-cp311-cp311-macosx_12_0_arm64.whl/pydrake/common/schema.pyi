...
class Rotation:
    ...
    @overload
    def __init__(self, arg0: pydrake.math.RollPitchYaw_𝓣float𝓤) -> None: ...
    @overload
    def __init__(self, **kwargs) -> None: ...
    def GetDeterministicValue(self) -> pydrake.math.RotationMatrix_𝓣float𝓤: ...
...
class Transform:
    ...
    @overload
    def __init__(self, **kwargs) -> None: ...
    def GetDeterministicValue(self) -> pydrake.math.RigidTransform_𝓣float𝓤: ...
    def IsDeterministic(self) -> bool: ...
    def Mean(self) -> pydrake.math.RigidTransform_𝓣float𝓤: ...
    def Sample(self, generator: pydrake.common._module_py.RandomGenerator) -> pydrake.math.RigidTransform_𝓣float𝓤: ...
