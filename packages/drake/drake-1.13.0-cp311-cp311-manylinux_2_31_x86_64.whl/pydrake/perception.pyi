...
class DepthImageToPointCloud(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
    ...
    def camera_pose_input_port(self) -> pydrake.systems.framework.InputPort_𝓣float𝓤: ...
    ...
    def point_cloud_output_port(self) -> pydrake.systems.framework.OutputPort_𝓣float𝓤: ...
...
class PointCloudToLcm(pydrake.systems.framework.LeafSystem_𝓣float𝓤):
