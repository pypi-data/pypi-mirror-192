...
class BsplineTrajectory(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, basis: pydrake.math.BsplineBasis_𝓣float𝓤, control_points: List[List[float]]) -> None: ...
    @overload
    def __init__(self, basis: pydrake.math.BsplineBasis_𝓣float𝓤, control_points: List[numpy.ndarray[numpy.float64[m,n]]]) -> None: ...
    def Clone(self) -> Trajectory_𝓣float𝓤: ...
    def CopyBlock(self, start_row: int, start_col: int, block_rows: int, block_cols: int) -> BsplineTrajectory_𝓣float𝓤: ...
    def CopyHead(self, n: int) -> BsplineTrajectory_𝓣float𝓤: ...
    ...
    def basis(self) -> pydrake.math.BsplineBasis_𝓣float𝓤: ...
    def control_points(self) -> List[numpy.ndarray[numpy.float64[m,n]]]: ...
    def num_control_points(self) -> int: ...
    def __copy__(self) -> BsplineTrajectory_𝓣float𝓤: ...
    def __deepcopy__(self, arg0: dict) -> BsplineTrajectory_𝓣float𝓤: ...
    def __getstate__(self) -> Tuple[pydrake.math.BsplineBasis_𝓣float𝓤,List[numpy.ndarray[numpy.float64[m,n]]]]: ...
    def __setstate__(self, arg0: Tuple[pydrake.math.BsplineBasis_𝓣float𝓤,List[numpy.ndarray[numpy.float64[m,n]]]]) -> None: ...
...
class BsplineTrajectory_𝓣float𝓤(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
...
class PathParameterizedTrajectory(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, path: Trajectory_𝓣float𝓤, time_scaling: Trajectory_𝓣float𝓤) -> None: ...
    def Clone(self) -> Trajectory_𝓣float𝓤: ...
    def path(self) -> Trajectory_𝓣float𝓤: ...
    def time_scaling(self) -> Trajectory_𝓣float𝓤: ...
    def __copy__(self) -> PathParameterizedTrajectory_𝓣float𝓤: ...
    def __deepcopy__(self, arg0: dict) -> PathParameterizedTrajectory_𝓣float𝓤: ...
...
class PathParameterizedTrajectory_𝓣float𝓤(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, path: Trajectory_𝓣float𝓤, time_scaling: Trajectory_𝓣float𝓤) -> None: ...
    def Clone(self) -> Trajectory_𝓣float𝓤: ...
...
class PiecewisePolynomial(PiecewiseTrajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
    ...
    @overload
    def __init__(self, arg0: List[pydrake.polynomial.Polynomial_𝓣float𝓤], arg1: List[float]) -> None: ...
    ...
    def Block(self, start_row: int, start_col: int, block_rows: int, block_cols: int) -> PiecewisePolynomial_𝓣float𝓤: ...
    def Clone(self) -> Trajectory_𝓣float𝓤: ...
    def ConcatenateInTime(self, other: PiecewisePolynomial_𝓣float𝓤) -> None: ...
    ...
    def Transpose(self) -> PiecewisePolynomial_𝓣float𝓤: ...
    def ZeroOrderHold(self, *args, **kwargs) -> Any: ...
    @overload
    def derivative(self, derivative_order: int = ...) -> PiecewisePolynomial_𝓣float𝓤: ...
    @overload
    def derivative(self) -> Any: ...
    def getPolynomial(self, segment_index: int, row: int = ..., col: int = ...) -> pydrake.polynomial.Polynomial_𝓣float𝓤: ...
    ...
    def isApprox(self, other: PiecewisePolynomial_𝓣float𝓤, tol: float, tol_type: pydrake.common._module_py.ToleranceType = ...) -> bool: ...
    ...
    def slice(self, start_segment_index: int, num_segments: int) -> PiecewisePolynomial_𝓣float𝓤: ...
    def __add__(self, arg0: PiecewisePolynomial_𝓣float𝓤) -> PiecewisePolynomial_𝓣float𝓤: ...
    def __copy__(self) -> PiecewisePolynomial_𝓣float𝓤: ...
    def __deepcopy__(self, arg0: dict) -> PiecewisePolynomial_𝓣float𝓤: ...
...
class PiecewisePolynomial_𝓣float𝓤(PiecewiseTrajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
...
class PiecewisePose(PiecewiseTrajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, position_trajectory: PiecewisePolynomial_𝓣float𝓤, orientation_trajectory: PiecewiseQuaternionSlerp_𝓣float𝓤) -> None: ...
    def GetAcceleration(self, time: float) -> numpy.ndarray[numpy.float64[6,1]]: ...
    def GetPose(self, time: float) -> pydrake.math.RigidTransform_𝓣float𝓤: ...
    def GetVelocity(self, time: float) -> numpy.ndarray[numpy.float64[6,1]]: ...
    def IsApprox(self, other: PiecewisePose_𝓣float𝓤, tol: float) -> bool: ...
    def MakeCubicLinearWithEndLinearVelocity(self, *args, **kwargs) -> Any: ...
    def MakeLinear(self, *args, **kwargs) -> Any: ...
    def get_orientation_trajectory(self) -> PiecewiseQuaternionSlerp_𝓣float𝓤: ...
    def get_position_trajectory(self) -> PiecewisePolynomial_𝓣float𝓤: ...
    def __copy__(self) -> PiecewisePose_𝓣float𝓤: ...
    def __deepcopy__(self, arg0: dict) -> PiecewisePose_𝓣float𝓤: ...
...
class PiecewisePose_𝓣float𝓤(PiecewiseTrajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
...
class PiecewiseQuaternionSlerp(PiecewiseTrajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, breaks: List[float], quaternions: List[pydrake.common.eigen_geometry.Quaternion_𝓣float𝓤]) -> None: ...
    @overload
    def __init__(self, breaks: List[float], rotation_matrices: List[numpy.ndarray[numpy.float64[3,3]]]) -> None: ...
    @overload
    def __init__(self, breaks: List[float], rotation_matrices: List[pydrake.math.RotationMatrix_𝓣float𝓤]) -> None: ...
    @overload
    def __init__(self, breaks: List[float], angle_axes: List[pydrake.common.eigen_geometry.AngleAxis_𝓣float𝓤]) -> None: ...
    @overload
    def Append(self, time: float, quaternion: pydrake.common.eigen_geometry.Quaternion_𝓣float𝓤) -> None: ...
    @overload
    def Append(self, time: float, rotation_matrix: pydrake.math.RotationMatrix_𝓣float𝓤) -> None: ...
    @overload
    def Append(self, time: float, angle_axis: pydrake.common.eigen_geometry.AngleAxis_𝓣float𝓤) -> None: ...
    ...
    def orientation(self, time: float) -> pydrake.common.eigen_geometry.Quaternion_𝓣float𝓤: ...
    def __copy__(self) -> PiecewiseQuaternionSlerp_𝓣float𝓤: ...
    def __deepcopy__(self, arg0: dict) -> PiecewiseQuaternionSlerp_𝓣float𝓤: ...
...
class PiecewiseQuaternionSlerp_𝓣float𝓤(PiecewiseTrajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
...
class PiecewiseTrajectory(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
...
class PiecewiseTrajectory_𝓣float𝓤(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def duration(self, segment_index: int) -> float: ...
...
class StackedTrajectory(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, rowwise: bool = ...) -> None: ...
    def Append(self, arg0: Trajectory_𝓣float𝓤) -> None: ...
    def Clone(self) -> Trajectory_𝓣float𝓤: ...
    def __copy__(self) -> StackedTrajectory_𝓣float𝓤: ...
    def __deepcopy__(self, arg0: dict) -> StackedTrajectory_𝓣float𝓤: ...
...
class StackedTrajectory_𝓣float𝓤(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, rowwise: bool = ...) -> None: ...
    def Append(self, arg0: Trajectory_𝓣float𝓤) -> None: ...
...
class Trajectory:
    ...
    def MakeDerivative(self, derivative_order: int = ...) -> Trajectory_𝓣float𝓤: ...
    def cols(self) -> int: ...
    def end_time(self) -> float: ...
...
class _TemporaryName_N5drake12trajectories13PiecewisePoseIdEE(PiecewiseTrajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
...
class _TemporaryName_N5drake12trajectories17BsplineTrajectoryIdEE(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
...
class _TemporaryName_N5drake12trajectories17StackedTrajectoryIdEE(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, rowwise: bool = ...) -> None: ...
    def Append(self, arg0: Trajectory_𝓣float𝓤) -> None: ...
...
class _TemporaryName_N5drake12trajectories19PiecewisePolynomialIdEE(PiecewiseTrajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
...
class _TemporaryName_N5drake12trajectories19PiecewiseTrajectoryIdEE(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def duration(self, segment_index: int) -> float: ...
...
class _TemporaryName_N5drake12trajectories24PiecewiseQuaternionSlerpIdEE(PiecewiseTrajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self) -> None: ...
...
class _TemporaryName_N5drake12trajectories27PathParameterizedTrajectoryIdEE(Trajectory_𝓣float𝓤):
    _original_name: ClassVar[str] = ...
    _original_qualname: ClassVar[str] = ...
    def __init__(self, path: Trajectory_𝓣float𝓤, time_scaling: Trajectory_𝓣float𝓤) -> None: ...
    def Clone(self) -> Trajectory_𝓣float𝓤: ...
