...
class ContactWrench:
    ...
    @property
    def F_Cb_W(self) -> pydrake.multibody.math.SpatialForce_𝓣float𝓤: ...
    @property
...
class Toppra:
    def __init__(self, path: pydrake.trajectories.Trajectory_𝓣float𝓤, plant: pydrake.multibody.plant.MultibodyPlant_𝓣float𝓤, gridpoints: numpy.ndarray[numpy.float64[m,1]]) -> None: ...
    @overload
    def AddFrameAccelerationLimit(self, constraint_frame: pydrake.multibody.tree.Frame_𝓣float𝓤, lower_limit: numpy.ndarray[numpy.float64[6,1]], upper_limit: numpy.ndarray[numpy.float64[6,1]], discretization: ToppraDiscretization = ...) -> Tuple[pydrake.solvers.Binding𝓣LinearConstraint𝓤,pydrake.solvers.Binding𝓣LinearConstraint𝓤]: ...
    @overload
    def AddFrameAccelerationLimit(self, constraint_frame: pydrake.multibody.tree.Frame_𝓣float𝓤, lower_limit: pydrake.trajectories.Trajectory_𝓣float𝓤, upper_limit: pydrake.trajectories.Trajectory_𝓣float𝓤, discretization: ToppraDiscretization = ...) -> Tuple[pydrake.solvers.Binding𝓣LinearConstraint𝓤,pydrake.solvers.Binding𝓣LinearConstraint𝓤]: ...
    @overload
    def AddFrameTranslationalSpeedLimit(self, constraint_frame: pydrake.multibody.tree.Frame_𝓣float𝓤, upper_limit: float) -> pydrake.solvers.Binding𝓣BoundingBoxConstraint𝓤: ...
    @overload
    def AddFrameTranslationalSpeedLimit(self, constraint_frame: pydrake.multibody.tree.Frame_𝓣float𝓤, upper_limit: pydrake.trajectories.Trajectory_𝓣float𝓤) -> pydrake.solvers.Binding𝓣BoundingBoxConstraint𝓤: ...
    def AddFrameVelocityLimit(self, constraint_frame: pydrake.multibody.tree.Frame_𝓣float𝓤, lower_limit: numpy.ndarray[numpy.float64[6,1]], upper_limit: numpy.ndarray[numpy.float64[6,1]]) -> pydrake.solvers.Binding𝓣BoundingBoxConstraint𝓤: ...
    ...
    def SolvePathParameterization(self) -> Optional[pydrake.trajectories.PiecewisePolynomial_𝓣float𝓤]: ...
