...
class AngleAxis:
    ...
    @overload
    def __init__(self, quaternion: Quaternion_𝓣float𝓤) -> None: ...
    @overload
    def __init__(self, rotation: numpy.ndarray[numpy.float64[3,3]]) -> None: ...
    @overload
    def __init__(self, other: AngleAxis_𝓣float𝓤) -> None: ...
    ...
    def cast𝓣float𝓤(self) -> AngleAxis_𝓣float𝓤: ...
    def inverse(self) -> AngleAxis_𝓣float𝓤: ...
    def multiply(self, other: AngleAxis_𝓣float𝓤) -> Quaternion_𝓣float𝓤: ...
    def quaternion(self) -> Quaternion_𝓣float𝓤: ...
    def rotation(self) -> numpy.ndarray[numpy.float64[3,3]]: ...
    def set_angle(self, angle: float) -> None: ...
    def set_axis(self, axis: numpy.ndarray[numpy.float64[3,1]]) -> None: ...
    def set_quaternion(self, q: Quaternion_𝓣float𝓤) -> None: ...
    def set_rotation(self, rotation: numpy.ndarray[numpy.float64[3,3]]) -> None: ...
    def __copy__(self) -> AngleAxis_𝓣float𝓤: ...
    def __deepcopy__(self, arg0: dict) -> AngleAxis_𝓣float𝓤: ...
...
class Isometry3:
    ...
    @overload
    def __init__(self, other: Isometry3_𝓣float𝓤) -> None: ...
    def Identity(self, *args, **kwargs) -> Any: ...
    def cast𝓣AutoDiffXd𝓤(self, *args, **kwargs) -> Any: ...
    def cast𝓣Expression𝓤(self, *args, **kwargs) -> Any: ...
    def cast𝓣float𝓤(self) -> Isometry3_𝓣float𝓤: ...
    def inverse(self) -> Isometry3_𝓣float𝓤: ...
    ...
    def __copy__(self) -> Isometry3_𝓣float𝓤: ...
    def __deepcopy__(self, arg0: dict) -> Isometry3_𝓣float𝓤: ...
...
class Quaternion:
    ...
    def __init__(self, rotation: numpy.ndarray[numpy.float64[3,3]]) -> None: ...
    @overload
    def __init__(self, other: Quaternion_𝓣float𝓤) -> None: ...
    def Identity(self, *args, **kwargs) -> Any: ...
    def cast𝓣AutoDiffXd𝓤(self, *args, **kwargs) -> Any: ...
    def cast𝓣Expression𝓤(self, *args, **kwargs) -> Any: ...
    def cast𝓣float𝓤(self) -> Quaternion_𝓣float𝓤: ...
    def conjugate(self) -> Quaternion_𝓣float𝓤: ...
    def inverse(self) -> Quaternion_𝓣float𝓤: ...
    def rotation(self) -> numpy.ndarray[numpy.float64[3,3]]: ...
    def set_rotation(self, arg0: numpy.ndarray[numpy.float64[3,3]]) -> None: ...
    @overload
    ...
    def slerp(self, t: float, other: Quaternion_𝓣float𝓤) -> Quaternion_𝓣float𝓤: ...
    def w(self) -> float: ...
    ...
    def y(self) -> float: ...
    def z(self) -> float: ...
    def __copy__(self) -> Quaternion_𝓣float𝓤: ...
    def __deepcopy__(self, arg0: dict) -> Quaternion_𝓣float𝓤: ...
...
class _TemporaryName_N5drake5ValueIN5Eigen9TransformIdLi3ELi1ELi0EEEEE(pydrake.common.value.AbstractValue):
    ...
    _original_qualname: ClassVar[str] = ...
    @overload
    def __init__(self, arg0: Isometry3_𝓣float𝓤) -> None: ...
    @overload
    def __init__(self, *args, **kwargs) -> Any: ...
    def get_mutable_value(self) -> Isometry3_𝓣float𝓤: ...
    def get_value(self) -> Isometry3_𝓣float𝓤: ...
    def set_value(self, arg0: Isometry3_𝓣float𝓤) -> None: ...
