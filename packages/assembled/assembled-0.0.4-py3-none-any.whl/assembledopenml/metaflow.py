...
class MetaFlow:
    def __init__(self, flow_id: int, description: Union[str, None], run_performance: Union[float, None],
                 run_id: int, conf_tol: float = 0.01):
        """Internal Object of a Flow filled with (for us relevant) metadata about the flow and the run.
        ...
        run_performance: Union[float, None]
            The performance of the run for the flow.
        run_id: int
            The id of run of the flow.
        conf_tol: float
    ...
    def get_predictions_data(self, class_labels: List[str]):
        ...
        self.predictions_url = openml_get_run(self.run_id).predictions_url
