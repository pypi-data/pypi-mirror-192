...
class process_lambda_host:
    ...
    def __init__(self, framework = None):  
        ...
        self.crs = self.vf_api.get_project_crs(self.project)
        self.lambda_framework.log(f'crs: {self.crs}')
    ...
    def create_entity_raw(self, type, name, fields):
        return self.vf_api.create_entity_raw(self.project, type, name, fields, self.crs)