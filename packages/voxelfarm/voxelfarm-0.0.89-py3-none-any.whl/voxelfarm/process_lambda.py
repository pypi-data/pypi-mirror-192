...
class process_lambda_host:
    ...
    def process_entity(self, project, folder, type, name, crs, fields = None, update_type = None):
    ...
    def process_lambda_entity(self, project, folder, name, inputs, code, files, fields = None, update_type = None):
        verified_files = []
        if files:
            for file in files:
