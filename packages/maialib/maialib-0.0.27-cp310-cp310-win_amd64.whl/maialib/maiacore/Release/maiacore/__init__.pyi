...
class TuningSystem():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    EQUAL_TEMPERAMENT: maialib.maiacore.Release.maiacore.TuningSystem # value = <TuningSystem.EQUAL_TEMPERAMENT: 0>
    JUST_INTONATION: maialib.maiacore.Release.maiacore.TuningSystem # value = <TuningSystem.JUST_INTONATION: 1>
    MEANTONE_TEMPERAMENT: maialib.maiacore.Release.maiacore.TuningSystem # value = <TuningSystem.MEANTONE_TEMPERAMENT: 3>
    PYTHAGOREAN_TUNING: maialib.maiacore.Release.maiacore.TuningSystem # value = <TuningSystem.PYTHAGOREAN_TUNING: 2>
    WELL_TEMPERAMENT: maialib.maiacore.Release.maiacore.TuningSystem # value = <TuningSystem.WELL_TEMPERAMENT: 4>
    __members__: dict # value = {'EQUAL_TEMPERAMENT': <TuningSystem.EQUAL_TEMPERAMENT: 0>, 'JUST_INTONATION': <TuningSystem.JUST_INTONATION: 1>, 'PYTHAGOREAN_TUNING': <TuningSystem.PYTHAGOREAN_TUNING: 2>, 'MEANTONE_TEMPERAMENT': <TuningSystem.MEANTONE_TEMPERAMENT: 3>, 'WELL_TEMPERAMENT': <TuningSystem.WELL_TEMPERAMENT: 4>}
    pass
def getTuningSystem() -> TuningSystem:
    pass
def setTuningSystem(tuningSystem: TuningSystem) -> None:
    pass
__version__ = '0.0.27'
