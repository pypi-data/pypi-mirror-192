...
class TuningSystem():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    EQUAL_TEMPERAMENT: maialib.maiacore.maiacore.TuningSystem # value = <TuningSystem.EQUAL_TEMPERAMENT: 0>
    JUST_INTONATION: maialib.maiacore.maiacore.TuningSystem # value = <TuningSystem.JUST_INTONATION: 1>
    MEANTONE_TEMPERAMENT: maialib.maiacore.maiacore.TuningSystem # value = <TuningSystem.MEANTONE_TEMPERAMENT: 3>
    PYTHAGOREAN_TUNING: maialib.maiacore.maiacore.TuningSystem # value = <TuningSystem.PYTHAGOREAN_TUNING: 2>
    WELL_TEMPERAMENT: maialib.maiacore.maiacore.TuningSystem # value = <TuningSystem.WELL_TEMPERAMENT: 4>
