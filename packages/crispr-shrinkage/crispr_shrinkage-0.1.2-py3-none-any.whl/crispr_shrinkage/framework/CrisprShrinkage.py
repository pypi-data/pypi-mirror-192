...
class StatisticalHelperMethods:
    ...
    @staticmethod
    def calculate_credible_interval(posterior_monte_carl_samples: List[float], percentiles: Tuple[float, float] = (0.05, 0.95)) -> Tuple[float,float]:
        ...
        posterior_monte_carl_samples = np.sort(posterior_monte_carl_samples)
        lower_percentile = percentileofscore(posterior_monte_carl_samples, percentiles[0])
        upper_percentile = percentileofscore(posterior_monte_carl_samples, percentiles[1])

        credible_interval = (np.percentile(posterior_monte_carl_samples, lower_percentile), np.percentile(posterior_monte_carl_samples, upper_percentile))
...
def perform_adjustment(
    ...
    print("Last updated: 2/19/2023 - 4:00pm")
