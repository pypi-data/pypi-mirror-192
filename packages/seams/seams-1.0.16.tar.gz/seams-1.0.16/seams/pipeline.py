...
class Pipeline(ABC):
    ...
    def __build_log_upload_files(self) -> tuple[str, str]:
        ...
        log_file_upload = self.seams.upload_file("logs for {}".format(self.vertex_id), log_temp_file_full_path, file_type="File")
        ...
        user_log_file_upload = self.seams.upload_file("user logs for {}".format(self.vertex_id), user_log_temp_file_full_path, file_type="File")
