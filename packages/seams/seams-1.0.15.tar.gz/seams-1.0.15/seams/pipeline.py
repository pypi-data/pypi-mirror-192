...
class Pipeline(ABC):
    ...
    def update_pipeline_status_done(self) -> str:
        ...
        for item in self.result_files:
            self.seams.attach_edges(self.vertex_id, [item["id"]])
    ...
    def download_input_files(self) -> list:
        ...
        for item in curr_input_files:
            download = self.seams.download_files( [ item["id"] ])
    ...
    def __build_log_upload_files(self) -> tuple[str, str]:
        ...
        log_file_upload = self.seams.upload_file("logs for {}".format(self.vertex_id), log_temp_file_full_path, file_type="PipelineInputFile")
        ...
        user_log_file_upload = self.seams.upload_file("user logs for {}".format(self.vertex_id), user_log_temp_file_full_path, file_type="PipelineInputFile")
    ...
    def __get_parameters(self) -> dict:
        ...
        self.seams.set_current_schema_by_id(args.tenant_id)
