...
#if QT_CONFIG(tooltip)
        self.ryujinx_legacy_radio.setToolTip(QCoreApplication.translate("DreadGameExportDialog", u"<html><head/><body><p>Same as Ryujinx, but does not use exlaunch. Use in case the normal option does not work.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
