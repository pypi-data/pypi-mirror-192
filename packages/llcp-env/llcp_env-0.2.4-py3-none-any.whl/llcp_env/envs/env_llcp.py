...
class CPEnv(Env):
    ...
    dic_clfs1 = np.load('/content/drive/MyDrive/Colab Notebooks/dic_clfs1.npy', allow_pickle=True).item()
    ...
    def step(self, action):
        ...
        # print("余数：", self.jishu % self.every_zu_nums)

        if self.jishu % self.every_zu_nums == 0:
            self.done = True
