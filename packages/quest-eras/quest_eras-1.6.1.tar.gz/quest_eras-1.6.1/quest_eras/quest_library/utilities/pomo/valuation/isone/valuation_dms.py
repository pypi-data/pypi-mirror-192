...
from utilities.pomo.dms import DataManagementSystem
import utilities.pomo.valuation.isone.data_processing_tools as dpt


class ValuationDMSISONE(DataManagementSystem):
    """
    ...
    def get_isone_data(self, year, month, nodeid):
        ...
        try:
            ...
            lmp_da, rccp, rpcp, mi_mult = dpt.read_isone_data(path, year, month, nodeid)
