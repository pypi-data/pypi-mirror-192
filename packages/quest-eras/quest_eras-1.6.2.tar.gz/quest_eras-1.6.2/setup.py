...
setup(
    ...
    package_data={"quest_eras": ["quest_eras/quest_library/apps/valuation/data/CAISO/ASP/2018/*.csv","quest_eras/quest_library/apps/valuation/data/ERCOT/SPP/2018/*.xlsx"] },
