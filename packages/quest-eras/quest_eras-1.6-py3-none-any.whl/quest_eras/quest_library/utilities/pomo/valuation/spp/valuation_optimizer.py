...
from utilities.pomo.valuation.spp.constraints import ExpressionsBlock
import logging
...
class ValuationOptimizerSPP(optimizer.Optimizer):
    """A framework wrapper class for creating Pyomo ConcreteModels for valuating energy storage in SPP electricity market."""
