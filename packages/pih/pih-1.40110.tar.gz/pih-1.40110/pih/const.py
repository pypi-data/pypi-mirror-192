...
from pih.collection import FieldItem, FieldItemList, LogCommandDescription, ParamItem, PasswordSettings, ServiceRoleDescription, SettingsValue
...
class CONST:
    ...
    class AD:
        ...
        class JobPisitions(Enum):
            HR: str = auto()
            IT: str = auto()
            CALL_CENTRE: str = auto()
            REGISTRATOR: str = auto()
    ...
    class POLIBASE:
        ...
        APPOINTMENT_SERVICE_GROUP_NAME: dict = {
            APPOINTMENT_SERVICE_GROUP_ID.ULTRASOUND: "УльтраЗвуковое Исслдеование",
            APPOINTMENT_SERVICE_GROUP_ID.ENDOSCOPY: "эндоспопичекое", 
            APPOINTMENT_SERVICE_GROUP_ID.MRI: "МРТ исследование", 
            APPOINTMENT_SERVICE_GROUP_ID.CT: "КТ исследование"
        }
        ...
        YES_ANSWER: List[str] = ["да", "согласен", "согласна", "ok", "ок", "yes"]

        NO_ANSWER: List[str] = ["нет", "не согласен", "не согласна", "no"]
...
class ServiceCommands(Enum):
    ...
    get_polibase_person_notification_confirmation: int = auto()
    complete_polibase_person_notification_confirmation: int = auto()
    #
...
class ServiceRoles(Enum):
    ...
    DATA_STORAGE: ServiceRoleDescription = ServiceRoleDescription(
                                            ...
                                            commands=[
                                                        ...
                                                        #
                                                        ServiceCommands.get_polibase_person_notification_confirmation,
                                                        ServiceCommands.complete_polibase_person_notification_confirmation,
                                                        #
...
class Settings(Enum):
    ...
    POLIBASE_PERSON_REVIEW_NOTIFICATION_START_TIME: SettingsValue = SettingsValue(None, "13:23")
    #
    ...
    POLIBASE_PERSON_VISIT_GREETING_NOTIFICATION_TEXT: SettingsValue = SettingsValue(
        None,  CONST.POLIBASE.PERSON_VISIT_GREETING_NOTIFICATION_TEXT_BASE + "\n" + CONST.POLIBASE.PERSON_VISIT_NOTIFICATION_WITH_TIME_TEXT + CONST.POLIBASE.ASK_TO_SEND_TELEGRAM_BOT_URL_TEXT)

    POLIBASE_PERSON_VISIT_NOTIFICATION_TEXT: SettingsValue = SettingsValue(
        None, CONST.POLIBASE.PERSON_VISIT_NOTIFICATION_HEADER + CONST.POLIBASE.PERSON_VISIT_NOTIFICATION_APPOINTMENT_INFORMATION +  CONST.POLIBASE.PERSON_VISIT_NOTIFICATION_TEXT_CANCEL_OR_REPLACE_RECEPTION + CONST.POLIBASE.PERSON_VISIT_NOTIFICATION_WITH_TIME_TEXT)

    POLIBASE_PERSON_VISIT_REMINDER_TEXT: SettingsValue = SettingsValue(
        None, CONST.POLIBASE.PERSON_VISIT_NOTIFICATION_HEADER + "\n\n*{name}*, напоминаем Вам о записи сегодня {visit_time}. Вы записаны{appointment_information}" + CONST.POLIBASE.PERSON_VISIT_NOTIFICATION_TEXT_CANCEL_OR_REPLACE_RECEPTION)

    POLIBASE_PERSON_TAKE_TELEGRAM_BOT_URL_TEXT: SettingsValue = SettingsValue(
        None, CONST.POLIBASE.TAKE_TELEGRAM_BOT_URL_TEXT)
    
    POLIBASE_PERSON_PERSONLESS_TAKE_TELEGRAM_BOT_URL_TEXT: SettingsValue = SettingsValue(
        None, CONST.POLIBASE.PERSONLESS_TAKE_TELEGRAM_BOT_URL_TEXT)
    ...
    POLIBASE_PERSON_NO_ANSWER_ON_CONFIRMED_NOTIFICATION_TEXT: SettingsValue = SettingsValue(
        None, "Хорошего дня")
...
class LogCommands(Enum):
    ...
    WATCHABLE_WORKSTATION_IS_NOT_ACCESSABLE: LogCommandDescription = LogCommandDescription(
        "Компьютер {workstation_name} вне сети", LogChannels.IT, LogLevels.ERROR.value, [ParamItem("workstation_name", "")])
