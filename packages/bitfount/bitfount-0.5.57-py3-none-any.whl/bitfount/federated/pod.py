...
class Pod:
    ...
    async def _create_and_run_worker(self, message: _BitfountMessage) -> None:
        ...
        worker_datasource = self._get_target_datasource(task_request_message)
    ...
    def _get_target_datasource(
        self, task_request_message: _TaskRequestMessage
    ) -> BaseSource:
        """Extract the view config associated with view requested."""
        # TODO: [BIT-2704] Merge extraction to work for both subsidiary and
        #                  "main" datasource(s).
        target_datasource = self._extract_requested_datasource(task_request_message)
    ...
    def _extract_requested_datasource(
        self, task_request_message: _TaskRequestMessage
    ) -> str:
        """Extract the requested datasource from task request message."""
        # TODO: [BIT-2703] Extract requested datasource from message context
        return ""
