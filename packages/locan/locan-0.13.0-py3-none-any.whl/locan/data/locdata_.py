...
class LocData:
    ...
    def from_selection(cls, locdata, indices=slice(0, None), meta=None):
        ...
        meta_.history.add(name="LocDataSelection.from_selection")
    ...
    def from_chunks(
        ...
        references = [
            LocDataSelection.from_locdata(locdata=locdata, indices=index_list)
    ...
    def print_summary(self):
        ...
        meta_.creation_time = self.meta.creation_time
        meta_.modification_time = self.meta.modification_time
