...
def run_tests(
    ...
    # TODO: use colored print to be able to get a better understanding of the logs
    logger.info(f"Blazetest version: {__version__}")

    # TODO: it is a better way to print only the package version
    if info:
        return
    ...
    if test_session_result is not None:
        test_session_result.log_results(failed_test_retry_enabled=flaky_test_retry_enabled)
