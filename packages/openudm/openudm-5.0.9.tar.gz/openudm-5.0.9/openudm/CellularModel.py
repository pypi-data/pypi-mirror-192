...
class CellularModel(_object):
    ...
    def OutputDevelopmentDensity(self, popDensityRaster, dwellingDensityRaster, people_per_dwelling):
        return _CellularModel.CellularModel_OutputDevelopmentDensity(self, popDensityRaster, dwellingDensityRaster, people_per_dwelling)
