...
class api:
    ...
    def ModifyOrder(self,broker: str,exchange: str,symbol: str,order_id: str,action: str,product: str,pricetype: str ,quantity: int,price: float=0,disclosed_quantity: int=0,trigger_price: float=0,api_key: str="default", api_secret: str="default"):
    ...
    def CancelOrder(self, broker: str,order_id: str, api_key: str="default", api_secret: str="default"):
    ...
    def CancelAllOrder(self, broker: str,api_key: str="default", api_secret: str="default"):
    ...
    def SquareOffPosition(self,broker: str,exchange: str,product: str,symbol: str,api_key: str="default", api_secret: str="default"):
    ...
    def SquareOffAllPosition(self,broker: str,api_key: str="default", api_secret: str="default"):
    ...
    def ExitBOOrder(self, broker: str,order_id: str, api_key: str="default", api_secret: str="default"):
    ...
    def ExitCOOrder(self, broker: str,order_id: str, api_key: str="default", api_secret: str="default"):
