...
PACKAGE_NAME = 'Leer_PDF_GP' #Debe coincidir con el nombre de la carpeta 
AUTHOR = 'Ander Valencia' #Modificar con vuestros datos
AUTHOR_EMAIL = 'a@gmail.com' #Modificar con vuestros datos
