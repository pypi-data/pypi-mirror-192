...
class UGKYCApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_voter_endpoint = _Endpoint(
            settings={
                'response_type': (GetVoterResponse,),
                'auth': [
                    'apikeyAuth',
                    'appIdAuth'
                ],
                'endpoint_path': '/api/v1/ug/kyc/voter',
                'operation_id': 'get_voter',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_voter(
        ...
        **kwargs
        ...
        >>> thread = api.get_voter(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_voter_endpoint.call_with_http_info(**kwargs)
