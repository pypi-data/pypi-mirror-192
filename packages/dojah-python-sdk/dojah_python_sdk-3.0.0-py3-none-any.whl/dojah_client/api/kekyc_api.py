...
class KEKYCApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_national_id_endpoint = _Endpoint(
            settings={
                'response_type': (GetNationalIdResponse,),
                'auth': [
                    'apikeyAuth',
                    'appIdAuth'
                ],
                'endpoint_path': '/api/v1/ke/kyc/id',
                'operation_id': 'get_national_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_national_id(
        ...
        **kwargs
        ...
        >>> thread = api.get_national_id(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_national_id_endpoint.call_with_http_info(**kwargs)
