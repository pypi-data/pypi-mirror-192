...
def test_format_playlist_three_tracks():
    ...
    assert (
        ...
        '             0  cardigan                 folklore                '
        'Taylor Swift\n'
        '>>>          1  One For The Ditch        Some Kind of Certainty  '
        'Ewan Robertson\n'
        '             2  Vincent Black Lightning  Some Kind of Certainty  '
...
def test_format_playlist_all(playlist):
    assert (
            ...
            '             1  cardigan                         folklore '
            ' Taylor Swift\n'
            '             2  the last great american dynasty  folklore '
            ' Taylor Swift\n'
            '             3  exile                            folklore '
            ' Taylor Swift\n'
            '>>>          4  my tears ricochet                folklore '
            ' Taylor Swift\n'
            '             5  mirrorball                       folklore '
            ' Taylor Swift\n'
            '             6  seven                            folklore '
            ' Taylor Swift\n'
            '             7  august                           folklore '
            ...
            ' Taylor Swift\n'
            '             9  illicit affairs                  folklore '
            ' Taylor Swift\n'
            '            10  invisible string                 folklore '
            ' Taylor Swift\n'
            '            11  mad woman                        folklore '
            ' Taylor Swift\n'
            '            12  epiphany                         folklore '
            ' Taylor Swift\n'
            '            13  betty                            folklore '
            ' Taylor Swift\n'
            '            14  peace                            folklore '
