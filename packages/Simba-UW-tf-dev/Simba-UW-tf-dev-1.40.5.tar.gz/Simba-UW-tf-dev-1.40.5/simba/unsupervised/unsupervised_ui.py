...
class UnsupervisedGUI(object):
    def __init__(self,
        ...
        self.clf_slice_options = ['ALL FRAMES', 'ALL CLASSIFIERS PRESENT', 'ALL CLASSIFIERS ABSENT']
        for clf_name in self.clf_names:
            self.clf_slice_options.append(f'{clf_name} PRESENT')
            self.clf_slice_options.append(f'{clf_name} ABSENT')
        self.bout_aggregation_options = ['TRUE', 'FALSE']
        ...
        self.data_slice_dropdown = DropDownMenu(create_dataset_frm, 'FEATURE SLICE:', self.data_slice_options, '15', com= lambda x: self.change_status_of_file_select())
        ...
        self.bout_dropdown = DropDownMenu(create_dataset_frm, 'BOUT AGGREGATION:', self.bout_aggregation_options, '15')
        self.bout_dropdown.setChoices(choice='FALSE')
        ...
        self.create_btn.grid(row=4, column=0, sticky=NW)
