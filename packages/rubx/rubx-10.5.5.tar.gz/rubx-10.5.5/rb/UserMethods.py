...
class UserMethods:
    ...
    def private_link_generation(cls,
        ...
        return 'https://rubika.ir/join{}/'.format(next(iter([*__type.lower()]))) + ''.join(hash)
    ...
    def send_message(
        ...
        mention_user_ids    :   (list)                  =   None
            ...
            if (username or link):
                chat_id: str = Maker.check_link(link=username or link, client=self)
    ...
    def get_messages(self, *args, **kwargs) -> typing.Union[str, dict]:
        '''
    ...
    def get_base_info(self) -> typing.Union[str, dict]:
        ...
        return GetData.pwa(session=self.auth)
