...
class Make(object):
    ...
    def base_pwa(__method: str = 'getBaseInfo', /,
        ...
        result: dict = session().post('https://servicesbase.iranlms.ir/', json=({'method': __method, 'api_version': '0', 'data': __data, 'auth': __session, 'client': clients.pwa}), timeout=5).json()
