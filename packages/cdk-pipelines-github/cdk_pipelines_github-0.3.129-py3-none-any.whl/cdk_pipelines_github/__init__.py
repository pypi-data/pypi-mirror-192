...
class GitHubActionRole(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param repos: (experimental) A list of GitHub repositories you want to be able to access the IAM role. Each entry should be your GitHub username and repository passed in as a single string. For example, `['owner/repo1', 'owner/repo2'].
