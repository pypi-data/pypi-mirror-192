...
class MarketData:
    ...
    def get_assessments_by_symbol_current(
        self,
        *,
        symbol: Optional[Union[Collection[str], str]] = None,
        bate: Optional[Union[Collection[str], str]] = None,
        ...
        Parameters
        ----------
        symbol : Optional[Union[Collection[str], str]], optional
            filter by symbol, by default None
        bate : Optional[Union[Collection[str], str]], optional
    ...
    def get_assessments_by_mdc_current(
        ...
        *,
        mdc: str,
        bate: Optional[Collection[str]] = None,
        filter_exp: Optional[str] = None,
        page: int = 1,
        page_size: int = 10000,
        paginate: bool = True,
        ...
        bate : Optional[Collection[str]], optional
            filter by bate, by default None
        filter_exp : Optional[str], optional
            pass-thru ``filter`` query param to use a handcrafted filter expression, by default None
        page : int, optional
    ...
    def get_symbols(
        ...
        *,
        ...
        symbol : Optional[Union[Collection[str], str]], optional
            filter by symbol, by default None
        delivery_region_basis : Optional[Union[Collection[str], str]], optional
        ...
        assessment_frequency: Optional[Union[Collection[str], Collection[AssessmentFrequency], str, AssessmentFrequency]], optional
