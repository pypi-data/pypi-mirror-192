...
from spgci.types import ContractType, CurveType, MatFrequency
...
class ForwardCurves:
    ...
    def get_assessments(
        self,
        *,
        curve_code: Optional[Union[Collection[str], str]] = None,
        derivative_maturity_frequency: Optional[
            Union[Collection[str], Collection[MatFrequency], str, MatFrequency]
        ] = None,
        ...
        Parameters
        ----------
        curve_code : Optional[Union[Collection[str], str]], optional
            fitler by curve code, by default None
        derivative_maturity_frequency : Optional[ Union[Collection[str], Collection[MatFrequency], str, MatFrequency] ], optional
        ...
        --------
        **Get Latest Curve**
        >>> ForwardCurves.get_assessments(curve_code="CN003")

        **Get Multiple Curves**
        >>> ForwardCurves.get_assessments(curve_code=["CN003", "CN002"])

        **Get Monthly Contracts**
        >>> ForwardCurves.get_assessments(curve_code=["CN003", "CN002"], derivative_maturity_frequency="Month")

        **Get Assessments for a Curve on a particular date**
        >>> ForwardCurves.get_assessments(curve_code=["CN003"], assess_date=date(2023,2,13))
        """
    ...
    def get_curves(
        ...
        *,
        q: Optional[str] = None,
        commodity: Optional[Union[Collection[str], str]] = None,
        contract_type: Optional[
            Union[Collection[str], Collection[ContractType], str, ContractType]
        ] = None,
        currency: Optional[Union[Collection[str], str]] = None,
        uom: Optional[Union[Collection[str], str]] = None,
        curve_code: Optional[Union[Collection[str], str]] = None,
        curve_type: Optional[
            Union[Collection[str], Collection[CurveType], str, CurveType]
        ] = None,
        mdc: Optional[Union[Collection[str], str]] = None,
        derivative_maturity_frequency: Optional[
            Union[Collection[str], Collection[MatFrequency], str, MatFrequency]
        ] = None,
        filter_exp: Optional[str] = None,
        ...
        See ``get_assessments()`` to get assessments for each symbol in a curve.\n
         ...
         commodity : Optional[Union[Collection[str], str]], optional
             filter by commodity, by default None
         contract_type : Optional[ Union[Collection[str], Collection[ContractType], str, ContractType] ], optional
             filter by contract type, by default None
         currency : Optional[Union[Collection[str], str]], optional
             filter by currency, by default None
         uom : Optional[Union[Collection[str], str]], optional
             filter by unit of measure, by default None
         curve_code : Optional[Union[Collection[str], str]], optional
             filter by curve code, by default None
         curve_type : Optional[Union[Collection[str], Collection[CurveType], str, CurveType]], optional
             filter by curve type, by default None
         mdc : Optional[Union[Collection[str], str]], optional
        ...
        Returns
         ...
         --------
         **Free text search**
         >>> ForwardCurves.get_curves(q="Brent")

         **Find Benzene Curves**
         >>> ForwardCurves.get_curves(commodity="Benzene")

         **Find Monthly Relative Curves by MDC**
         >>> ForwardCurves.get_curves(curve_type=CurveType.Relative, mdc=["DR"], derivative_maturity_frequency='Month')
        """
        filter_params: List[str] = []
