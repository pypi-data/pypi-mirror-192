...
class DataSetsManager(ManagerMix):
    ...
    def post_data_set_data2(self, data: pd.DataFrame, data_set: DataSets, overwriteStrategy: str = None):
        print(data)
        ...
        if is_datetime(data["date_time"]):
            ...
            data["date_time"] = (data.date_time.values.astype(np.int64) / 10**9).astype(np.int64) - 3600
