...
```
cd existing_repo
git remote add origin https://gitlab-master.nvidia.com/dchichkov/magic-key.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-master.nvidia.com/dchichkov/magic-key/-/settings/integrations)
