...
from pypaq.lipytools.printout import short_scin, stamp
...
from pypaq.torchness.comoneural import NNWrap, NNWrapException
...
class NEModel(NNWrap):
    ...
    def _manage_dna(
        ...
        self._dna_nngraph = point_trim(self.nngraph, dna_with_nwwlog)
        self._dna_opt_func = point_trim(opt_func, dna_with_nwwlog)
