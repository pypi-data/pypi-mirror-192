...
from pypaq.torchness.comoneural.batcher import Batcher, split_data_TR
...
class NNWrap(ParaSave, ABC):
    ...
    def _manage_dna(
        ...
        self._dna_nngraph = point_trim(nngraph_func, dna_with_nwwlog)
