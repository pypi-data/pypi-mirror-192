...
{'': ['*'],
 'organage.data.ml_models.KADRC': ['Zprot_stableps_perf95/Adipose/*',
                                   ...
                                   'Zprot_stableps_perf95_fiba/DementiaAdipose/*',
                                   'Zprot_stableps_perf95_fiba/DementiaArtery/*',
                                   'Zprot_stableps_perf95_fiba/DementiaBrain/*',
                                   'Zprot_stableps_perf95_fiba/DementiaHeart/*',
                                   'Zprot_stableps_perf95_fiba/DementiaImmune/*',
                                   'Zprot_stableps_perf95_fiba/DementiaIntestine/*',
                                   'Zprot_stableps_perf95_fiba/DementiaKidney/*',
                                   'Zprot_stableps_perf95_fiba/DementiaLiver/*',
                                   'Zprot_stableps_perf95_fiba/DementiaLung/*',
                                   'Zprot_stableps_perf95_fiba/DementiaMuscle/*',
                                   'Zprot_stableps_perf95_fiba/DementiaPancreas/*']}
