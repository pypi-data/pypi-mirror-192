...
def main():
    ...
    parser.add_option("--init", dest="init", type="string", default='ddr-init',
                      help="Relative path to the file containing the initial-facts file")
    parser.add_option("--control", dest="control", type="string", default='ddr-control',
                      help="Relative path to the file containing the external application control file")
    parser.add_option("--sim", dest="sim", type="string", default='ddr-sim',
                      help="Relative path to the file containing the simulated facts for rule execution file")
    parser.add_option("--parsers", dest="parsers", type="string", default='ddr-parsers',
                      help="Relative path to the file containing the genie_parsers required for the usecase")
