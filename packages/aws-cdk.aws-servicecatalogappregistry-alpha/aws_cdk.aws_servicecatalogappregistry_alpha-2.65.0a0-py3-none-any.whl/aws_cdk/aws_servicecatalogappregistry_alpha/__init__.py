...
class TargetApplication(
    ...
    def create_application_stack(
        ...
        *,
        ...
        :param stack_id: (deprecated) Stack ID in which application will be created or imported. The id of a stack is also the identifier that you use to refer to it in the `AWS CDK Toolkit <https://docs.aws.amazon.com/cdk/v2/guide/cli.html>`_. Default: - ApplicationAssociatorStack
