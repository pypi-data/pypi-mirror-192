...
def _parse_response(*, response: httpx.Response) -> Optional[Union[BaseError, UserOut]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[BaseError, UserOut]]:
    return Response(
