...
setup(
    ...
    version = 'v1.0.3',  # Ideally should be same as your GitHub release tag varsion
    ...
    download_url = 'https://github.com/louis-it4u/http-request/archive/refs/tags/v1.0.3.tar.gz',
