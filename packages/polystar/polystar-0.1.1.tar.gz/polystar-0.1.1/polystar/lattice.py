    ...
    *or* ``(vectors,)`` [which also requires setting ``row_vectors=False`` if the matrix represents column vectors].
    ...
    spacegroup : str, tuple(str, str)
        ...
        * or 'R' or 'H' for trigonal systems with Rhombohedral or Hexagonal lattice settings, respectively.
        ...
        `this table <https://github.com/g5t/polystar/blob/eecb4cb28227665908793abc47e88c69518c09fc/src/spg_database.cpp#L63-L610>`_
        with each line representing one spacegroup with values, in order, defined by the
        `class signature <https://github.com/g5t/polystar/blob/eecb4cb28227665908793abc47e88c69518c09fc/src/spg_database.hpp#L80-L91>`_
    ...
    symmetry: polystar.Symmetry, tuple(matrices, vectors), str
    ...
    basis: polystar.Basis, tuple(positions, types)
    ...
    kwargs:
        Keyword arguments are passed to the :py:class:`polystar._polystar.Lattice` constructor,
        see its documentation for details.

    """
    from ._polystar import Lattice as _Lattice, Symmetry as _Symmetry, Basis as _Basis
