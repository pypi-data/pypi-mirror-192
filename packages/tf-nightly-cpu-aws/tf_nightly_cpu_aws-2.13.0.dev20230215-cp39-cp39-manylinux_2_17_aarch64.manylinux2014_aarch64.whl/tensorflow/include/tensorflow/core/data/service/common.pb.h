...
inline void TaskInfo::clear_transfer_address() {
  _impl_.transfer_address_.ClearToEmpty();
}
...
void TaskInfo::set_transfer_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.transfer_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& TaskInfo::_internal_transfer_address() const {
  return _impl_.transfer_address_.Get();
}
inline void TaskInfo::_internal_set_transfer_address(const std::string& value) {
  
  _impl_.transfer_address_.Set(value, GetArenaForAllocation());
}
inline std::string* TaskInfo::_internal_mutable_transfer_address() {
  
  return _impl_.transfer_address_.Mutable(GetArenaForAllocation());
}
inline std::string* TaskInfo::release_transfer_address() {
  ...
  return _impl_.transfer_address_.Release();
}
inline void TaskInfo::set_allocated_transfer_address(std::string* transfer_address) {
  ...
  _impl_.transfer_address_.SetAllocated(transfer_address, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.transfer_address_.IsDefault()) {
    _impl_.transfer_address_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
