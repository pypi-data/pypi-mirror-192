...
class logger_x(object):
    def __init__(self, file, hstdout='DEBUG', hfile='DEBUG', maxBytes=0, backupCount=0):
    ...
    def configLogger(self):
        if self.s_console in LEVEL_LIST:
            ...
            logging.error("Wrong Log Level. Re-check it !!!")
            exit(1)
