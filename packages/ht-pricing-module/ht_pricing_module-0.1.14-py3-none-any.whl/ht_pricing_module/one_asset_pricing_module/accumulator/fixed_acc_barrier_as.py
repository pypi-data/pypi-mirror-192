...
class FixedAccBarrier(OneAssetOptionBase):
    ...
    def __calculate_present_value__(self) -> float:
        ...
        vanilla_option_type = {OptionType.ACCUMULATOR: OptionType.PUT,
        ...
        for obs in self.param.obs_date:
            param = Struct({})
            param['option_type'] = vanilla_option_type
            ...
            rst = rst + (
                        -self.param.leverage * vanilla.present_value() + binary1.present_value() - binary2.present_value())
        return rst
