...
- 🎯 Entry points to execute your program using `python -m <brds>` or `$ brds` with basic CLI argument parsing.
...
Awesome brds created by brahle
...
```py
from brds import BaseClass
from brds import base_function
