...
class OolerBLEDevice:
    ...
    def _fire_callbacks(self) -> None:
        """Fire the callbacks."""
        _LOGGER.error("Here are the callbacks being called together:")
        for callback in self._callbacks:
            _LOGGER.error("Here is the current callback: %s", callback.__name__)
    ...
    def register_constant_callback(self, callback: Callable[[OolerBLEState], None]) -> None:
        """Register a callback permanently to be called when state changes."""
        self._callbacks.append(callback)
    ...
    def _notification_handler(self, _sender: BleakGATTCharacteristic, data: bytearray) -> None:
        ...
        # settemp_int = self.state.set_temperature
        # actualtemp_int = self.state.actual_temperature
        ...
        _LOGGER.error("Notification handled. Firing callbacks now")
        self._fire_callbacks
