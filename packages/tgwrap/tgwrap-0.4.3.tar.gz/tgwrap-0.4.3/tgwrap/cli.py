...
@click.version_option(version=__version__)
def lock(domain, stage, module, auto_approve, verbose, dry_run, working_dir):
    """ Lock a particular domain/stage """
...
@click.version_option(version=__version__)
def unlock(domain, stage, module, auto_approve, verbose, dry_run, working_dir):
    """ Unlock a particular domain/stage """
