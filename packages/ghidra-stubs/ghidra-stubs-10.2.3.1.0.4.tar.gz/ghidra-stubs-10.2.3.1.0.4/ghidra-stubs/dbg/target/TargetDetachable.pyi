...
class TargetDetachable(ghidra.dbg.target.TargetObject, object):
    ALL_INTERFACES: java.util.Set = [interface ghidra.dbg.target.TargetBreakpointSpecContainer, interface ghidra.dbg.target.TargetTogglable, interface ghidra.dbg.target.TargetSymbol, interface ghidra.dbg.target.TargetAttacher, interface ghidra.dbg.target.TargetBreakpointLocation, interface ghidra.dbg.target.TargetSectionContainer, interface ghidra.dbg.target.TargetDeletable, interface ghidra.dbg.target.TargetSection, interface ghidra.dbg.target.TargetNamedDataType, interface ghidra.dbg.target.TargetModule, interface ghidra.dbg.target.TargetRegisterBank, interface ghidra.dbg.target.TargetResumable, interface ghidra.dbg.target.TargetModuleContainer, interface ghidra.dbg.target.TargetKillable, interface ghidra.dbg.target.TargetConsole, interface ghidra.dbg.target.TargetAttachable, interface ghidra.dbg.target.TargetStackFrame, interface ghidra.dbg.target.TargetDetachable, interface ghidra.dbg.target.TargetProcess, interface ghidra.dbg.target.TargetAccessConditioned, interface ghidra.dbg.target.TargetRegisterContainer, interface ghidra.dbg.target.TargetDataTypeNamespace, interface ghidra.dbg.target.TargetInterruptible, interface ghidra.dbg.target.TargetMemory, interface ghidra.dbg.target.TargetMemoryRegion, interface ghidra.dbg.target.TargetAggregate, interface ghidra.dbg.target.TargetLauncher, interface ghidra.dbg.target.TargetConfigurable, interface ghidra.dbg.target.TargetFocusScope, interface ghidra.dbg.target.TargetActiveScope, interface ghidra.dbg.target.TargetSymbolNamespace, interface ghidra.dbg.target.TargetThread, interface ghidra.dbg.target.TargetExecutionStateful, interface ghidra.dbg.target.TargetInterpreter, interface ghidra.dbg.target.TargetStack, interface ghidra.dbg.target.TargetSteppable, interface ghidra.dbg.target.TargetEventScope, interface ghidra.dbg.target.TargetRegister, interface ghidra.dbg.target.TargetEnvironment, interface ghidra.dbg.target.TargetMethod, interface ghidra.dbg.target.TargetDataTypeMember, interface ghidra.dbg.target.TargetBreakpointLocationContainer, interface ghidra.dbg.target.TargetBreakpointSpec]
