...
class AddressOfPcodeExecutorStatePiece(object, ghidra.pcode.exec.PcodeExecutorStatePiece):
    ...
    @overload
    def getVar(self, __a0: ghidra.program.model.address.AddressSpace, __a1: List[int], __a2: int, __a3: bool, __a4: ghidra.pcode.exec.PcodeExecutorStatePiece.Reason) -> ghidra.program.model.address.Address: ...
    ...
    @overload
    def setVar(self, __a0: ghidra.program.model.address.AddressSpace, __a1: List[int], __a2: int, __a3: bool, __a4: ghidra.program.model.address.Address) -> None: ...
