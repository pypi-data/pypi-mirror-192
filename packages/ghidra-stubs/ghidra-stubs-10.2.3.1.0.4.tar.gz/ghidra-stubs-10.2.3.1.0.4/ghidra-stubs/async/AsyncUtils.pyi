...
class AsyncUtils(object):
    CLEANER: java.lang.ref.Cleaner = java.lang.ref.Cleaner@4904de96
    FRAMEWORK_EXECUTOR: java.util.concurrent.ExecutorService = java.util.concurrent.ForkJoinPool@51cea11d[Running, parallelism = 2, size = 0, active = 0, running = 0, steals = 0, tasks = 0, submissions = 0]
    NIL: java.util.concurrent.CompletableFuture = java.util.concurrent.CompletableFuture@1c213648[Completed normally]
    SWING_EXECUTOR: java.util.concurrent.ExecutorService = ghidra.async.SwingExecutorService$1@309b4c73
