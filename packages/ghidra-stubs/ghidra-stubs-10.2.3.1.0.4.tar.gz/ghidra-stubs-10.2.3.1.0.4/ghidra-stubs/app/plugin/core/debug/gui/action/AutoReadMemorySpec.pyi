...
class AutoReadMemorySpec(ghidra.util.classfinder.ExtensionPoint, object):
    PRIVATE: ghidra.app.plugin.core.debug.gui.action.AutoReadMemorySpec.Private = ghidra.app.plugin.core.debug.gui.action.AutoReadMemorySpec$Private@2779f564
