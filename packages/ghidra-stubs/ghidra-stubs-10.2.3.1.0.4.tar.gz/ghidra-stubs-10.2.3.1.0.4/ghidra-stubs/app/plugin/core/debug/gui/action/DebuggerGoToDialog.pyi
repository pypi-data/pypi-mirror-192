...
class DebuggerGoToDialog(docking.DialogComponentProvider):
    ...
    def show(self, __a0: ghidra.app.plugin.processors.sleigh.SleighLanguage) -> None: ...
    ...
    @property
    def expression(self) -> None: ...  # No getter available.
