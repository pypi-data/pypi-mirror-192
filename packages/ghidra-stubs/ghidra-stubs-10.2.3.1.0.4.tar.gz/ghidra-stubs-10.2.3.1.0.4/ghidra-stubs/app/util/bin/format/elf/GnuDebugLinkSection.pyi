...
class GnuDebugLinkSection(ghidra.program.model.data.FactoryStructureDataType):
    """
    Factory data type that marks up a ELF .gnu_debuglink section.
    """

    DEBUG_LINK_SECTION_NAME: unicode = u'.gnu_debuglink'




    class GnuDebugLinkSectionValues(object):
    ...
    def __init__(self, dtm: ghidra.program.model.data.DataTypeManager, sectionSize: long):
        """
    ...
    @staticmethod
    def fromProgram(program: ghidra.program.model.listing.Program) -> ghidra.app.util.bin.format.elf.GnuDebugLinkSection.GnuDebugLinkSectionValues: ...
