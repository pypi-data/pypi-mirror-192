...
class AARCH64_MachoRelocationHandler(ghidra.app.util.bin.format.macho.relocation.MachoRelocationHandler):
    ...
    def relocate(self, __a0: ghidra.app.util.bin.format.macho.relocation.MachoRelocation) -> None: ...
    ...
    @staticmethod
    def write(__a0: ghidra.app.util.bin.format.macho.relocation.MachoRelocation, __a1: long) -> None: ...
