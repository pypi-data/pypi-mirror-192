...
class CompositeInternal(ghidra.program.model.data.Composite, object):
    ...
    class ComponentComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.ComponentComparator = ghidra.program.model.data.CompositeInternal$ComponentComparator@ead97eb
    ...
    class OffsetComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.OffsetComparator = ghidra.program.model.data.CompositeInternal$OffsetComparator@64d1bb83
    ...
    class OrdinalComparator(object, java.util.Comparator):
        INSTANCE: ghidra.program.model.data.CompositeInternal.OrdinalComparator = ghidra.program.model.data.CompositeInternal$OrdinalComparator@10140ba2
