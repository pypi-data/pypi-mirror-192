...
class DataTypeConflictHandler(object):
    DEFAULT_HANDLER: ghidra.program.model.data.DataTypeConflictHandler = ghidra.program.model.data.DataTypeConflictHandler$1@38afec6b
    KEEP_HANDLER: ghidra.program.model.data.DataTypeConflictHandler = ghidra.program.model.data.DataTypeConflictHandler$5@33477b36
    REPLACE_EMPTY_STRUCTS_OR_RENAME_AND_ADD_HANDLER: ghidra.program.model.data.DataTypeConflictHandler = ghidra.program.model.data.DataTypeConflictHandler$6@53f909e0
