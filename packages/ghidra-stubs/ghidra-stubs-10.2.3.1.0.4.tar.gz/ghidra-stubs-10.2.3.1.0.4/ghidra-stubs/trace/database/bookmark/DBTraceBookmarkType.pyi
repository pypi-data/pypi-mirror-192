...
class DBTraceBookmarkType(object, ghidra.trace.model.bookmark.TraceBookmarkType):
    ...
    @overload
    def __init__(self, __a0: ghidra.trace.database.bookmark.DBTraceBookmarkManager, __a1: unicode, __a2: javax.swing.ImageIcon, __a3: java.awt.Color, __a4: int): ...
    ...
    @icon.setter
    def icon(self, value: javax.swing.ImageIcon) -> None: ...
