...
class TraceEquate(object):
    ...
    @overload
    def addReference(self, __a0: com.google.common.collect.Range, __a1: ghidra.trace.model.thread.TraceThread, __a2: ghidra.program.model.address.Address, __a3: int) -> ghidra.trace.model.symbol.TraceEquateReference: ...

    @overload
    def addReference(self, __a0: com.google.common.collect.Range, __a1: ghidra.trace.model.thread.TraceThread, __a2: ghidra.program.model.address.Address, __a3: ghidra.program.model.pcode.Varnode) -> ghidra.trace.model.symbol.TraceEquateReference: ...
