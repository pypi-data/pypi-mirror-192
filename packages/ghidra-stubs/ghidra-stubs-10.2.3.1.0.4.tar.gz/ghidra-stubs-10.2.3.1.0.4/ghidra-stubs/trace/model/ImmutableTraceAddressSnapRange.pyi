...
class ImmutableTraceAddressSnapRange(object, ghidra.trace.model.TraceAddressSnapRange):
    ...
    @overload
    def __init__(self, __a0: ghidra.program.model.address.Address, __a1: com.google.common.collect.Range): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.address.AddressRange, __a1: com.google.common.collect.Range): ...

    @overload
    def __init__(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.program.model.address.Address, __a2: com.google.common.collect.Range): ...
    ...
    @overload
    def __init__(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.program.model.address.Address, __a2: com.google.common.collect.Range, __a3: ghidra.util.database.spatial.rect.EuclideanSpace2D): ...
    ...
    @staticmethod
    def spanCentered(__a0: long, __a1: int) -> com.google.common.collect.Range: ...
