...
class TraceRegisterUtils(java.lang.Enum):
    ...
    @staticmethod
    def getRegisterValue(__a0: ghidra.program.model.lang.Register, __a1: java.util.function.BiConsumer) -> ghidra.program.model.lang.RegisterValue: ...

    @staticmethod
    def getValueHackPointer(__a0: ghidra.trace.model.listing.TraceData) -> object: ...

    @staticmethod
    def getValueRepresentationHackPointer(__a0: ghidra.trace.model.listing.TraceData) -> unicode: ...
