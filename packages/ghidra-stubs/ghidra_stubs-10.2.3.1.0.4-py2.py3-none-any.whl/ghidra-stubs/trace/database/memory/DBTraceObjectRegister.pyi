...
class DBTraceObjectRegister(object, ghidra.trace.model.memory.TraceObjectRegister, ghidra.trace.database.target.DBTraceObjectInterface):
    ...
    def setState(self, __a0: com.google.common.collect.Range, __a1: ghidra.trace.model.memory.TraceMemoryState) -> None: ...

    def setValue(self, __a0: com.google.common.collect.Range, __a1: List[int]) -> None: ...
