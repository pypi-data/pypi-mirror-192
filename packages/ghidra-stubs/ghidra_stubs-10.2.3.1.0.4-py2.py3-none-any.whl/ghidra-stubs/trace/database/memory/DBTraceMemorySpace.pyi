...
class DBTraceMemorySpace(object, ghidra.trace.model.memory.TraceMemorySpace, ghidra.trace.database.memory.InternalTraceMemoryOperations, ghidra.trace.database.space.DBTraceSpaceBased):
    ...
    @overload
    def addRegion(self, __a0: unicode, __a1: com.google.common.collect.Range, __a2: ghidra.program.model.address.AddressRange, __a3: java.util.Collection) -> ghidra.trace.database.memory.DBTraceMemoryRegion: ...
