...
class CycleGroup(object):
    ...
    ALL_CYCLE_GROUPS: List[object] = [ghidra.program.model.data.CycleGroup$ByteCycleGroup@65428d6, ghidra.program.model.data.CycleGroup$FloatCycleGroup@d43c3d7, ghidra.program.model.data.CycleGroup$StringCycleGroup@7e77ee8b]
    BYTE_CYCLE_GROUP: ghidra.program.model.data.CycleGroup = ghidra.program.model.data.CycleGroup$ByteCycleGroup@65428d6
    FLOAT_CYCLE_GROUP: ghidra.program.model.data.CycleGroup = ghidra.program.model.data.CycleGroup$FloatCycleGroup@d43c3d7
    STRING_CYCLE_GROUP: ghidra.program.model.data.CycleGroup = ghidra.program.model.data.CycleGroup$StringCycleGroup@7e77ee8b
