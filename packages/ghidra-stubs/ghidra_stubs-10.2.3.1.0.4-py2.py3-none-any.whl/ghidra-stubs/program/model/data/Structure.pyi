...
class Structure(ghidra.program.model.data.Composite, object):
    ...
    class BitOffsetComparator(object, java.util.Comparator):
        INSTANCE_BE: java.util.Comparator = ghidra.program.model.data.Structure$BitOffsetComparator@70a6d372
        INSTANCE_LE: java.util.Comparator = ghidra.program.model.data.Structure$BitOffsetComparator@6cff734
