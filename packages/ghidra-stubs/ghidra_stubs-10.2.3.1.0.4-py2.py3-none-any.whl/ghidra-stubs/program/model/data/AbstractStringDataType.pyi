...
class AbstractStringDataType(ghidra.program.model.data.BuiltIn, ghidra.program.model.data.Dynamic, ghidra.program.model.data.DataTypeWithCharset):
    ...
    COMMON_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition] = array(ghidra.docking.settings.SettingsDefinition, [ghidra.program.model.data.TranslationSettingsDefinition@114dbc3e, ghidra.program.model.data.RenderUnicodeSettingsDefinition@7a2828f6])
    COMMON_WITH_CHARSET_STRING_SETTINGS_DEFS: List[ghidra.docking.settings.SettingsDefinition] = array(ghidra.docking.settings.SettingsDefinition, [ghidra.program.model.data.TranslationSettingsDefinition@114dbc3e, ghidra.program.model.data.RenderUnicodeSettingsDefinition@7a2828f6, ghidra.program.model.data.CharsetSettingsDefinition@170db3a7])
