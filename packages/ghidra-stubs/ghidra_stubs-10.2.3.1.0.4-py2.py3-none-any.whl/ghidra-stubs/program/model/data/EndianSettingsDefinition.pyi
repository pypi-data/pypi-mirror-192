...
class EndianSettingsDefinition(object, ghidra.docking.settings.EnumSettingsDefinition):
    ...
    BIG: int = 2
    DEF: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@57b2a5ed
    DEFAULT: int = 0
    ENDIAN: ghidra.program.model.data.EndianSettingsDefinition = ghidra.program.model.data.EndianSettingsDefinition@57b2a5ed
    LITTLE: int = 1
