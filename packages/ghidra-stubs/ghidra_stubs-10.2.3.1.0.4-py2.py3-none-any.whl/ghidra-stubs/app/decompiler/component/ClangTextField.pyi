...
class ClangTextField(docking.widgets.fieldpanel.field.WrappingVerticalLayoutTextField):
    ...
    def __init__(self, __a0: List[object], __a1: List[docking.widgets.fieldpanel.field.FieldElement], __a2: int, __a3: int, __a4: int, __a5: docking.widgets.fieldpanel.support.HighlightFactory): ...
