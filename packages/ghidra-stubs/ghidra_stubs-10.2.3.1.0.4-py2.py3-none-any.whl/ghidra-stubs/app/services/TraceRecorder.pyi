...
class TraceRecorder(object):
    ...
    def getTargetRegisterBank(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: int) -> ghidra.dbg.target.TargetRegisterBank: ...
    ...
    def isRegisterOnTarget(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: ghidra.program.model.lang.Register) -> bool: ...

    def isSupportsFocus(self) -> bool: ...

    def isVariableOnTarget(self, __a0: ghidra.trace.model.thread.TraceThread, __a1: ghidra.program.model.address.Address, __a2: int) -> bool: ...
