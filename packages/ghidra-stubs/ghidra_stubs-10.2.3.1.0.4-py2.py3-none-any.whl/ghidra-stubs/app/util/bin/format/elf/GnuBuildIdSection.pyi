...
class GnuBuildIdSection(ghidra.program.model.data.FactoryStructureDataType):
    """
    Factory data type that marks up a Gnu Build-Id record from a 
     ELF .note.gnu.build-id section
    """

    BUILD_ID_SECTION_NAME: unicode = u'.note.gnu.build-id'




    class GnuBuildIdValues(object):
    ...
    @staticmethod
    def fromProgram(program: ghidra.program.model.listing.Program) -> ghidra.app.util.bin.format.elf.GnuBuildIdSection.GnuBuildIdValues: ...
