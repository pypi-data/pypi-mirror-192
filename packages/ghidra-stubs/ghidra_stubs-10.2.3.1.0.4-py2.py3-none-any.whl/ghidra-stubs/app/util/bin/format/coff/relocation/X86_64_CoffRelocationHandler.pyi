...
class X86_64_CoffRelocationHandler(object, ghidra.app.util.bin.format.coff.relocation.CoffRelocationHandler):
    ...
    def relocate(self, __a0: ghidra.program.model.address.Address, __a1: ghidra.app.util.bin.format.coff.CoffRelocation, __a2: ghidra.app.util.bin.format.coff.relocation.CoffRelocationContext) -> None: ...
