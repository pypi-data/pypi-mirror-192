...
class AbstractProgramLoader(object, ghidra.app.util.opinion.Loader):
    ...
    class LoadedProgram(java.lang.Record):




        def __init__(self, __a0: ghidra.program.model.listing.Program, __a1: ghidra.framework.model.DomainFolder): ...



        def destinationFolder(self) -> ghidra.framework.model.DomainFolder: ...
