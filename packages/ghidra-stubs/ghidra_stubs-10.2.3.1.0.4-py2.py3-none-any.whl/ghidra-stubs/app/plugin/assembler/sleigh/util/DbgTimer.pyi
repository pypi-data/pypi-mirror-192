...
class DbgTimer(java.io.PrintStream):
    ...
    ACTIVE: ghidra.app.plugin.assembler.sleigh.util.DbgTimer = ghidra.app.plugin.assembler.sleigh.util.DbgTimer@6c7e6695
    INACTIVE: ghidra.app.plugin.assembler.sleigh.util.DbgTimer = ghidra.app.plugin.assembler.sleigh.util.DbgTimer$2@3e269bfb
