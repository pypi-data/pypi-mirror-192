...
class TracePathLastLifespanPlotColumn(docking.widgets.table.AbstractDynamicTableColumn):
    ...
    @overload
    def getValue(self, __a0: ghidra.app.plugin.core.debug.gui.model.PathTableModel.PathRow, __a1: ghidra.docking.settings.Settings, __a2: ghidra.trace.model.Trace, __a3: ghidra.framework.plugintool.ServiceProvider) -> com.google.common.collect.Range: ...
