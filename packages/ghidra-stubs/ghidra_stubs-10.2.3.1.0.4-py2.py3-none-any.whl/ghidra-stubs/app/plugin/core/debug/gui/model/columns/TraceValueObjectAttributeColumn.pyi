...
class TraceValueObjectAttributeColumn(docking.widgets.table.AbstractDynamicTableColumn):





    class AttributeRenderer(ghidra.util.table.column.AbstractGColumnRenderer, ghidra.app.plugin.core.debug.gui.model.ColorsModified.InTable):




        def __init__(self, __a0: ghidra.app.plugin.core.debug.gui.model.columns.TraceValueObjectAttributeColumn): ...
        ...
        @overload
        def getFilterString(self, __a0: ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueRow, __a1: ghidra.docking.settings.Settings) -> unicode: ...
    ...
    @staticmethod
    def computeColumnType(__a0: ghidra.dbg.target.schema.SchemaContext, __a1: ghidra.dbg.target.schema.TargetObjectSchema.AttributeSchema) -> java.lang.Class: ...

    def equals(self, __a0: object) -> bool: ...

    @staticmethod
    def fromSchema(__a0: ghidra.dbg.target.schema.SchemaContext, __a1: ghidra.dbg.target.schema.TargetObjectSchema.AttributeSchema) -> ghidra.app.plugin.core.debug.gui.model.columns.TraceValueObjectAttributeColumn: ...
