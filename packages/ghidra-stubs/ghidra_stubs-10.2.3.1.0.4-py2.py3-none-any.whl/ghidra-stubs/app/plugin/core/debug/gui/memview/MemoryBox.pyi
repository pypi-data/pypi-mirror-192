...
class MemoryBox(object):
    ...
    @overload
    def __init__(self, __a0: unicode, __a1: ghidra.app.plugin.core.debug.gui.memview.MemviewBoxType, __a2: ghidra.program.model.address.AddressRange, __a3: com.google.common.collect.Range): ...
    ...
    @overload
    def setColor(self, __a0: java.awt.Color, __a1: int) -> None: ...

    @overload
    def setColor(self, __a0: java.awt.Color, __a1: int, __a2: int) -> None: ...
