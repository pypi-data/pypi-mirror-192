...
class BreakpointActionSet(java.util.LinkedHashSet):
    ...
    def planDelete(self, __a0: ghidra.dbg.target.TargetBreakpointLocation) -> ghidra.app.plugin.core.debug.service.breakpoint.DeleteBreakpointActionItem: ...

    def planDisable(self, __a0: ghidra.dbg.target.TargetBreakpointLocation) -> ghidra.app.plugin.core.debug.service.breakpoint.DisableBreakpointActionItem: ...

    def planEnable(self, __a0: ghidra.dbg.target.TargetBreakpointLocation) -> ghidra.app.plugin.core.debug.service.breakpoint.EnableBreakpointActionItem: ...
