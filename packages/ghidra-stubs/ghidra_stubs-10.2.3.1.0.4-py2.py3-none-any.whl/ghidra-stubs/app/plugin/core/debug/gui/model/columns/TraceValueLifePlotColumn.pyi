...
class TraceValueLifePlotColumn(docking.widgets.table.AbstractDynamicTableColumn):
    ...
    @overload
    def getValue(self, __a0: ghidra.app.plugin.core.debug.gui.model.ObjectTableModel.ValueRow, __a1: ghidra.docking.settings.Settings, __a2: ghidra.trace.model.Trace, __a3: ghidra.framework.plugintool.ServiceProvider) -> com.google.common.collect.RangeSet: ...
    ...
    def setFullRange(self, __a0: com.google.common.collect.Range) -> None: ...
    ...
    @fullRange.setter
    def fullRange(self, value: com.google.common.collect.Range) -> None: ...
