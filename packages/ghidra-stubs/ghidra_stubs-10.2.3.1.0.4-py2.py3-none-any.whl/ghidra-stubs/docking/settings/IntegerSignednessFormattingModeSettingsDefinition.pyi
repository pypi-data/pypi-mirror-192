...
class IntegerSignednessFormattingModeSettingsDefinition(object, ghidra.docking.settings.EnumSettingsDefinition):
    ...
    DEF: ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition = ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition@2d62bbf1
    DEF_SIGNED: ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition = ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition@76e5da18
    DEF_UNSIGNED: ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition = ghidra.docking.settings.IntegerSignednessFormattingModeSettingsDefinition@4932fd88
