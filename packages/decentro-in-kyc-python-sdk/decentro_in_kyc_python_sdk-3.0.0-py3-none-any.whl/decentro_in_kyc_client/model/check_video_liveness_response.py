    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "confidence", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "confidence", ], str]):
