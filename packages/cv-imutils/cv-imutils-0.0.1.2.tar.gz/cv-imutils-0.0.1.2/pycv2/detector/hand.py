...
class Hand_detector(mp_hand.Hands):
        ...
        if results.multi_hand_landmarks:
            for handLms in results.multi_hand_landmarks:
                mpDraw.draw_landmarks(
                    img, handLms, HAND_CONNECTIONS, mpDraw.DrawingSpec(), mpDraw.DrawingSpec())
        return img
    ...
    def findlength(self, img, p1, p2, draw=True, color=(255, 0, 0), radius=5, lcolor=(255, 255, 2555), thickness=3):
    ...
    def findAngel(self, img, p1, p2, p3, draw=True, color=(255, 0, 0), radius=5, lcolor=(255, 255, 255), thickness=1, drawtext=True, fontscale=5, font=cv2.FONT_HERSHEY_SIMPLEX, tcolor=(0, 255, 0), textthickness=1):
        ...
        if draw:
            ...
            if drawtext:
                cv2.putText(img, str(int(angel)), (x2-10, y2),
                            font, fontscale, tcolor, textthickness)
        return angel
